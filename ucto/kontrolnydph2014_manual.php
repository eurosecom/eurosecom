...
<?php if ( $kli_vrok == 2018 ) { ?> 
      <img src="../obr/ikony/info_blue_icon.png" onclick="PoucVyplnenie2018();" title="PouËenie na vyplnenie" class="btn-form-tool">
<?php                          } ?>
     ...
     <img src="../obr/ikony/download_blue_icon.png" onclick="RozdielyKvXml(<?php echo $xdod; ?>,'<?php echo $xume; ?>',3,<?php echo $xstv; ?>,'',<?php echo $xpov; ?>);" title="NaËÌtaù rozdielovÈ riadky oproti pÙvodnÈmu KVDPH" class="btn-form-tool">
...
<table class="oddiel">
<caption>
 <strong>B.3.1</strong>⁄daje zo vöetk˝ch prijat˝ch zjednoduöen˝ch fakt˙r podæa ß 74 ods. 3 pÌsm. a) aû c) z·kona,
z kt. prÌjemca plnenia uplatÚuje odpoËÌtanie dane (ak je celkov· suma odpoËÌtanej dane za prÌsluönÈ zdaÚovacie obdobie menej ako 3 000 eur)
</caption>
<tr>
<FORM name="fhlv11" method="post" action="kontrolnydph2014_manual.php?copern=15011&page=1&xume=<?php echo $xume; ?>&xstv=<?php echo $xstv; ?>">
 ...
 <th width="22%">Z·klad dane (ZD)</th>
 <th width="22%">Suma dane (SD)</th>
 <th width="22%">OdpoËÌtan· daÚ</th>
 <th width="22%">KÛd opravy</th>
 <th width="6%"></th>
</tr>
<?php
     }
...
<tr>
 <td>
  ...
  <img src='../obr/hladaj.png' onclick="myKVDPH.style.display=''; volajKvdph('B31');" title="Hæadaù v KVDPH">
 </td>
 ...
 <input type="submit" id="uloz11" name="uloz11" value="Uloûiù" onmouseover="return Povol_uloz11();" >
...
<table class="oddiel">
<caption>
 <strong>B.3.2</strong>⁄daje zo vöetk˝ch prijat˝ch zjednoduöen˝ch fakt˙r podæa ß 74 ods. 3 pÌsm. a) aû c) z·kona, z ktor˝ch prÌjemca plnenia uplatÚuje odpoËÌtanie dane
(ak je celkov· suma odpoËÌtanej dane za prÌsluönÈ zdaÚovacie obdobie 3000 eur a viac)
</caption>
<tr>
<FORM name="fhlv12" method="post" action="kontrolnydph2014_manual.php?copern=15012&page=1&xume=<?php echo $xume; ?>&xstv=<?php echo $xstv; ?>">
 <th width="5%">Oddiel</th>
 <th width="18%">I»DPH dod·vateæa</th>
 <th width="18%">Z·klad dane (ZD)</th>
 <th width="18%">Suma dane (SD)</th>
 <th width="18%">OdpoËÌtan· daÚ</th>
 <th width="18%">KÛd opravy</th>
 <th width="5%"></th>
</tr>
<?php
     }
...
<tr>
 <td>
  ...
  <img src='../obr/hladaj.png' onclick="myKVDPH.style.display=''; volajKvdph('B32');" title="Hæadaù v KVDPH">
 </td>
 <td><input type="text" name="kvicd" id="kvicd" onkeydown="kvicdb2Enter(event.which);" maxlength="20" style="width:100px;"/></td>
 ...
 <input type="submit" id="uloz12" name="uloz12" value="Uloûiù" onmouseover="return Povol_uloz12();" >
