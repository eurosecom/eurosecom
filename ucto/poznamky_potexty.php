...
if( !confirm ("Chcete importovaù poloûky \r zo s˙boru <?php echo $odkial; ?> ? \r POZOR!!! Pred importom bud˙ terajöie texty pozn·mok v tejto firme vymazanÈ .") )
         { window.close()  }
else
...
?>
<script type="text/javascript">
if( !confirm ("Chcete naËÌtaù pozn·mky z firmy Ë. <?php echo $fix;?> ? \r POZOR !!! Terajöie texty pozn·mok bud˙ najprv vymazanÈ .") )
         { window.close()  }
else
