...
if( $cislokomodity == 11 ) $text_komodita="elektroz. tr5 - svetelné zdroje";
if( $cislokomodity == 12 ) $text_komodita="elektroz. tr6";
if( $cislokomodity == 13 ) $text_komodita="elektroz. tr7";
if( $cislokomodity == 14 ) $text_komodita="elektroz. tr8";
if( $cislokomodity == 15 ) $text_komodita="elektroz. tr9";
...
if( $cislokomodity == 25 ) $text_komodita="elektrozariadenie kategórie è.5. - svietidlá";
