...
if ( !confirm ("Chcete naËÌtaù ˙daje do FOB z firmy minulÈho roka ?") )
         ...
         { location.href='priznanie_fob2014.php?copern=3156&page=1&drupoh=1&cislo_oc=<?php echo $cislo_oc; ?>' }
</script>
<?php                  }
...
//Z ciarky na bodku
  ...
  function reNacitaj()
  {
   window.open('../ucto/priznanie_fob2014.php?cislo_oc=<?php echo $cislo_oc;?>&copern=26&drupoh=1&page=1&subor=0&prepocitaj=1', '_self', 'width=1050, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes');
  }
  function TlacFOB()
  {
   window.open('../ucto/priznanie_fob2014.php?cislo_oc=<?php echo $cislo_oc;?>&copern=10&drupoh=1&page=1&subor=0&strana=9999', '_blank', 'width=1050, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes');
  }
  function NacitajMinRok()
  {
   window.open('../ucto/priznanie_fob2014.php?cislo_oc=<?php echo $cislo_oc;?>&copern=3155&drupoh=1&page=1', '_self','width=1060, height=900, top=0, left=12, status=yes, resizable=yes, scrollbars=yes');
  }
  function PoucVyplnenie()
  {
   window.open('../dokumenty/dan_z_prijmov2014/dpfob2014/FOBv13_poucenie_na_vyplnenie.pdf', '_blank', 'width=1080, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes');
  }
  function ZnovuPotvrdenie()
  {
   window.open('../ucto/priznanie_fob2014.php?cislo_oc=<?php echo $cislo_oc;?>&copern=26&drupoh=1&page=1&subor=1&prepocitaj=1', '_self', 'width=1080, height=900, top=0, left=10, status=yes, resizable=yes, scrollbars=yes');
  }
  function vypocetOP()
  {
   window.open('priznanie_fob2014.php?copern=20&strana=<?php echo $strana; ?>&miliondan=1', '_self');
  }
  function namanzelku()
  {
   window.open('priznanie_fob2014.php?copern=20&strana=<?php echo $strana; ?>&namanzelku=1', '_self');
  }
  function NacitajVHpredDanou()
  {
   window.open('../ucto/priznanie_fob2014.php?strana=3&copern=200&drupoh=1&page=1&typ=PDF&dppo=1', '_self');
  }
</script>
</HEAD>
<?php if( $zandroidu == 1 ) { ?>
...
<div id="content">
<FORM name="formv1" method="post" action="priznanie_fob2014.php?copern=23&cislo_oc=<?php echo $cislo_oc;?>&strana=<?php echo $strana;?>">
<?php
...
$source="../ucto/priznanie_fob2014.php?cislo_oc=".$cislo_oc."&drupoh=1&page=1&subor=0";
?>
<div class="navbar">
...
<?php if ( $strana == 1 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-1.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ B pre rok 2013 1.strana 282kB" class="form-background">
...
<!-- Miesto podnikania (ak sa lÌöi od miesta trvalÈho pobytu) - ! VypÂÚaù iba pri V˝kaze o prÌjmoch a v˝davkoch a pri V˝kaze o majetku a z·v‰zkov !
Ulica:<input type="text" name="pruli" id="pruli" size="30" />
»Ìslo:<input type="text" name="prcdm" id="prcdm" size="10" />
PS»:<input type="text" name="prpsc" id="prpsc" size="10" />
Obec:<input type="text" name="prmes" id="prmes" size="30" />
TelefÛn:<input type="text" name="prtel" id="prtel" size="30" />
Fax:<input type="text" name="prfax" id="prfax" size="30" /> --> <!-- dopyt, neviem, Ëi nechaù alebo nie -->
<?php                                        } ?>


<?php if ( $strana == 2 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-2.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ B pre rok 2013 2.strana 282kB" class="form-background">
...
<?php if ( $strana == 3 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-3.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ B pre rok 2013 3.strana 282kB" class="form-background">
<input type="text" name="fir_fdic" id="fir_fdic" value="<?php echo $fir_fdic; ?>" disabled="disabled" class="nofill" style="width:220px; top:68px; left:397px;"/>
...
<input type="text" name="t1v2" id="t1v2" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:262px; left:661px;"/>
 ...
 <img src="../obr/ikony/calculator_blue_icon.png" onclick="NacitajVHpredDanou();" title="NaËÌtaù prÌjmy,v˝davky a zaplatenÈ poistnÈ SP a ZP zo ûivnosti do tabuæky Ë.1 (VI.oddiel FOB 3. strana), musÌte maù spracovan˝ V˝kaz o prÌjmoch a v˝davkoch za 12.2013" class="btn-row-tool" style="top:262px; left:910px;">
...
<?php if ( $strana == 4 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-4.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ B pre rok 2013 4.strana 282kB" class="form-background">
<input type="text" name="fir_fdic" id="fir_fdic" value="<?php echo $fir_fdic; ?>" disabled="disabled" class="nofill" style="width:220px; top:68px; left:397px;"/>
...
<?php if ( $strana == 5 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-5.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ B pre rok 2013 5.strana 282kB" class="form-background">
<input type="text" name="fir_fdic" id="fir_fdic" value="<?php echo $fir_fdic; ?>" disabled="disabled" class="nofill" style="width:220px; top:68px; left:397px;"/>
...
<?php if ( $strana == 6 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-6.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ B pre rok 2013 6.strana 282kB" class="form-background">
<input type="text" name="fir_fdic" id="fir_fdic" value="<?php echo $fir_fdic; ?>" disabled="disabled" class="nofill" style="width:220px; top:68px; left:397px;"/>
...
<?php if ( $strana == 7 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-7.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ B pre rok 2013 7.strana 282kB" class="form-background">
<input type="text" name="fir_fdic" id="fir_fdic" value="<?php echo $fir_fdic; ?>" disabled="disabled" class="nofill" style="width:220px; top:68px; left:397px;"/>
...
<?php if ( $strana == 8 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-8.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ B pre rok 2013 8.strana 282kB" class="form-background">
<input type="text" name="fir_fdic" id="fir_fdic" value="<?php echo $fir_fdic; ?>" disabled="disabled" class="nofill" style="width:220px; top:68px; left:397px;"/>

<!-- X. ODDIEL -->

<input type="text" name="r73" id="r73" onkeyup="CiarkaNaBodku(this);" style="width:152px; top:196px; left:580px;"/>
 <img src="../obr/ikony/calculator_blue_icon.png" onclick="vypocetOP();" title="VypoËÌtaù odpoËÌtateæn˙ poloûku na daÚovnÌka" class="btn-row-tool" style="top:200px; left:750px;">
<input type="text" name="r74" id="r74" onkeyup="CiarkaNaBodku(this);" style="width:152px; top:235px; left:580px;"/>
 <img src="../obr/ikony/calculator_blue_icon.png" onclick="namanzelku();" title="VypoËÌtaù odpoËÌtateæn˙ poloûku na manûelku" class="btn-row-tool" style="top:230px; left:750px;"> <!-- dopyt, m· to tu byù -->
...
<?php if ( $strana == 9 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-9.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ B pre rok 2013 9.strana 282kB" class="form-background">
<input type="text" name="fir_fdic" id="fir_fdic" value="<?php echo $fir_fdic; ?>" disabled="disabled" class="nofill" style="width:220px; top:68px; left:397px;"/>
...
<?php if ( $strana == 10 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-10.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ B pre rok 2013 10.strana 282kB" class="form-background">
<input type="text" name="fir_fdic" id="fir_fdic" value="<?php echo $fir_fdic; ?>" disabled="disabled" class="nofill" style="width:220px; top:68px; left:397px;"/>
...
<?php if ( $strana == 11 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-11.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ B pre rok 2013 11.strana 282kB" class="form-background">
<input type="text" name="fir_fdic" id="fir_fdic" value="<?php echo $fir_fdic; ?>" disabled="disabled" class="nofill" style="width:220px; top:68px; left:397px;"/>
...
<?php if ( $strana == 12 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-12.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ B pre rok 2013 12.strana 282kB" class="form-background">
<input type="text" name="fir_fdic" id="fir_fdic" value="<?php echo $fir_fdic; ?>" disabled="disabled" class="nofill" style="width:220px; top:68px; left:397px;"/>
...
$pdf->SetLeftMargin(8);
$pdf->SetTopMargin(10);
if ( File_Exists('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-1.jpg') )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-1.jpg',0,0,210,297);
}
$pdf->SetY(10);
...
$pdf->SetLeftMargin(8);
$pdf->SetTopMargin(10);
if ( File_Exists('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-2.jpg') )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-2.jpg',0,0,210,297);
}
$pdf->SetY(10);
...
$pdf->SetLeftMargin(8);
$pdf->SetTopMargin(10);
if ( File_Exists('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-3.jpg') )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-3.jpg',0,0,210,297);
}
$pdf->SetY(10);
...
$pdf->SetLeftMargin(8);
$pdf->SetTopMargin(10);
if (File_Exists('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-4.jpg') )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-4.jpg',0,0,210,297);
}
$pdf->SetY(10);
...
$pdf->SetLeftMargin(8);
$pdf->SetTopMargin(10);
if (File_Exists('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-5.jpg') )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-5.jpg',0,0,210,297);
}
$pdf->SetY(9);
...
$pdf->SetLeftMargin(8);
$pdf->SetTopMargin(10);
if (File_Exists('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-6.jpg') )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-6.jpg',0,0,210,297);
}
$pdf->SetY(10);
...
$pdf->SetLeftMargin(8);
$pdf->SetTopMargin(10);
if (File_Exists('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-7.jpg') )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-7.jpg',0,0,210,297);
}
$pdf->SetY(10);
...
$pdf->SetLeftMargin(8);
$pdf->SetTopMargin(10);
if (File_Exists('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-8.jpg') )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-8.jpg',0,0,210,297);
}
$pdf->SetY(10);
...
$pdf->SetLeftMargin(8);
$pdf->SetTopMargin(10);
if (File_Exists('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-9.jpg') )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-9.jpg',0,0,210,297);
}
$pdf->SetY(9);
...
$pdf->SetLeftMargin(8);
$pdf->SetTopMargin(10);
if (File_Exists('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-10.jpg') )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-10.jpg',0,0,210,297);
}
$pdf->SetY(10);
...
$pdf->SetLeftMargin(8);
$pdf->SetTopMargin(10);
if ( File_Exists('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-11.jpg') )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-11.jpg',0,0,210,297);
}
$pdf->SetY(10);
...
$pdf->SetLeftMargin(8);
$pdf->SetTopMargin(10);
if ( File_Exists ('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-12.jpg') )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-12.jpg',0,0,210,297);
}
$pdf->SetY(10);
...
$pdf->SetLeftMargin(8);
$pdf->SetTopMargin(10);
if ( File_Exists('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-13.jpg') )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/dpfob2014/dpfob_v14-13.jpg',0,0,210,297);
}
$pdf->SetY(10);
...
if ( File_Exists('../dokumenty/dan_z_prijmov2014/dpfob2014/FOBv13_potvrdenie.jpg') )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/dpfob2014/FOBv13_potvrdenie.jpg',0,0,210,297);
}
$pdf->SetY(10);
