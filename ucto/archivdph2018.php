...
<script type="text/javascript">
  var okno = window.open("../ucto/archivdph2014.php?copern=<?php echo $copern; ?>&drupoh=<?php echo $drupoh; ?>&tis=<?php echo $tis; ?>
&fort=<?php echo $fort; ?>&subor=<?php echo $subor; ?>&prepoc=<?php echo $prepoc; ?>
&cislo_ume=<?php echo $cislo_ume; ?>&cislo_stvrt=<?php echo $cislo_stvrt; ?>&koefmin=<?php echo $koefmin; ?>&druhykoef=<?php echo $druhykoef; ?>
&cislo_druh=<?php echo $cislo_druh; ?>&cislo_dap=<?php echo $cislo_dap; ?>","_self");
</script>
...
window.open('../ucto/archivdph2018.php?copern=60&page=1&sysx=UCT&cislo_cpid=' + cislo_cpid + '&drupoh=1&uprav=1',
 '_self' );
                }
...
window.open('../ucto/prizdph2018_uprav.php?copern=20&page=1&sysx=UCT&cislo_cpid=' + cislo_cpid + '&cislo_ume=' + cislo_ume + '&cislo_druh=' + cislo_druh + '&cislo_stvrt=' + stvrtrok + '&drupoh=1&uprav=1',
 '_self' );
                }
...
window.open('../ucto/prizdph2018.php?copern=110&page=1&sysx=UCT&cislo_cpid=' + cislo_cpid + '&cislo_ume=' + cislo_ume + '&cislo_druh=' + cislo_druh + '&cislo_stvrt=' + stvrtrok + '&cislo_dap=' + cislo_dap + '&drupoh=1&uprav=1&fir_uctx01=<?php echo $fir_uctx01; ?>',
...
window.open('../ucto/archivdph2018.php?copern=220&page=1&sysx=UCT&cislo_cpid=' + cislo_cpid + '&cislo_ume=' + cislo_ume + '&cislo_druh=' + cislo_druh + '&cislo_stvrt=' + stvrtrok +
...
window.open('../ucto/archivdph2018.php?copern=230&page=1&sysx=UCT&cislo_cpid=' + cislo_cpid + '&cislo_ume=' + cislo_ume + '&cislo_druh=' + cislo_druh + '&cislo_stvrt=' + stvrtrok +
...
<?php if( $oddelcsv == 1 ) { ?>
<a href="#" title="icDPH CSV1" onClick="window.open('../ucto/archivdph2018.php?copern=80&drupoh=1&page=1&akecsv=1', '_self')">CSV1</a>

&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" title="icDPH CSV2" onClick="window.open('../ucto/archivdph2018.php?copern=80&drupoh=1&page=1&akecsv=2', '_self')">CSV2</a>
<?php                      } ?>
</td>
...
<FORM name="formv1" class="obyc" method="post" action="archivdph2018.php?copern=23
