...
$jpg_popis="tlaËivo V˝kaz o objeme v˝roby ... ".$kli_vrok;
...
//Umiestnenie st·lej prev·dzk·rne na ˙zemÌ SR (ak nie je sÌdlo na ˙zemÌ SR) 1.strana - tam je adresa prevadzkarne
//nazov prevadzkarne je v polozke ulica v tvare "nazov - ulica", podla pomlcky si to rozdeli
//Osoba opr·vnen· na podanie daÚovÈho priznania za PO 10.strana
...
$pdf->SetFont('arial','',10);
$pdf->Cell(22,4,"List Ë. $strana","$rmc",1,"L");
$pdf->Cell(190,27," ","$rmc1",1,"L");
...
<td>EuroSecom  -  V˝kaz o objeme v˝roby, dovozu, v˝vozu a reexportu
...
<option value="106" >viacvrstv.obaly "N"</option>
  ...
  <option value="7" >elektroz. tr1 a. Chladiaca technika chladniËky,mrazniËky, klimatiz·cie, vinotÈky a.i.</option>
  <option value="31" >elektroz. tr1 b. OstatnÈ zariadenia na tepeln˙ v˝menu olejovÈ radi·tory,zvhlËovaËe,odvlhËovaËe, a.i.</option>

  <option value="8" >elektroz. tr2 a. TelevÌzory,Monitory,obrazovky a.i.</option>
  <option value="32" >elektroz. tr2 b. Notebooky a tablety a Ôaæöie zobrazovacie zariadenia ktorÈ ,obsahuj˙ obrazovky v‰Ëöie ako 100 cm2</option>

  <option value="9" >elektroz. tr3 a. SvetelnÈ zdroje s obsahom ortuti ûiarivky,v˝bojky</option>
  <option value="33" >elektroz. tr3 b. SvetelnÈ zdroje LED a inÈ</option>

  <option value="10" >elektroz. tr4 a. VeækÈ zariadenia s v˝nimkou veæk˝ch svietidiel a fotovoltaick˝ch panelov</option>
  <option value="34" >elektroz. tr4 b. VeækÈ svietidl· s vonkajöÌm rozmerom viac ako 50 cm</option>
  <option value="35" >elektroz. tr4 c. FotovoltaickÈ panely</option>

  <option value="11" >elektroz. tr5 a. MalÈ zariadenia s ak˝mkoævek  vonkajöÌm rozmerom menej ako 50cm</option>
  <option value="36" >elektroz. tr5 b. MalÈ svietidl· s vonkajöÌm rozmerom menej ako 50 cm do hmotnosti 3 kg vr·tane</option>
  <option value="37" >elektroz. tr5 c. MalÈ svietidl· s vonkajöÌm rozmerom menej ako 50 cm nad hmotnosù 3kg</option>

  <option value="12" >elektroz. tr6 a. MalÈ IT a telekomunikaËnÈ zariadenia s ak˝mkoævek rozmerom menej ako 50 cm</option>
