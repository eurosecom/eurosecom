...
$hhmmss = Date ("is", MkTime (date("H"),date("i"),date("s"),date("m"),date("d"),date("Y")));
 ...
 $outfilexdel="../tmp/hlkni_".$kli_uzid."_*.*";
 foreach (glob("$outfilexdel") as $filename) {
    unlink($filename);
 }

$outfilex="../tmp/hlkni_".$kli_uzid."_".$hhmmss.".pdf";
...
<title>Hlavn· kniha poloûkovit·</title>
  <style type="text/css">
...
$pdf->Cell(110,5,"Hlavn· kniha za $vyb_ume  - poloûkovit· ","LTB",0,"L");
...
if( $polozka->uro == 1 AND $polozka->ur1 == 0 )
   {
if( $tlac == 1 ) {
$pdf->Cell(90,5,"PoËiatok $polozka->uce za obdobie $vyb_ume","T",0,"L");
