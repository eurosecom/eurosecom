...
if( confirm ("Chcete zmazaù prijÌmateæa Ë.<?php echo $cislo_p1cpl; ?> ?") )
         { location.href='priznanie_dppriloha2018.php?copern=207&uprav=0&cislo_p1cpl=<?php echo $cislo_p1cpl; ?>&tt=1' }
else
         { location.href='priznanie_dppriloha2018.php?copern=101&uprav=0&cislo_p1cpl=&tt=1' }
</script>
<?php
exit;
    }
...
if( confirm ("Chcete zmazaù projekt Ë.<?php echo $cislo_prcpl; ?> ?") )
         { location.href='priznanie_dppriloha2018.php?copern=1207&uprav=0&cislo_prcpl=<?php echo $cislo_prcpl; ?>&tt=1' }
else
         { location.href='priznanie_dppriloha2018.php?copern=1101&uprav=0&cislo_prcpl=&tt=1' }
</script>
<?php
exit;
    }
...
<div class="navbar">
  ...
  <a href="#" onclick="editForm(14);" class="toleft">14</a>
...
<a href="#" onclick="window.open('priznanie_dppriloha2018.php?copern=101&drupoh=1', '_self')" class="toleft">PrÌj2%</a>
  <a href="#" onclick="window.open('priznanie_dppriloha2018.php?copern=11&drupoh=1', '_blank')" class="<?php echo $clas992; ?> toright">PrÌj2%</a>
  <a href="#" onclick="window.open('priznanie_dppriloha2018.php?copern=1011&drupoh=1', '_blank')" class="<?php echo $clas991; ?> toright">V˝zkum</a>
...
{
?>
<form name="formv1" method="post" action="priznanie_dppriloha2018.php?copern=202&cislo_p1cpl=<?php echo $cislo_p1cpl; ?>">
<input type="submit" id="uloz" name="uloz" value="Uloûiù zmeny" class="btn-top-formsave">
<img src="<?php echo $jpg_source; ?>_str16.jpg" class="form-background" alt="<?php echo $jpg_title; ?> 15.strana">
<span class="text-echo" style="top:75px; left:337px;"><?php echo $fir_fdic; ?></span>
<!-- PRILOHA k IV.casti -->
<input type="text" name="p1cis" id="p1cis" style="width:86px; top:154px; left:219px;"/>
...
{
?>
<form name="formv1" method="post" action="priznanie_dppriloha2018.php?copern=1202&cislo_prcpl=<?php echo $cislo_prcpl; ?>">
<input type="submit" id="uloz" name="uloz" value="Uloûiù zmeny" class="btn-top-formsave">
<img src="<?php echo $jpg_source; ?>_str15.jpg" class="form-background" alt="<?php echo $jpg_title; ?> 14.strana">
<span class="text-echo" style="top:75px; left:337px;"><?php echo $fir_fdic; ?></span>
...
//PRIJIMATEL
//cislo
$text=sprintf('% 4s',$hlavicka->p1cis);
if ( $druh == 3 OR $hlavicka->pzano == 1 ) { $text=""; }
$t01=substr($text,0,1);
$t02=substr($text,1,1);
$t03=substr($text,2,1);
$t04=substr($text,3,1);
$pdf->Cell(38,7," ","$rmc1",0,"C");$pdf->Cell(4.5,6,"$t01","$rmc",0,"C");
...
//Z ciarky na bodku
  ...
  {
   window.open('../ucto/priznanie_dppriloha2018.php?copern=336&uprav=0', '_self')
  }
  function UpravPrmatel(p1cpl)
  {
   window.open('../ucto/priznanie_dppriloha2018.php?copern=203&uprav=0&cislo_p1cpl=' + p1cpl + '&tt=1', '_self')
  }
  function ZmazPrmatel(p1cpl)
  {
   window.open('../ucto/priznanie_dppriloha2018.php?copern=206&uprav=0&cislo_p1cpl=' + p1cpl + '&tt=1', '_self')
  }

  function NovyProj()
  {
   window.open('../ucto/priznanie_dppriloha2018.php?copern=1336&uprav=0', '_self')
  }
  function UpravProj(prcpl)
  {
   window.open('../ucto/priznanie_dppriloha2018.php?copern=1203&uprav=0&cislo_prcpl=' + prcpl + '&tt=1', '_self')
  }
  function ZmazProj(prcpl)
  {
   window.open('../ucto/priznanie_dppriloha2018.php?copern=1206&uprav=0&cislo_prcpl=' + prcpl + '&tt=1', '_self')
  }
