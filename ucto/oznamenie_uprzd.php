...
<tr class="body">
 ...
 <td align="right">
  ...
  <img src="../obr/ikony/upbox_blue_icon.png" onclick="DMVdoXML(<?php echo $rsluz->cpl; ?>, '<?php echo $rsluz->zodic; ?>');" title="Export do XML"> <!-- dopyt, aktualizovaù -->
&nbsp;&nbsp;&nbsp;</td>
</tr>
<?php
 }
...
<div id="wrap-heading">
 <table id="heading">
  ...
  <tr>
   <td class="header">Ozn·menie v176 / Export XML - <span class="subheader"><?php echo "DI» $cislo_dic";?></span></td>
   <td></td>
  </tr>
 </table>
</div>
...
<?php
$upozorni1=1;
echo "DI» $hlavicka->zodic, nie je vyplnenÈ <strong>zdaÚovacie obdobie</strong> ozn·menia.";
?>
</li>
<?php
}
...
<?php
$upozorni2=1;
echo "DI» $hlavicka->zodic, nie je vyplnen· <strong>suma</strong> ozn·menia.";
?>
</li>
<?php
}
...
<?php
$upozorni1=1;
echo "DI» $hlavicka->zodic, nie je vyplnen˝ <strong>d·tum vypracovania</strong> ozn·menia.";
?>
</li>
<?php
}
