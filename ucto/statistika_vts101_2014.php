...
<HTML>
<?php
//celkovy zaciatok dokumentu VTS 101 rok 2014
do
{
$sys = 'UCT';
$urov = 2000;
...
//Z ciarky na bodku
  ...
  function TlacVykaz()
  {
   window.open('../ucto/statistika_vts101_2014.php?copern=11&strana=9999', '_blank');
  }
  ...
  {
   window.open('../ucto/statistika_vts101_2014.php?copern=200&drupoh=1&page=1', '_self');
  }
...
<FORM name="formv1" method="post" action="statistika_vts101_2014.php?copern=103&strana=<?php echo $strana; ?>">
<?php
...
$source="statistika_vts101_2014.php?";
?>
<div class="navbar">
