...
&nbsp;&nbsp;&nbsp;
<img src='../obr/vlozit.png' border="1" onclick="UhradyDok();" width="15" height="15" title="⁄hrady pre OdpoËet a uplatnenie DPH aû po prijatÌ platby" >
<?php                                       } ?>
       </td>
<?php                                 } ?>
<?php if( $_SESSION['nieie'] == 1 )  { ?>
...
?>
<br />
<span id="overicdph" style="display:blok; width:100%; align:center; font-family:bold; font-weight:bold; background-color:white; color:black;">Skontrolujte si spr·vne nahratÈ I» DPH = <?php echo $akeicd ?></span> &nbsp;&nbsp;&nbsp;&nbsp;<a href="#" title="Pre spr·vne vytvorenie KontrolnÈho v˝kazu DPH je dÙleûitÈ aby ste mali v ËÌselnÌku I»O spr·vne I» DPH !!!" onclick="OverIcdph();" >Overovanie I» DPH</a>
<br />
<br />
<?php
