...
$jpg_title="tlaËivo Ozn·menie o vykonanÌ ˙pravy z·kladu dane pre rok $kli_vrok $strana.strana";
...
<!-- pocet 2.stran -->
<div class="input-echo" style="width:105px; top:1019px; left:190px;"></div><!-- dopyt,nie je vypoËÌtanÈ -->
<?php                                        } ?>
...
<img src='../obr/ikony/searchl_blue_icon.png' id="buttjson" name="buttjson" title="Vyhæadaù DI»" class="btn-row-tool" style="top:241px; left:290px;">
...
$outfilex="../tmp/oznuprzd_".$kli_uzid."_".$hhmmss.".xml";
