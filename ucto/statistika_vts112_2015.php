...
//Z ciarky na bodku
  ...
  function TlacVykaz()
  {
   window.open('../ucto/statistika_vts112_2015.php?copern=11&drupoh=1&page=1&typ=PDF', '_blank');
  }
  ...
  {
   window.open('../ucto/statistika_vts112_2015.php?copern=11&drupoh=1&page=1&typ=PDF&zarchivu=1&mesarch=' + mesiac +  '&xxx=1', '_blank', 'width=980, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes, menubar=yes, toolbar=yes');
  }
</script>
</HEAD>
<BODY onload="ObnovUI();">
...
<div id="content">
<FORM name="formv1" method="post" action="statistika_vts112_2015.php?copern=3&strana=<?php echo $strana; ?>">
<?php
$clas1="noactive"; $clas2="noactive";
if ( $strana == 1 ) $clas1="active"; if ( $strana == 2 ) $clas2="active";
$source="statistika_vts112_2015.php";
?>
<div class="navbar">
