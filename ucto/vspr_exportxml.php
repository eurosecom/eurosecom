...
<BODY class="white">
 ...
 <tr>
  <td>EuroSecom  -  Príkaz na úhradu è. <?php echo $cislo_dok; ?> - export do XML</td>
  <td align="right">
...
$instrid="ABC/4562/2008-09-28";

  $text = "   <InstrId>".$instrid."</InstrId>"."\r\n"; fwrite($soubor, $text);

$endtoendid="/VS1234567890/SS1234567890/KS0308";
...
<br />
<br />
Stiahnite si nižšie uvedený súbor XML na Váš lokálny disk a naèítajte do InternetBankingu :
<br />
<br />
