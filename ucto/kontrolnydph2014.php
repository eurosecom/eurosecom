...
if( $kli_vrok > 2016 )
  {
$texta2="⁄daje z vyhotovenej fakt˙ry o dodanÌ tovarov, ktor˙ bol platiteæ dane povinn˝ vyhotoviù podæa ß 71 aû 75 z·kona, pri ktor˝ch je osobou povinnou platiù daÚ prÌjemca plnenia podæa ß 69 ods. 12 pÌsm. f) aû j) z·kona";
  }
...
$textb3="⁄daje zo vöetk˝ch prijat˝ch zjednoduöen˝ch fakt˙r podæa ß 74 ods. 3 pÌsm. a) aû c) z·kona, z ktor˝ch prÌjemca plnenia uplatÚuje odpoËÌtanie dane (ak je celkov· suma odpoËÌtanej dane za prÌsluönÈ zdaÚovacie obdobie menej ako 3 000 eur)";
$textb3s1p1="Celkov· suma z·kladov dane";
$textb3s1p2="v eur·ch";
$textb3s2p1="Celkov· suma dane";
$textb3s2p2="v eur·ch";
...
$textb3="⁄daje zo vöetk˝ch prijat˝ch zjednoduöen˝ch fakt˙r podæa ß 74 ods. 3 pÌsm. a) aû c) z·kona, z ktor˝ch prÌjemca plnenia uplatÚuje odpoËÌtanie dane (ak je celkov· suma odpoËÌtanej dane za prÌsluönÈ zdaÚovacie obdobie 3 000 eur a viac)";
$textb3s1p1="IdentifikaËnÈ ËÌslo pre daÚ";
$textb3s1p2="dod·vateæa";
$textb3s2p1="Celkov· suma z·kladov dane";
$textb3s2p2="v eur·ch";
$textb3s3p1="Celkov· suma dane";
$textb3s3p2="v eur·ch";
$textb3s4p1="Celkov· suma odpoËÌtanej dane";
$textb3s4p2="v eur·ch";
$textb3s5p1="KÛd opravy";
$textb3s5p2="(ËÌslo dokladu)";
$pdf->SetY(6);
$pdf->Cell(277,4.5," ","$rmc",1,"L");
...
$textc1s7p3="[tovar podæa ß 69 ods. 12";
$textc1s7p4="pÌsm. f) a g) z·kona]";
$textc1s8p1="Druh tovaru";
$textc1s8p2="[tovar podæa";
...
<td class="bmenu" colspan="7">Nulov˝ Z·klad alebo DPH ?!?</td>
<?php                            } ?>
<?php if( $hlavicka->er1 == 11 ) { ?>
<td class="bmenu" colspan="7">Fakt˙ra z oddielu A2 nem· iËDPH</td>
<?php                            } ?>
