...
$sql = "SELECT * FROM F$kli_vxcf"."_crs_pod2014";
$vysledok = mysql_query("$sql");
if ($vysledok)
          {
$polx = mysql_num_rows($vysledok);
$sql = "DROP TABLE F$kli_vxcf"."_crs_pod2014";
...
if( $copern == 10 )
{
//nastav crs podla uce ale nie z uctosnova ako pri podnikatelskych ale z crs_pod2014.csv v adresary /import
$sql = "DROP TABLE F$kli_vxcf"."_crs_pod2014";
//$vysledok = mysql_query("$sql");
...
if (!$vysledok)
          {
echo "Vytvorit tabulku F$kli_vxcf"."_crs_pod2014!"."<br />";
...
$sql = 'CREATE TABLE F'.$kli_vxcf.'_crs_pod2014'.$sqlt;
...
//koniec tabulky crs_pod2014


$sqtoz = "UPDATE F$kli_vxcf"."_prcsuvahas$kli_uzid,F$kli_vxcf"."_crs_pod2014".
" SET rdk=F$kli_vxcf"."_crs_pod2014.crs".
" WHERE LEFT(F$kli_vxcf"."_prcsuvahas$kli_uzid.uce,3) = LEFT(F$kli_vxcf"."_crs_pod2014.uce,3) ";
//echo $sqtoz;
$oznac = mysql_query("$sqtoz");

$sqtoz = "UPDATE F$kli_vxcf"."_prcsuvahas$kli_uzid,F$kli_vxcf"."_crs_pod2014".
" SET rdk=F$kli_vxcf"."_crs_pod2014.crs".
" WHERE LEFT(F$kli_vxcf"."_prcsuvahas$kli_uzid.uce,5) = LEFT(F$kli_vxcf"."_crs_pod2014.uce,5) ";
//echo $sqtoz;
$oznac = mysql_query("$sqtoz");

$sqtoz = "UPDATE F$kli_vxcf"."_prcsuvahas$kli_uzid,F$kli_vxcf"."_crs_pod2014".
" SET rdk=F$kli_vxcf"."_crs_pod2014.crs".
" WHERE LEFT(F$kli_vxcf"."_prcsuvahas$kli_uzid.uce,6) = LEFT(F$kli_vxcf"."_crs_pod2014.uce,6) ";
//echo $sqtoz;
$oznac = mysql_query("$sqtoz");

//Tabulka uctsyngensuv_pod2014
$sql = "SELECT * FROM F$kli_vxcf"."_uctsyngensuv_pod2014";
$vysledok = mysql_query("$sql");
if ($vysledok)
          {
$polx = mysql_num_rows($vysledok);
$sql = "DROP TABLE F$kli_vxcf"."_uctsyngensuv_pod2014";
...
if (!$vysledok)
          {
echo "Vytvorit tabulku F$kli_vxcf"."_uctsyngensuv_pod2014!"."<br />";

$sqlt = <<<uctsyngensuv_pod2014
(
   cpl         int not null auto_increment,
   dok         VARCHAR(10),
   ucm         DECIMAL(10,0),
...
uctsyngensuv_pod2014;

$sql = 'CREATE TABLE F'.$kli_vxcf.'_uctsyngensuv_pod2014'.$sqlt;
$vysledek = mysql_query("$sql");
...
//koniec tabulky uctsyngensuv_pod2014


//pozri co mame synteticky(zmen cislo riadku) a podla zostatku ( zmen cislo riadku )
$sqltt = "SELECT * FROM F".$kli_vxcf."_uctsyngensuv_pod2014 WHERE dok != '' ";
$jesynt=0;
$pol=0;
...
$sqtoz = "UPDATE F$kli_vxcf"."_prcsuvahas$kli_uzid,F$kli_vxcf"."_uctsyngensuv_pod2014".
" SET rdk=F$kli_vxcf"."_uctsyngensuv_pod2014.ucm, uce=F$kli_vxcf"."_uctsyngensuv_pod2014.dok ".
" WHERE LEFT(F$kli_vxcf"."_prcsuvahas$kli_uzid.uce,3) = F$kli_vxcf"."_uctsyngensuv_pod2014.dok ";
//echo $sqtoz;
$oznac = mysql_query("$sqtoz");
...
$sqtoz = "UPDATE F$kli_vxcf"."_prcsuvahas$kli_uzid,F$kli_vxcf"."_uctsyngensuv_pod2014".
" SET rdk=F$kli_vxcf"."_uctsyngensuv_pod2014.ucd, F$kli_vxcf"."_prcsuvahas$kli_uzid.hod=-1*F$kli_vxcf"."_prcsuvahas$kli_uzid.hod  ".
" WHERE LEFT(F$kli_vxcf"."_prcsuvahas$kli_uzid.uce,3) = F$kli_vxcf"."_uctsyngensuv_pod2014.dok ".
" AND F$kli_vxcf"."_prcsuvahas$kli_uzid.hod < 0  AND F$kli_vxcf"."_uctsyngensuv_pod2014.ucd > 0 ";
//echo $sqtoz;
$oznac = mysql_query("$sqtoz");
...
"SUM(r121),SUM(r122),SUM(r123),SUM(r124),SUM(r125),SUM(r126),SUM(r127),SUM(r128),SUM(r129),SUM(r130),".
"SUM(r131),SUM(r132),SUM(r133),SUM(r134),SUM(r135),SUM(r136),SUM(r137),SUM(r138),SUM(r139),SUM(r140),".
"SUM(r141),SUM(r142),SUM(r143),SUM(r144),SUM(r145),SUM(r146),SUM(r147),SUM(r148),SUM(r149),".
...
" r136=r137+r138, ".
" r123=r124+r125+r126, ".
" r122=r123+r127+r128+r129+r130+r131+r132+r133+r134+r135, ".
" r118=r119+r120 ".
" WHERE prx = 1 ";
$oznac = mysql_query("$sqtoz");
...
" r87=r88+r89, ".
" r81=r82+r83+r84, ".
" r80=r81+r85+r86+r87+r90+r93+r97+r100, ".
" r79=r80+r101+r141 ".
" WHERE prx = 1 ";
$oznac = mysql_query("$sqtoz");
...
$vsql = 'DROP TABLE F'.$kli_vxcf.'_uctsuvpodzaok';
...
$vsql = 'CREATE TABLE F'.$kli_vxcf.'_uctsuvpodzaok'.$sqlt;
$vytvor = mysql_query("$vsql");
...
$sqltt = "UPDATE F$kli_vxcf"."_uctsuvpodzaok SET cislcent=UNIX_TIMESTAMP(datcent) ";
$sql = mysql_query("$sqltt");
                }
...
$sql = mysql_query("$sqltt");
$sqltt = "UPDATE F$kli_vxcf"."_uctsuvpodzaok SET cislzaok=UNIX_TIMESTAMP(datzaok), hospeura=hospcent ";
$sql = mysql_query("$sqltt");

$sqltt = "UPDATE F$kli_vxcf"."_uctsuvpodzaok SET hosprozd=hospzaok-hospeura, cislrozd=cislzaok-cislcent, umerozd=umezaok-umecent, cxx=cxx+1 ";
$sql = mysql_query("$sqltt");
                }
...
if( $tis > 0 AND $cislo_rdk > 0 )
     {
$sqtoz = "SELECT * FROM F$kli_vxcf"."_uctsuvpodzaok "; $exis = mysql_query("$sqtoz");
if( $exis )
{
$hosprozd=0;
$umerozd=1;
$cislrozd=1000;
$sqltt = "SELECT * FROM F$kli_vxcf"."_uctsuvpodzaok "; 
$sqldok = mysql_query("$sqltt");
  if (@$zaznam=mysql_data_seek($sqldok,0))
  {
  $riaddok=mysql_fetch_object($sqldok);
...
window.open('../ucto/vykzis_pod2014.php?copern=10&drupoh=1&jazyk=<?php echo $jazyk; ?>&tis=<?php echo $tis; ?>&h_zos=<?php echo $h_zos; ?>&h_sch=<?php echo $h_sch; ?>&h_drp=<?php echo $h_drp; ?>&page=1&kompletka=1&lenvzs=<?php echo $lenvzs; ?>&lensuv=<?php echo $lensuv; ?>', '_self' )
...
window.open('../ucto/vykzis_pod2014.php?copern=10&drupoh=1&jazyk=<?php echo $jazyk; ?>&tis=<?php echo $tis; ?>&h_zos=<?php echo $h_zos; ?>&h_sch=<?php echo $h_sch; ?>&h_drp=<?php echo $h_drp; ?>&page=1&kompletka=0&lenvzs=<?php echo $lenvzs; ?>&lensuv=<?php echo $lensuv; ?>', '_self' )
