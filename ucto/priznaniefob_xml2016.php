...
<div id="wrap-heading">
 <table id="heading">
  ...
  <tr>
   <td class="header">DaÚ z prÌjmov FOB / Export XML - <span class="subheader"><?php echo "$dmeno $dprie";?></span></td>
   <td></td>
  </tr>
 </table>
</div>
...
{
$upozorni14=1;
echo "Na strane 3 pri vyplnenom riadku preuk·zateænÈ zaplatenÈ poistnÈ musÌ byù vyplnen˝ <strong>riadok 12 alebo 14</strong> v PrÌlohe 2 priznania.";
}
?>
</li>
</ul>
