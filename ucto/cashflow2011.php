...
$mena2 = $fir_mena2;
$kurz12 = $fir_kurz12;
if (File_Exists ("../tmp/cash.$kli_uzid.pdf")) { $soubor = unlink("../tmp/cash.$kli_uzid.pdf"); }
...
$pdf->Output("../tmp/cash.$kli_uzid.pdf");
...
<script type="text/javascript">
  var okno = window.open("../tmp/cash.<?php echo $kli_uzid; ?>.pdf","_self");
</script>
