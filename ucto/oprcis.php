...
?>
<script type="text/javascript">
if( !confirm ("Chcete naËÌtaù ötandartn˝ ËÌselnÌk generovania S˙vaha NUJ ?") )
         { window.close()  }
else
...
echo "Zatvorte okno generovania a kliknite na vytvorenie S˙vahy NUJ - Program naËÌta ötandartn˝ ËÌselnÌk generovania ";
exit;
...
echo "Zatvorte okno generovania a kliknite na naËÌtanie hodnÙt do v˝kazu FIN 2 - 04 NUJ - Program naËÌta ötandartn˝ ËÌselnÌk generovania FIN 2 - 04 NUJ";
exit;
...
echo "Zatvorte okno generovania a kliknite na naËÌtanie hodnÙt do v˝kazu FIN 2 - 04 POD - Program naËÌta ötandartn˝ ËÌselnÌk generovania FIN 2 - 04 POD";
exit;
...
echo "Zatvorte okno generovania a kliknite na naËÌtanie hodnÙt do v˝kazu FIN 7 - 04 - Program naËÌta ötandartn˝ ËÌselnÌk generovania FIN 7 - 04";
exit;
