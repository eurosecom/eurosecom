...
<HTML>
<?php
//dmv 2019 nove oznamenie o zaniku
do
{
$sys = 'UCT';
$urov = 3000;
...
<?php              } ?>
<?php if ( $kli_vrok >= 2016 ) { ?>
   window.open('../dokumenty/dan_z_prijmov2016/dpdmv2016/dmv_v16_poucenie.pdf', '_blank', 'width=1080, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes');
<?php              } ?>
  }
  function Sadzby2015()
  {
...
<tr>
 <th rowspan="2">#</th>
 <th rowspan="2" align="left">E»V</th>
...
?>
 ...
 <td align="left" colspan="6" style="color:#999;">Spolu vozidl·&nbsp;&nbsp;&nbsp;<strong><?php echo $cisloi; ?></strong></td>
...
$hhmmss = Date ("His", MkTime (date("H"),date("i"),date("s"),date("m"),date("d"),date("Y")));
 ...
 $outfilexdel="../tmp/dpdmv_".$kli_uzid."_*.*";
 foreach (glob("$outfilexdel") as $filename) {
    unlink($filename);
 }

$outfilex="../tmp/dpdmv_".$kli_uzid."_".$hhmmss.".pdf";
...
//potvrdenie o podani
$potvrd = 1*$_REQUEST['potvrd'];
if ( $copern == 10 AND $potvrd == 1 )
  {

$hhmmss = Date ("His", MkTime (date("H"),date("i"),date("s"),date("m"),date("d"),date("Y")));

 $outfilexdel="../tmp/dpdmvp_".$kli_uzid."_*.*";
 foreach (glob("$outfilexdel") as $filename) {
    unlink($filename);
 }

$outfilex="../tmp/dpdmvp_".$kli_uzid."_".$hhmmss.".pdf";
if (File_Exists ("$outfilex")) { $soubor = unlink("$outfilex"); }
...
$hhmmss = Date ("His", MkTime (date("H"),date("i"),date("s"),date("m"),date("d"),date("Y")));
 ...
 $outfilexdel="../tmp/dpdmvo_".$kli_uzid."_*.*";
 foreach (glob("$outfilexdel") as $filename) {
    unlink($filename);
 }

$outfilex="../tmp/dpdmvo_".$kli_uzid."_".$hhmmss.".pdf";
if (File_Exists ("$outfilex")) { $soubor = unlink("$outfilex"); }
...
$pdf->SetLeftMargin(8);
$pdf->SetTopMargin(10);
if (File_Exists ('../dokumenty/tlacivo2019/dpdmv/dmv_v19_oznamenie_str1.jpg') )
{
$pdf->Image('../dokumenty/tlacivo2019/dpdmv/dmv_v19_oznamenie_str1.jpg',0,0,210,297);
}
$pdf->SetY(10);
...
$pdf->SetLeftMargin(8);
$pdf->SetTopMargin(10);
if (File_Exists ('../dokumenty/tlacivo2019/dpdmv/dmv_v19_oznamenie_str2.jpg') )
{
$pdf->Image('../dokumenty/tlacivo2019/dpdmv/dmv_v19_oznamenie_str2.jpg',0,0,210,297);
}
$pdf->SetY(10);
...
$t09=substr($text,8,1);
$t10=substr($text,9,1);
$pdf->Cell(80,6," ","$rmc1",0,"R");$pdf->Cell(5,6,"$t01","$rmc",0,"C");$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t02","$rmc",0,"C");
$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t03","$rmc",0,"C");$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t04","$rmc",0,"C");
$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t05","$rmc",0,"C");$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t06","$rmc",0,"C");
$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t07","$rmc",0,"C");$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t08","$rmc",0,"C");
$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t09","$rmc",0,"C");$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t10","$rmc",1,"C");
...
$t06=substr($text,9,1);
$pdf->SetY(67);
$pdf->Cell(181.5,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t05","$rmc",0,"C");$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t06","$rmc",1,"C");
...
$t09=substr($text,8,1);
$t10=substr($text,9,1);
$pdf->SetY(83); $pdf->SetX(11.5);
$pdf->Cell(5,6,"$t01","$rmc",0,"C");$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t02","$rmc",0,"C");
$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t03","$rmc",0,"C");$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t04","$rmc",0,"C");
$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t05","$rmc",0,"C");$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t06","$rmc",0,"C");
$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t07","$rmc",0,"C");$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t08","$rmc",0,"C");
$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t09","$rmc",0,"C");$pdf->Cell(1,6," ","$rmc1",0,"C");$pdf->Cell(4,6,"$t10","$rmc",1,"C");
...
//vypracoval, dna, telefon
if ( $fir_mzdt05 == '' ) $fir_mzdt05=$kli_uzmeno." ".$kli_uzprie;
$pdf->SetY(254); $pdf->SetX(11.5);
$pdf->Cell(5,6,"$fir_mzdt05","$rmc",1,"L");


$pdf->SetY(254); $pdf->SetX(133);
$text=$fir_mzdt04;
$t01=substr($text,0,1);
$t02=substr($text,1,1);
$t03=substr($text,2,1);
...
$t12=substr($text,11,1);
$t13=substr($text,12,1);
$pdf->Cell(5,7,"$t01","$rmc",0,"C");$pdf->Cell(1,7," ","$rmc1",0,"C");$pdf->Cell(4,7,"$t02","$rmc",0,"C");
$pdf->Cell(1,7," ","$rmc1",0,"C");$pdf->Cell(4,7,"$t03","$rmc",0,"C");$pdf->Cell(1,7," ","$rmc1",0,"C");$pdf->Cell(4,7,"$t04","$rmc",0,"C");
$pdf->Cell(1,7," ","$rmc1",0,"C");$pdf->Cell(4,7,"$t05","$rmc",0,"C");$pdf->Cell(1,7," ","$rmc1",0,"C");$pdf->Cell(4,7,"$t06","$rmc",0,"C");
$pdf->Cell(1,7," ","$rmc1",0,"C");$pdf->Cell(4,7,"$t07","$rmc",0,"C");$pdf->Cell(1,7," ","$rmc1",0,"C");$pdf->Cell(4,7,"$t08","$rmc",0,"C");
$pdf->Cell(1,7," ","$rmc1",0,"C");$pdf->Cell(4,7,"$t09","$rmc",0,"R");$pdf->Cell(1,7," ","$rmc1",0,"C");$pdf->Cell(4,7,"$t10","$rmc",0,"R");
...
$t11=substr($text,10,1);
$t12=substr($text,11,1);
$pdf->Cell(5,7,"$t01","$rmc",0,"C");$pdf->Cell(4,7,"$t02","$rmc",0,"C");
$pdf->Cell(4,7," ","$rmc",0,"C");$pdf->Cell(4,7,"$t04","$rmc",0,"C");$pdf->Cell(6,7,"$t05","$rmc",0,"C");
$pdf->Cell(13,7," ","$rmc",0,"C");$pdf->Cell(4,7,"$t09","$rmc",0,"C");$pdf->Cell(6,7,"$t10","$rmc",0,"C");
