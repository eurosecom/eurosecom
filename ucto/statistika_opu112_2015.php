...
<title>EuroSecom - výkaz OPU 1-12</title>
<style type="text/css">
img.btn-row-tool {
  width: 18px;
  height: 18px;
...
//Z ciarky na bodku
  ...
  function TlacVykaz()
  {
   window.open('../ucto/statistika_opu112_2015.php?copern=11&drupoh=1&page=1&typ=PDF', '_blank');
  }
  function UdajeFirma()
  {
...
<div id="wrap-heading">
 ...
 <tr>
  <td class="header">Mesaèný výkaz v obchode, pohostinstve a v ubytovaní OPU 1-12</td>
  <td>
   <div class="bar-btn-form-tool">
    ...
    <img src="../obr/ikony/download_blue_icon.png" onclick="NacitajMod124();" title="Naèíta údaje z obratovky" class="btn-form-tool">
    <img src="../obr/ikony/printer_blue_icon.png" onclick="TlacVykaz();" title="Zobrazi v PDF" class="btn-form-tool">
   </div>
  </td>
 </tr>
 </table>
...
<div id="content">
<FORM name="formv1" method="post" action="statistika_opu112_2015.php?copern=3">
 <INPUT type="submit" id="uloz" name="uloz" value="Uloži zmeny" class="btn-top-formsave">

<img src="../dokumenty/statistika2014/opu112/opu112v14_str1.jpg" alt="tlaèivo Mesaèný výkaz v obhchode ... OPU 1-12 302kB" class="form-background">
<?php
$mesiacx=$mesiac;
...
<span class="text-echo" style="top:598px; left:830px;"><?php echo $okres; ?></span>
 <img src="../obr/ikony/pencil_blue_icon.png" onclick="UdajeFirma();"
  title="Nastavi kód okresu" class="btn-row-tool" style="top:596px; left:860px;">
<!-- Vyplnil -->
