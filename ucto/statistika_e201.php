...
// celkovy zaciatok dokumentu E201 2018
       do
       {
$sys = 'UCT';
$urov = 2000;
...
<title>ätatistika E(MZSR) 2-01</title>
  <style type="text/css">
...
<td>EuroSecom  -  
<?php
  if ( $copern == 1 OR $copern == 2 OR $copern == 3 OR $copern == 11 OR $copern == 12 ) { echo " V˝kaz o ekonomike organiz·ciÌ v zdravotnÌctve E(MZSR) 2-01 ";
}
?>
<?php
  if ( $copern == 101 OR $copern == 102 OR $copern == 103 ) { echo " V˝kaz o ekonomike organiz·ciÌ v zdravotnÌctve E(MZSR) 2-01 ";
}
?>
  <a href="#" onClick="window.open('../ucto/statistika_e201.php?copern=11&drupoh=1&page=1&typ=PDF', '_blank', '<?php echo $tlcswin; ?>' )">
<img src='../obr/tlac.png' width=20 height=15 border=0 title='VytlaËiù cel˝ v˝kaz vo form·te PDF' ></a>
  <a href="#" onClick="window.open('../ucto/statistika_e201.php?copern=12&drupoh=1&page=1&typ=PDF', '_blank', '<?php echo $tlcswin; ?>' )">
<img src='../obr/orig.png' width=20 height=15 border=0 title='Vytvoriù XMLs˙bor na odoslanie' ></a>
</td>
...
<FORM name="formv1" class="obyc" method="post" action="statistika_e201.php?copern=2" >
<tr>
<td class="bmenu" width="10%">
<a href="#" onClick="window.open('../ucto/statistika_e201.php?copern=101&drupoh=1&page=1&typ=PDF', '_self', '<?php echo $tlcswin; ?>' )">
4103.,4104.modul</a>
...
<tr><td class="fmenu" colspan="3">5. Trûby ZP v˝kon</td>
...
<tr><td class="fmenu" colspan="3">8. Trûby ZP km min.</td>
<td class="fmenu" colspan="6" align="left"><?php echo "$mod4102s14";?></td></tr>



<tr><td class="fmenu" colspan="3">9. Trûby od ZP za inÈ</td>
<td class="fmenu" colspan="6" align="left"><?php echo "$mod4102s07";?></td></tr>

<tr><td class="fmenu" colspan="3">10. Trûby od obyv. za lieky</td>
<td class="fmenu" colspan="6" align="left"><?php echo "$mod4102s08";?></td></tr>

<tr><td class="fmenu" colspan="3">11. Trûby od obyv. za zdravotnÌcke pomÙcky</td>
<td class="fmenu" colspan="6" align="left"><?php echo "$mod4102s09";?></td></tr>

<tr><td class="fmenu" colspan="3">12. Trûby od obyv. za doplnkov˝ sortiment lek·rnÌ</td>
<td class="fmenu" colspan="6" align="left"><?php echo "$mod4102s10";?></td></tr>

<tr><td class="fmenu" colspan="3">13. Trûby od obyv. za inÈ</td>
<td class="fmenu" colspan="6" align="left"><?php echo "$mod4102s11";?></td></tr>

<tr><td class="fmenu" colspan="3">14. Prev·dzkovÈ dot·cie od zriaÔovateæa</td>
<td class="fmenu" colspan="6" align="left"><?php echo "$mod4102s12";?></td></tr>

<tr><td class="fmenu" colspan="3">15. OstatnÈ v˝nosy</td>
...
<table class="fmenu" width="100%" >
<FORM name="formv1" class="obyc" method="post" action="statistika_e201.php?copern=102" >
<tr>
<td class="bmenu" width="10%">
<a href="#" onClick="window.open('../ucto/statistika_e201.php?copern=1&drupoh=1&page=1&typ=PDF', '_self', '<?php echo $tlcswin; ?>' )">
4101.,4102.modul</a>
</td><td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td>
<td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td>
<td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td>
...
<table class="fmenu" width="100%" >
<FORM name="formv1" class="obyc" method="post" action="statistika_e201.php?copern=3" >
<tr>
<td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td>
<td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td>
<td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td>
...
<FORM name="formv2" class="obyc" method="post" action="statistika_e201.php?copern=1" >
<tr>
...
<table class="fmenu" width="100%" >
<FORM name="formv1" class="obyc" method="post" action="statistika_e201.php?copern=103" >
<tr>
<td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td>
<td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td>
<td class="bmenu" width="10%"></td><td class="bmenu" width="10%"></td>
...
<FORM name="formv2" class="obyc" method="post" action="statistika_e201.php?copern=101" >
<tr>
<td class="obyc" colspan="2"><INPUT type="submit" id="uloz" name="uloz" value="Koniec neuloûiù"></td>
</tr>
</FORM>
...
if( $copern == 11 )
          {
$sqtoz = "UPDATE F$kli_vxcf"."_statistika_e104prac SET zakx=98201 WHERE zakx >= 98201 AND zakx <= 98299 "; 
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_statistika_e104prac SET zakx=98301 WHERE zakx >= 98301 AND zakx <= 98399 "; 
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_statistika_e104prac SET zakx=98601 WHERE zakx >= 98601 AND zakx <= 98699 "; 
$oznac = mysql_query("$sqtoz");
...
//andrejko uprav 2018 rozpisanie sum podla poziadavky 
if( $copern == 11 OR $copern == 12 )
          {
$sqtoz = "UPDATE F$kli_vxcf"."_statistika_e104prac SET mod4102n02=0, mod4102n07=0, mod4102n05=mod4102n05-3.29-0.26  WHERE zakx = 502401 AND mod4102n02 = -3.29"; 
$oznac = mysql_query("$sqtoz");

$sqtoz = "UPDATE F$kli_vxcf"."_statistika_e104prac SET mod4101n03=1880149.25, mod4101n04=132197.69, mod4101n05=104871.98 WHERE zakx = 316001 AND mod4101n03 = 2117218.92 "; 
$oznac = mysql_query("$sqtoz");

$sqtoz = "UPDATE F$kli_vxcf"."_statistika_e104prac SET mod4102n07=1597071.40, mod4102n08=489461.89, mod4102n09=43258.05, mod4102n10=326979.94 WHERE zakx = 316001 AND mod4102n08 = 778611.83  "; 
$oznac = mysql_query("$sqtoz");
...
$sqltt = "SELECT * FROM F$kli_vxcf"."_statistika_e104prac WHERE prx = 2 ORDER BY nstr,zakx ".""; 
...
$strx=1*$hlavicka->strx;
$zakx=1*$hlavicka->zakx;
...
$pdf->Cell(190,6,"E(MZSR) 2-01 V˝kaz o ekonomike organiz·ciÌ v zdravotnÌctve za rok $kli_vrok","0",1,"L");
$pdf->SetFont('arial','',9);
...
if( $nstr != 99999999 ) $pdf->Cell(15,5,"$zakx","1",0,"R");
...
$pdf->Cell(15,5,"ZP v˝kony","1",0,"C");$pdf->Cell(15,5,"body","1",0,"C");$pdf->Cell(15,5,"kapit·cia","1",0,"C");
$pdf->Cell(15,5,"ZP km min","1",0,"C");$pdf->Cell(15,5,"inÈ","1",0,"C");$pdf->Cell(15,5,"lieky","1",0,"C");
$pdf->Cell(15,5,"zdr.pom.","1",0,"C");$pdf->Cell(15,5,"dopl.lek.","1",0,"C");$pdf->Cell(15,5,"inÈ","1",0,"C");
$pdf->Cell(15,5,"dot·cie","1",0,"C");$pdf->Cell(15,5,"OstatnÈ","1",1,"C");
...
$hlavicka=mysql_fetch_object($sql);
  ...
  $text = "<vykazy kodRozhrania=\"E02\" xsi:noNamespaceSchemaLocation=\"iszi_E02.xsd\""."\r\n";
  fwrite($soubor, $text);
...
$kli_telutf = iconv("CP1250", "UTF-8", $fir_mzdt04);
  ...
  fwrite($soubor, $text);
  $text = "<AUTOR_XML>Coex s.r.o. Senica</AUTOR_XML>"."\r\n";
  fwrite($soubor, $text);
...
if( $druhstr == 9 ) $druhstr="0";
  ...
  $text = "<CIS_DUTV1>".$druhstr."</CIS_DUTV1>"."\r\n";
  fwrite($soubor, $text);
...
if( $druhstr == 9 ) $druhstr="0";
  ...
  $text = "<CIS_DUTV2>".$druhstr."</CIS_DUTV2>"."\r\n";
  fwrite($soubor, $text);
...
if( $druhstr == 9 ) $druhstr="0";
  ...
  $text = "<CIS_DUTV3>".$druhstr."</CIS_DUTV3>"."\r\n";
  fwrite($soubor, $text);
