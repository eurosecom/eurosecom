...
if( !confirm ("Chcete naËÌtaù IBANy zr·ûok zamestnancov z miezd ? ") )
         { window.close()  }
else
...
{
$x_txx="*** ".$rovnvsy." rovnakÈ vsy ".$riadok->vsy;
...
&cislo_uce=<?php echo $cislo_uce;?>', '_self' )">
<img src='../obr/vlozit.png' width=15 height=15 border=0 title="NaËÌtaù IBANy pre zr·ûky zamestnancov z miezd" ></a>
