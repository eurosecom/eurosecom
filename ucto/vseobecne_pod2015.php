...
//Z ciarky na bodku
  ...
  function tlacVseob()
  {
   window.open('vseobecne_pod2015.php?copern=10&drupoh=1&page=1&subor=0&cislo_oc=<?php echo $cislo_oc;?>', '_blank');
  }
</script>
</HEAD>
...
<div id="content">
<FORM name="formv1" method="post" action="vseobecne_pod2015.php?copern=23&cislo_oc=<?php echo $cislo_oc;?>">
