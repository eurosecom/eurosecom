<HTML>
<?php
//VYHODNOTENIE UHRAD ZA DEALEROV ALCHEM "CHEMIA" rok 2015
$sys = 'UCT';
$urov = 1000;
...
//ikona CHEM  1. polrok 2015 agrochemikálie, osivá
//platia èísla faktúr 3255..., 3257..., 3254..., 3250.... a 425...
...
$dsqlt = "UPDATE F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid SET pox1=0 WHERE fak >= 32400001 AND fak <= 32409999 AND puc >= 180 ";
$dsql = mysql_query("$dsqlt");

$dsqlt = "UPDATE F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid SET pox1=0 WHERE fak >= 3249001 AND fak <= 3249999 AND puc >= 180 ";
$dsql = mysql_query("$dsqlt");

$dsqlt = "UPDATE F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid SET pox1=0 WHERE fak >= 3244001 AND fak <= 3244999 AND puc >= 180 ";
$dsql = mysql_query("$dsqlt");

$dsqlt = "UPDATE F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid SET pox1=0 WHERE fak >= 3247001 AND fak <= 3247999 AND puc >= 180 ";
$dsql = mysql_query("$dsqlt");

$dsqlt = "UPDATE F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid SET pox1=0 WHERE fak >= 3245001 AND fak <= 3245999 AND puc >= 180 ";
$dsql = mysql_query("$dsqlt");

$dsqlt = "UPDATE F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid SET pox1=0 WHERE fak >= 424001 AND fak <= 424999 AND puc >= 180 ";
$dsql = mysql_query("$dsqlt");
...
//rok 2015
$dsqlt = "UPDATE F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid SET pox1=0 WHERE fak >= 32500001 AND fak <= 32509999 ";
$dsql = mysql_query("$dsqlt");

$dsqlt = "UPDATE F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid SET pox1=0 WHERE fak >= 3259001 AND fak <= 3259999 ";
$dsql = mysql_query("$dsqlt");

$dsqlt = "UPDATE F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid SET pox1=0 WHERE fak >= 3254001 AND fak <= 3254999 ";
$dsql = mysql_query("$dsqlt");

$dsqlt = "UPDATE F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid SET pox1=0 WHERE fak >= 3257001 AND fak <= 3257999 ";
$dsql = mysql_query("$dsqlt");

$dsqlt = "UPDATE F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid SET pox1=0 WHERE fak >= 3255001 AND fak <= 3255999 ";
$dsql = mysql_query("$dsqlt");

$dsqlt = "UPDATE F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid SET pox1=0 WHERE fak >= 425001 AND fak <= 425999 ";
$dsql = mysql_query("$dsqlt");
...
$datvymaz="2015-07-01";
if( $h_obd ==  9 ) { $datvymaz="2015-10-01"; }
if( $h_obd == 12 ) { $datvymaz="2016-01-01"; }

$dsqlt = "DELETE FROM F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid WHERE dat >= '$datvymaz' ";
$dsql = mysql_query("$dsqlt");

$dsqlt = "DELETE FROM F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid WHERE das < '2015-01-01' ";
$dsql = mysql_query("$dsqlt");
