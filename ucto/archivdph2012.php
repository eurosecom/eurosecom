...
" AND F$kli_vxcf"."_archivdph".$kli_uzid.".druh = 1 ".
"";
...
$uprtxt = "UPDATE F$kli_vxcf"."_archivdph SET r19orig=r21 WHERE r19orig = 0"; 
$upravene = mysql_query("$uprtxt");

$uprtxt = "UPDATE F$kli_vxcf"."_archivdph SET r18orig=r20 WHERE r18orig = 0"; 
$upravene = mysql_query("$uprtxt");
...
" WHERE ume = $cislo_ume AND druh = $cislo_druh AND stvrtrok = $cislo_stvrt ";
...
$sqtoz = "UPDATE F$kli_vxcf"."_archivdph".
" SET r34=r31-r32-r33 ".
" WHERE r31 >= 0 AND  ume = $cislo_ume AND druh = $cislo_druh AND stvrtrok = $cislo_stvrt ";
$oznac = mysql_query("$sqtoz");
...
$zmazttt = "DELETE FROM F$kli_vxcf"."_archivdph WHERE ume = $cislo_ume AND druh = $cislo_druh AND stvrtrok = $cislo_stvrt  "; 
//echo $zmazttt;
$zmazane = mysql_query("$zmazttt"); 
$copern=80;
if (!$zmazane):
...
" WHERE ume = $cislo_ume AND druh = $cislo_druh AND stvrtrok = $cislo_stvrt ORDER BY ume,druh";
...
function ZmazPolozku(ume,druh,stvrtrok)
                {
var cislo_ume = ume;
var cislo_druh = druh;
var stvrtrok = stvrtrok;

window.open('../ucto/archivdph2012.php?copern=60&page=1&sysx=UCT&cislo_ume=' + cislo_ume + '&cislo_druh=' + cislo_druh + '&cislo_stvrt=' + stvrtrok + '&drupoh=1&uprav=1',
 '_self' );
                }

function UpravPolozku(ume,druh,stvrtrok)
                {
var cislo_ume = ume;
var cislo_druh = druh;
var stvrtrok = stvrtrok;

window.open('../ucto/archivdph2012.php?copern=20&page=1&sysx=UCT&cislo_ume=' + cislo_ume + '&cislo_druh=' + cislo_druh + '&cislo_stvrt=' + stvrtrok + '&drupoh=1&uprav=1',
 '_self' );
                }

function TlacPolozku(ume,druh,stvrtrok,dap)
                {
var cislo_ume = ume;
var cislo_druh = druh;
var cislo_dap = dap;
...
window.open('../ucto/prizdph2012.php?copern=110&page=1&sysx=UCT&cislo_ume=' + cislo_ume + '&cislo_druh=' + cislo_druh + '&cislo_stvrt=' + stvrtrok + '&cislo_dap=' + cislo_dap + '&drupoh=1&uprav=1&fir_uctx01=<?php echo $fir_uctx01; ?>',
 '_blank', '<?php echo $tlcuwin; ?>' );
                }

function ExportPolozku(ume,druh,stvrtrok,dap)
                {
var cislo_ume = ume;
var cislo_druh = druh;
var cislo_dap = dap;
...
window.open('../ucto/prizdph2012_xml.php?copern=110&page=1&sysx=UCT&cislo_ume=' + cislo_ume + '&cislo_druh=' + cislo_druh + '&cislo_stvrt=' + stvrtrok + '&cislo_dap=' + cislo_dap + '&drupoh=1&uprav=1&fir_uctx01=<?php echo $fir_uctx01; ?>',
 '_blank', '<?php echo $tlcuwin; ?>' );
                }
  ...
  robotmenu.style.display='none';
    ...
    var toprobot = 490;
    var leftrobot = 400;
    var toprobotmenu = 450;
    var leftrobotmenu = 460;
    var widthrobotmenu = 380;

    var htmlmenu = "<table  class='ponuka' width='100%'><tr><td width='80%'>Menu EkoRobot - Koeficient pomernÈho odpoËÌtania DPH</td>" +
    "<td width='20%' align='right'><img border=0 src='../obr/zmazuplne.png' style='width:10; height:10;' onClick='zhasni_menurobot();' title='Zhasni menu' ></td></tr>";  


<?php if( $cislo_druh == 3 ) { ?>

    htmlmenu += "<tr><td width='100%' class='ponuka' colspan='2'>"; 
htmlmenu += "<a href=\"#\" onClick=\"Odpoc('<?php echo $cislo_ume;?>',<?php echo $cislo_druh;?>,<?php echo $stvrtrok;?>);\">" +
...
?>
    ...
    htmlmenu += "<tr><FORM name='fkoef' method='post' action='#' ><td width='100%' class='ponuka' colspan='2'>";
htmlmenu += "Druhy dokladov s pomern˝m uplatnenÌm napr: 34,46,48 ";
    htmlmenu += "<input type='text' name='h_druhykoef' id='h_druhykoef' size='30' maxlenght='30' value='<?php echo $druhykoef; ?>' >"; 
    htmlmenu += "</td></tr>";

    htmlmenu += "<tr><td width='80%' class='ponuka' colspan='1'>";
htmlmenu += "Koeficient z predch·dzaj˙ceho kalend·rneho roka </td><td width='20%' class='ponuka' colspan='1'>";
    htmlmenu += "<input type='text' name='h_koefmin' id='h_koefmin' size='4' maxlenght='4' value='<?php echo $koefmin; ?>' >"; 
    htmlmenu += "</td></tr>";

    htmlmenu += "<tr><td width='100%' class='ponuka' colspan='2'>"; 
htmlmenu += "<a href=\"#\" onClick=\"Prepoc('<?php echo $cislo_ume;?>',<?php echo $cislo_druh;?>,<?php echo $stvrtrok;?>);\">" +
...
<?php if( $prepoc == 1 ) { ?>
    ...
    htmlmenu += "<tr><td width='80%' class='ponuka' colspan='1'>";
htmlmenu += "Suma 20% DPH za pomernÈ druhy celkom </td><td width='20%' class='ponuka' colspan='1'>";
    htmlmenu += "<input type='text' name='h_odpocall' id='h_odpocall' size='10' maxlenght='10' value='<?php echo $odpocall; ?>' >"; 
    htmlmenu += "</td></tr>";

    htmlmenu += "<tr><td width='80%' class='ponuka' colspan='1'>";
htmlmenu += "Suma 20% DPH za pomernÈ druhy upraven· </td><td width='20%' class='ponuka' colspan='1'>";
    htmlmenu += "<input type='text' name='h_odpocupr' id='h_odpocupr' size='10' maxlenght='10' value='<?php echo $odpocupr; ?>' >"; 
    htmlmenu += "</td></tr>";

<?php                    } ?>

    htmlmenu += "<tr><td></td></FORM></tr></table>"; 
  ...
  function Prepoc(ume,druh,stvrtrok)
  { 
...
window.open('../ucto/archivdph2012.php?copern=220&page=1&sysx=UCT&cislo_ume=' + cislo_ume + '&cislo_druh=' + cislo_druh + '&cislo_stvrt=' + stvrtrok +
...
function TlacPotvrdDPH(obdx)
  ...
  function Odpoc(ume,druh,stvrtrok)
  { 
...
window.open('../ucto/archivdph2012.php?copern=230&page=1&sysx=UCT&cislo_ume=' + cislo_ume + '&cislo_druh=' + cislo_druh + '&cislo_stvrt=' + stvrtrok +
...
function TlacZoznam(ume,druh,stvrtrok)
                {
var cislo_ume = ume;
var cislo_druh = druh;
var stvrtrok = stvrtrok;

window.open('../ucto/prizdph2012.php?copern=7020&drupoh=1&page=1&typ=PDF&cislo_ume=' + cislo_ume + '&cislo_druh=' + cislo_druh + '&cislo_stvrt=' + stvrtrok + '&rozdiel=0',
 '_blank', 'width=1080, height=900, top=0, left=10, status=yes, resizable=yes, scrollbars=yes' );
                }

function TlacZoznamRP(ume,druh,stvrtrok)
                {
var cislo_ume = ume;
var cislo_druh = druh;
var stvrtrok = stvrtrok;

window.open('../ucto/prizdph2012.php?copern=7020&drupoh=1&page=1&typ=PDF&cislo_ume=' + cislo_ume + '&cislo_druh=' + cislo_druh + '&cislo_stvrt=' + stvrtrok + '&rozdiel=1',
 '_blank', 'width=1080, height=900, top=0, left=10, status=yes, resizable=yes, scrollbars=yes' );
                }

function TlacZoznamRM(ume,druh,stvrtrok)
                {
var cislo_ume = ume;
var cislo_druh = druh;
var stvrtrok = stvrtrok;

window.open('../ucto/prizdph2012.php?copern=7020&drupoh=1&page=1&typ=PDF&cislo_ume=' + cislo_ume + '&cislo_druh=' + cislo_druh + '&cislo_stvrt=' + stvrtrok + '&rozdiel=2',
 '_blank', 'width=1080, height=900, top=0, left=10, status=yes, resizable=yes, scrollbars=yes' );
                }
...
<td>EuroSecom  -  ArchÌv daÚov˝ch priznanÌ DPH <?php echo $kli_vrok; ?></td>
...
<FORM name="formv1" class="obyc" method="post" action="archivdph2012.php?copern=23
&cislo_ume=<?php echo $cislo_ume;?>&cislo_druh=<?php echo $cislo_druh; ?>&cislo_stvrt=<?php echo $cislo_stvrt; ?>" >
<tr>
...
if( $jearchzoznam == 1 )
     { ?>
<a href="#" onClick="TlacZoznam('<?php echo $cislo_ume;?>',<?php echo $cislo_druh;?>,<?php echo $cislo_stvrt;?>);">
...
if( $jearchzoznam == 1 )
     { ?>
<a href="#" onClick="TlacZoznamRP('<?php echo $cislo_ume;?>',<?php echo $cislo_druh;?>,<?php echo $cislo_stvrt;?>);">
...
<a href="#" onClick="TlacZoznamRM('<?php echo $cislo_ume;?>',<?php echo $cislo_druh;?>,<?php echo $cislo_stvrt;?>);">
...
?>
<tr>
<td class="hmenu" colspan="8" >
<a href="#" onClick="ArchivJCD();">
JCD <img src='../obr/zoznam.png' width=15 height=15 border=0 title='ArchÌv JCD uplatnen˝ch v DPH' ></a>
</tr>
<?php
     }
?>
...
<tr>
<td class="hmenu" width="11%" >mesiac
<td class="hmenu" width="10%" >ötvrùrok
<td class="hmenu" width="15%" >druh
<td class="hmenu" width="23%" align="right" >r31 vlastn· daÚ.povinnosù
<td class="hmenu" width="23%" align="right" >r32 nadmer˝ odpoËet
...
<a href="#" onClick="TlacPolozku('<?php echo $riadok->ume;?>',<?php echo $riadok->druh;?>,<?php echo $riadok->stvrtrok;?>,'<?php echo $riadok->dap;?>');">
...
<td class="fmenu" width="5%" >
<a href="#" onClick="UpravPolozku('<?php echo $riadok->ume;?>',<?php echo $riadok->druh;?>,<?php echo $riadok->stvrtrok;?>);">
<img src='../obr/uprav.png' width=15 height=10 border=0 title='Upraviù riadok' ></a>

<td class="fmenu" width="5%" >
<a href="#" onClick="ExportPolozku('<?php echo $riadok->ume;?>',<?php echo $riadok->druh;?>,<?php echo $riadok->stvrtrok;?>,'<?php echo $riadok->dap;?>');">
<img src='../obr/export.png' width=15 height=10 border=0 title='Export do XML' ></a>

<td class="fmenu" width="5%" >
<a href="#" onClick="ZmazPolozku('<?php echo $riadok->ume;?>',<?php echo $riadok->druh;?>,<?php echo $riadok->stvrtrok;?>);">
