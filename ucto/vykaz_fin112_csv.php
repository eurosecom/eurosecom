...
" 1,zdroj,oddiel,polozka,schvaleny,zmeneny,predpoklad,skutocnost ".
" FROM F$kli_vxcf"."_uctvykaz_fin104".
...
//rozp.polozky
$dotaz = "select * from vyddbf where cast = 1 order by cast,zdroj,oddiel,polozka ";
...
//nerozp.polozky
$dotaz = "select * from vyddbf where cast = 4 order by cast,zdroj,oddiel,polozka ";
