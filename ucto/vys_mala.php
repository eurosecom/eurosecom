...
$poleo = explode(".", $kli_vume);
$_REQUEST['h_obdk'] = 1*$poleo[0];
...
if( $synt == 0 )
{
$pdf->Cell(110,5,"V˝sledovka za $mes_obdp / $mes_obdk","LTB",0,"L");
$pdf->Cell(0,5,"FIR$kli_vxcf $kli_nxcf strana $strana","RTB",1,"R");

$pdf->SetFont('arial','',8);
$pdf->Cell(15,4,"⁄Ëet","1",0,"R");
$pdf->Cell(110,4,"Popis","1",0,"L");
$pdf->Cell(30,4,"$vyb_ume M·Daù","1",0,"R");$pdf->Cell(30,4,"$vyb_ume Dal","1",0,"R");$pdf->Cell(30,4,"$vyb_ume Rozdiel","1",0,"R");
$pdf->Cell(32,4,"Cel˝ rok M·Daù","1",0,"R");$pdf->Cell(0,4,"Cel˝ rok Dal","1",1,"R");
}
...
$pdf->Cell(35,4,"Cel˝ rok M·Daù","1",0,"R");$pdf->Cell(35,4,"Cel˝ rok Dal","1",1,"R");
}
...
//tlac sumare VSETKO
$pdf->Cell(277,2," ","0",1,"R");
$pdf->Cell(50,4,"Celkom vöetky ˙Ëty","LTB",0,"L");
...
$pdf->Cell(70,4,"Hospod·rsky v˝sledok pred zdanenÌm: ","1",0,"L");$pdf->Cell(40,4,"$hvpz","1",1,"R");
$pdf->Cell(70,4,"Hospod·rsky v˝sledok po zdanenÌ: ","1",0,"L");$pdf->Cell(40,4,"$polozka->odl","1",1,"R");
$j = $j + 1;
   }
}
//koniec analyticka
