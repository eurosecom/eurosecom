...
$jpg_popis="tlaËivo FinanËn˝ v˝kaz o plnenÌ rozpoËtu a o nerozpoËtov˝ch pohyboch na ˙Ëtoch verejnej spr·vy FIN 1-12 za rok ".$kli_vrok;
...
if( !confirm ("Chcete naËÌtaù rozpoËet z minnulÈho roka ?") )
         ...
         { location.href='vykaz_fin112_2016.php?copern=1002&strana=1&fin1a12=<?php echo $fin1a12; ?>'  }
</script>
<?php
    }
...
function ZnovuPotvrdenie()
                {
window.open('vykaz_fin112_2016.php?cislo_oc=<?php echo $cislo_oc;?>&copern=26&drupoh=1&page=1&subor=1&fin1a12=<?php echo $fin1a12; ?>',
...
window.open('vykaz_fin112_2016.php?cislo_oc=<?php echo $cislo_oc;?>&copern=26&nostp=' + nostp + '&drupoh=1&page=1&subor=1&fin1a12=<?php echo $fin1a12; ?>', '_self' );
                }
...
<a href="#" onClick="window.open('vykaz_fin112_2016.php?cislo_oc=<?php echo $cislo_oc;?>&copern=10&drupoh=1&page=1&subor=0&strana=9999&fin1a12=<?php echo $fin1a12; ?>',
...
<FORM name="formv1" class="obyc" method="post" action="../ucto/vykaz_fin112_2016.php?copern=23&cislo_oc=<?php echo $cislo_oc;?>&strana=<?php echo $strana;?>&fin1a12=<?php echo $fin1a12; ?>" >
<tr>
...
<a href="#" onClick="window.open('vykaz_fin112_2016.php?copern=20&drupoh=1&page=1&subor=0&cislo_oc=<?php echo $cislo_oc;?>&strana=<?php echo $prev_str;?>&fin1a12=<?php echo $fin1a12; ?>', '_self' )">
<img src='../obr/prev.png' width=12 height=12 border=0 title='Strana <?php echo $prev_str;?> obdobie <?php echo $cislo_oc; ?>' ></a>
<a href="#" onClick="window.open('vykaz_fin112_2016.php?copern=20&drupoh=1&page=1&subor=0&cislo_oc=<?php echo $cislo_oc;?>&strana=<?php echo $next_str;?>&fin1a12=<?php echo $fin1a12; ?>', '_self' )">
...
<a href="#" onClick="window.open('../ucto/vykaz_fin112_2016.php?cislo_oc=<?php echo $cislo_oc;?>&copern=20&drupoh=1&page=1&subor=0&strana=1&fin1a12=<?php echo $fin1a12; ?>', '_self' );">1</a> 

<a href="#" onClick="window.open('../ucto/vykaz_fin112_2016.php?cislo_oc=<?php echo $cislo_oc;?>&copern=20&drupoh=1&page=1&subor=0&strana=2&fin1a12=<?php echo $fin1a12; ?>', '_self' );">2</a>

<a href="#" onClick="window.open('../ucto/vykaz_fin112_2016.php?cislo_oc=<?php echo $cislo_oc;?>&copern=20&drupoh=1&page=1&subor=0&strana=3&fin1a12=<?php echo $fin1a12; ?>', '_self' );">3</a> 

<a href="#" onClick="window.open('../ucto/vykaz_fin112_2016.php?cislo_oc=<?php echo $cislo_oc;?>&copern=20&drupoh=1&page=1&subor=0&strana=4&fin1a12=<?php echo $fin1a12; ?>', '_self' );">4</a>
...
<a href='vykaz_fin112_2016.php?copern=1001&strana=1&fin1a12=<?php echo $fin1a12; ?>'>
