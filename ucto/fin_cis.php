...
<?php
if ( $drupoh >= 91 AND $drupoh <= 96 ) echo ""; //dopyt, Ëo je to za podmienku, je aktu·lna
?>
nastavenie generovania
   </span>
  </h1>
   <div class="bar-btn-form-tool"> <!-- dopyt, prÌpadne zobraù z tlaciva.css -->
<?php if ( $drupoh != 96 AND drupoh != 196 ) { ?> <!-- dopyt, Ëo je to za podmienku, je aktu·lna -->
...
<?php if ( $drupoh >= 91 AND $drupoh <= 96 ) { ?>
 ...
 <a href="#" onclick="window.open('<?php echo $source; ?>&drupoh=97', '_self');"
    title="Fin 7-04 - generovanie" class="<?php echo $clas6; ?>">Fin 7-04</a> <!-- dopyt, keÔ kliknem, tak sa nezobrazÌ liöta so z·loûkami -->
<?php                                        } ?>
</div>
