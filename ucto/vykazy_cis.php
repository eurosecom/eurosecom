...
<script type="text/javascript">
//sirka a vyska okna
var vyskawin = screen.height-175; //dopyt, chcem daù preË
...
<?php if ( $drupoh != 95 AND $drupoh != 96 AND $drupoh != 195 AND $drupoh != 196 ) { ?>
  <th>⁄Ëet</th><th colspan="2">»Ìslo riadku</th>
<?php                                                                              } ?>
<?php if ( $drupoh == 95 OR $drupoh == 195 ) { ?>
  <th>⁄Ëet</th><th>AktÌva</th><th>PasÌva</th>
<?php                                        } ?>
<?php
}
?>
...
{
?>
 <th>S˙vaha <img src='../obr/info.png' width=12 height=12 border=0 title="»Ìslo riadku aktÌv v S˙vahe kam m· program z˙Ëtovaù rozdiel HV po zaokr˙hlenÌ S˙vahy, napr. Ë. 35"> <!-- dopyt, pozor inÈ ËÌslo riadku v title img -->
<?php
}
?>
 </th>
...
?>
<?php if ( $drupoh != 93 AND $drupoh != 193 AND $drupoh != 94 AND $drupoh != 194 ) { ?> <!-- dopyt, oöetriù, aby neukazoval v roku 2013 a staröie -->
