...
a.btn-down {
  display: block; /* dopyt, zos˙ladiù s ostatn˝mi :before, :after */
  float: right;
  line-height: 26px;
  padding: 0 9px 0 7px;
  font-size: 11px;
...
<?php if( $drupoh >= 191 AND $drupoh <= 196 ) { ?> 
   <td class="header">⁄Ëtovn· z·vierka <span class="subheader">Podnikateæskej ˙Ëtovnej jednotky</span> - nastavenie</td>
<?php                                         } ?> 
  <td>
...
<div class="content-navbar toright"> <!-- dopyt, rozchodiù -->
<?php if( $drupoh >=  91 AND $drupoh <=  96 ) { ?> 
 ...
 <a href="#" onclick="window.open('<?php echo $source; ?>&drupoh=95', '_self');"
  title="S˙vaha - generovanie AktÌv / PasÌv" class="<?php echo $clas5; ?> darkgreen">Generovanie A / P</a>
...
if ( $drupoh == 95 OR $drupoh == 195 ) { echo "S˙vaha - Generovanie v˝kazu AktÌva / PasÌva"; }
if ( $drupoh == 96 OR $drupoh == 196 ) { echo "S˙vaha a V˝kaz ziskov a str·t - Nastavenie zaokr˙hlenia"; }
?>
 </h2>
...
<div style="float:right; margin-top: 0px; width: 350px; background-color:; overflow:auto;">
  <a href='vykazy_cis.php?drupoh=<?php echo $drupoh; ?>&copern=4055&page=1'
   title="NaËÌtaù ËÌselnÌk z predch·dzaj˙ce ˙ËtovnÈho obdobia" class="btn-down">Predch. obdobie</a> <!-- dopyt, doprava na liötu spraviù tlaËidlo "naËÌtaù" -->

  <a href='vykazy_cis.php?drupoh=<?php echo $drupoh; ?>&copern=155&page=1'
   title="NaËÌtaù ötandartn˝ ËÌselnÌk" class="btn-down" style=""  >ätandardn˝ ËÌselnÌk</a>
</div>
...
<?php                    } ?>
 <th>
  <a href='vykazy_cis.php?drupoh=<?php echo $drupoh; ?>&copern=4055&page=1'
   title="NaËÌtaù z predch·dzaj˙ce ˙ËtovnÈho obdobia" class="btn-down" style="display:none;">Predch·dz. obdobie</a> <!-- dopyt, doprava na liötu spraviù tlaËidlo "naËÌtaù" -->


  <a href='vykazy_cis.php?drupoh=<?php echo $drupoh; ?>&copern=155&page=1'
   title="NaËÌtaù ötandartn˝ ËÌselnÌk" class="btn-down" style="display:none;">ätandardn˝ ËÌselnÌk</a>
 </th>
</tr>
</thead>
<?php
...
<tr>
 ...
 <th style="width:35%;">»Ìslo riadku</th>
</tr>
<tr>
 <th>
...
{
?>
 <th>S˙vaha <img src='../obr/info.png' width=12 height=12 border=0 title="»Ìslo riadku aktÌv v S˙vahe kam m· program z˙Ëtovaù rozdiel HV po zaokr˙hlenÌ S˙vahy, napr. Ë. 15">
<?php
}
?>
<?php
...
{
?>
 <th>S˙vaha <img src='../obr/info.png' width=12 height=12 border=0 title="»Ìslo riadku aktÌv v S˙vahe kam m· program z˙Ëtovaù rozdiel HV po zaokr˙hlenÌ S˙vahy, napr. Ë. 35">
<?php
}
?>
 </th>
...
?>
 <th>V˝kaz ziskov a str·t
<img src='../obr/info.png' width=12 height=12 border=0 title="»Ìslo n·kladovÈho riadku vo V˝kaze ziskov kam m· program z˙Ëtovaù rozdiel HV po zaokr˙hlenÌ S˙vahy a VZaS, napr. Ë. 26">
<?php
}
?>
</th>
