...
?>
  ...
  <td>
   ...
   <ul class="toleft legend-vykazy">
    ...
    <img src="../obr/ikony/trash_blue_icon.png" onclick=";" title="Vymazaù vöetky poloûky"
     class="btn-form-tool"> <!-- dopyt, nie je funkËnÈ + daù alert pre vymazanÌm -->
   </div>
  </td>
 </tr>
 </table>
...
?>
   <img src='../obr/info.png' title="EnterNext = kl·vesou ENTER prejdete na Ôalöiu poloûku"> <!-- dopyt, pri zaokr˙hlenÌ asi nem· v˝znam? -->
  </h2>
 </div>
<?php
//uprava vykazu
...
<?php                      } ?>
 ...
 <tr>
  <td colspan="3" style="">
   <div id="Cele" class="alert-error" style="display:none; ">Hodnota musÌ byù celÈ ËÌslo</div>
   <div id="Fx" class="alert-error" style="display:none; ">VyplÚte vöetky poloûky</div>
  </td>
...
<FORM name="formv1" method="post" action="vykazy_cis.php?copern=315&uprav=0&drupoh=<?php echo $drupoh;?>">
 ...
 <tr>
  ...
  <th style="width:25%;">»Ìslo riadku</th>
...
<tr>
 ...
 <td style="height:12px; padding:4px 0;" onmouseover="return Povol_uloz();" >
  <input type="submit" id="uloz" name="uloz" value="Uloûiù" > <!-- dopyt, tu nem· zmysel blokovaù enter -->
 </td>
 </tr>
 </tfoot>
 </table>
...
<?php                                                                              } ?>
 <a href='vykazy_cis.php?drupoh=<?php echo $drupoh; ?>&copern=4055&page=1'
  ...
  class="btn-down-x26 toright">Predch. obdobie</a> <!-- dopyt, maj˙ zmysel pri zaokr˙hlenÌ?  -->
