...
if ( $drupoh == 92 ) { echo "Vıkaz ziskov a strát - Generovanie"; }
if ( $drupoh == 94 ) { echo "Vıkaz ziskov a strát - Predchádzajúce úètovné obdobie"; }
if ( $drupoh == 95 ) { echo "Súvaha - Generovanie vıkazu Aktíva / Pasíva"; }
if ( $drupoh == 96 ) { echo "Súvaha a Vıkaz ziskov a strát - Nastavenie zaokrúhlenia"; }
?>
 </h2>
...
<tr>
 <td><?php echo $riadok->uce;?></td> <!-- dopyt, tu nebude vıpis, èi? -->
