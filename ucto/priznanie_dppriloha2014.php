...
//Z ciarky na bodku
  ...
  {
   window.open('../ucto/priznanie_dppriloha2014.php?copern=336&uprav=0&volapo=<?php echo $volapo; ?>', '_self')
  }
  function UpravPrmatel(p1cpl)
  {
   window.open('../ucto/priznanie_dppriloha2014.php?copern=203&uprav=0&cislo_p1cpl=' + p1cpl + '&tt=1&volapo=<?php echo $volapo; ?>', '_self')
  }
  function ZmazPrmatel(p1cpl)
  {
   window.open('../ucto/priznanie_dppriloha2014.php?copern=206&uprav=0&cislo_p1cpl=' + p1cpl + '&tt=1&volapo=<?php echo $volapo; ?>', '_self')
  }
</script>
</HEAD>
<BODY onload="ObnovUI();">
...
<div class="navbar">
 ...
 <a href="#" onclick="window.open('priznanie_dppriloha2014.php?copern=101&drupoh=1&page=1&volapo=<?php echo $volapo; ?>', '_self')" class="<?php echo $clas99; ?> toleft">prÌloha</a>
 <a href="#" onclick="window.open('priznanie_dppriloha2014.php?copern=11&drupoh=1&page=1&volapo=<?php echo $volapo; ?>', '_blank')" class="<?php echo $clas99; ?> toright">prÌloha</a>
...
<div class="navbar">
 ...
 <a href="#" onclick="window.open('<?php echo $source; ?>&copern=102&strana=9', '_self');" class="<?php echo $clas9; ?> toleft">9</a>
 <a href="#" onclick="window.open('<?php echo $source; ?>&copern=102&strana=10', '_self');" class="<?php echo $clas10; ?> toleft">10</a>
 <a href="#" onclick="window.open('priznanie_dppriloha2014.php?copern=101&drupoh=1&page=1&volapo=<?php echo $volapo; ?>', '_self')" class="<?php echo $clas11; ?> toleft">prÌloha</a>
