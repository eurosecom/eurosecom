...
<div class="navbar">
 ...
 <a href="#" onclick="window.open('priznanie_dppriloha2014.php?copern=11&drupoh=1&page=1&volapo=<?php echo $volapo; ?>', '_blank')" class="<?php echo $clas11; ?> toright">prÌloha</a>
...
<div class="wrap-prijimatelia">
 ...
 <caption>PrÌloha k IV. Ëasti - œalöÌ prijÌmatelia
  <img src="../obr/ikony/plus_lgreen_icon.png" onclick="NovyPrmatel();" title="Pridaù prijÌmateæa">
 </caption>
 <thead>
  <tr>
