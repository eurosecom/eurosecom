...
$jpg_popis="formulár Všeobecné podanie k ÚZ - Podnikate¾ské subjekty v sústave pú pre rok ".$kli_vrok;
...
<select name="duozn" id="duozn" size="1" style="width:274px; top:205px; left:248px;"> <!-- dopyt, predpåòa z ufir -->
 ...
 <option value="5">Prešov</option>
 <option value="6">Trenèín</option>
 <option value="7">Trnava</option>
 <option value="8">ilina</option>
 <option value="9">pre vybrané daòové subjekty</option>
</select>
<div class="input-echo" style="top:249px; left:248px;">Úètovné dokumenty</div>
<div class="input-echo" style="top:279px; left:248px;">
<?php
if ( $kli_vduj == 0 ) { echo "Úètovné vıkazy pre podnikate¾ské subjekty úètujúce v sústave podvojného úètovníctva"; }
if ( $kli_vduj == 1 ) { echo "Úètovné vıkazy pre neziskové organizácie úètujúce v sústave podvojného úètovníctva"; }
?>
</div>
...
if ( $hlavicka->duozn == 5 ) { $duozn="Prešov"; }
if ( $hlavicka->duozn == 6 ) { $duozn="Trenèín"; }
if ( $hlavicka->duozn == 7 ) { $duozn="Trnava"; }
if ( $hlavicka->duozn == 8 ) { $duozn="ilina"; }
if ( $hlavicka->duozn == 9 ) { $duozn="pre vybrané daòové subjekty"; }
$pdf->Cell(45,5," ","$rmc1",0,"L");$pdf->Cell(60,5,"$duozn","$rmc",1,"L");
$pdf->Cell(190,5," ","$rmc1",1,"L");
$oblast="Úètovné dokumenty";
$pdf->Cell(45,5," ","$rmc1",0,"L");$pdf->Cell(60,5,"$oblast","$rmc",1,"L");
$pdf->SetFont('arial','',9);
$pdf->Cell(190,2," ","$rmc1",1,"L");
if ( $kli_vduj == 0 ) { $agenda="Úètovné vıkazy pre podnikate¾ské subjekty úètujúce v sústave podvojného úètovníctva"; }
if ( $kli_vduj == 1 ) { $agenda="Úètovné vıkazy pre neziskové organizácie úètujúce v sústave podvojného úètovníctva"; }
...
if ( $hlavicka->typpod == 2 ) { $typpod="Mikro úètovná jednotka"; }
...
$pdf->Cell(190,1," ","$rmc1",1,"L");
$spopod="Elektronicky - súèas podania";
