...
if ( !confirm ("Chcete naËÌtaù ˙daje do FOB z firmy minulÈho roka ?") )
         ...
         { location.href='priznanie_fob2018.php?copern=3156&drupoh=1&cislo_oc=<?php echo $cislo_oc; ?>' }
</script>
<?php                  }
...
" det4='$det4', nzdm='$nzdm', kupm='$kupm', kupme='$kupme', kupd1='$kupd1', kupd2='$kupd2', kupd3='$kupd3', kupd4='$kupd4', kupde='$kupde',  ".
...
$uprtxt = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET ".
" r38='$r38',  r38a='$r38a',  r39='$r39',  r40='$r40', ".
...
" t1az3='$t1az3', t1az4='$t1az4', t1az5='$t1az5', t1ak3='$t1ak3', t1ak4='$t1ak4', t1ak5='$t1ak5', ".
...
$r43 = 1*$_REQUEST['r43'];
$r44 = 1*$_REQUEST['r44'];
$r43pu = 1*$_REQUEST['r43pu'];
$r44pu = 1*$_REQUEST['r44pu'];
$r45 = 1*$_REQUEST['r45'];
$r46 = 1*$_REQUEST['r46'];
$r47 = 1*$_REQUEST['r47'];
$r48 = 1*$_REQUEST['r48'];
...
$uprtxt = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET ".
" r43pu='$r43pu', r44pu='$r44pu', r43='$r43', r44='$r44', r45='$r45', r46='$r46', r47='$r47', r48='$r48', ".
...
$t3v16 = 1*$_REQUEST['t3v16'];

$t3p17 = 1*$_REQUEST['t3p17'];
$t3v17 = 1*$_REQUEST['t3v17'];
$t3p18 = 1*$_REQUEST['t3p18'];
$t3v18 = 1*$_REQUEST['t3v18'];
$t3p19 = 1*$_REQUEST['t3p19'];
$t3v19 = 1*$_REQUEST['t3v19'];

$uprtxt = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET ".
" t3p17='$t3p17', t3v17='$t3v17', t3p18='$t3p18', t3v18='$t3v18', t3p19='$t3p19', t3v19='$t3v19', ".
" t3p1='$t3p1', t3p2='$t3p2', t3p3='$t3p3', ".
" t3v1='$t3v1', t3v2='$t3v2', t3v3='$t3v3', ".
" t3p4='$t3p4', t3p5='$t3p5', t3p6='$t3p6', t3p7='$t3p7', t3p8='$t3p8', t3p9='$t3p9', ".
" t3p10='$t3p10', t3p11='$t3p11', t3p12='$t3p12', t3p13='$t3p13', t3p14='$t3p14', t3p15='$t3p15', t3p16='$t3p16', t3v16='$t3v16', ".
...
$r75 = 1*$_REQUEST['r75'];
$r76 = 1*$_REQUEST['r76'];
$r76a = 1*$_REQUEST['r76a'];
$r76b = 1*$_REQUEST['r76b'];
$r77 = 1*$_REQUEST['r77'];
$r78 = 1*$_REQUEST['r78'];
$r79 = 1*$_REQUEST['r79'];
$r80 = 1*$_REQUEST['r80'];
...
$uprtxt = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET ".
" r69='$r69', r70='$r70', r71='$r71', r76a='$r76a', r76b='$r76b', ".
...
$uprtxt = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET ".
" r85='$r85', r86='$r86', r87='$r87', r88='$r88', r89='$r89', r90='$r90', r91='$r91', r92='$r92', r93='$r93', r94='$r94', ".
...
$uprtxt = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET ".
" r108='$r108', r109='$r109', r110='$r110', r111='$r111', r112='$r112', ".
...
$r128 = 1*$_REQUEST['r128'];
$r129 = 1*$_REQUEST['r129'];
$r130 = 1*$_REQUEST['r130'];
$r131 = 1*$_REQUEST['r131'];
$r132 = 1*$_REQUEST['r132'];
$r133 = 1*$_REQUEST['r133'];
$r134 = 1*$_REQUEST['r134'];
$r135 = 1*$_REQUEST['r135'];
$r136 = 1*$_REQUEST['r136'];
$r137 = 1*$_REQUEST['r137'];
$r138 = 1*$_REQUEST['r138'];
$udnr = $_REQUEST['udnr'];
$ldnr = 1*$_REQUEST['ldnr'];
$nrzsprev = 1*$_REQUEST['nrzsprev'];

$uprtxt = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET ".
" r127='$r127', r128='$r128', r129='$r129', r130='$r130', r131='$r131', r132='$r132', r133='$r133', r134='$r134', ".
" r135='$r135', r136='$r136', r137='$r137', r138='$r138', ".
" sdnr='$sdnr',  nrzsprev='$nrzsprev', ldnr='$ldnr'  ".
" WHERE oc = $cislo_oc";
                     }
...
if ( !$vysledok )
{
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD new2018 DECIMAL(2,0) DEFAULT 0 AFTER t1p13";
$vysledek = mysql_query("$sql");

$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD nzdm DECIMAL(2,0) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD kupm DECIMAL(2,0) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD kupme DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");

$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD kupd1 DECIMAL(2,0) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD kupd2 DECIMAL(2,0) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD kupd3 DECIMAL(2,0) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD kupd4 DECIMAL(2,0) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD kupde DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");

$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD dbur DECIMAL(2,0) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD dbure DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD dburm DECIMAL(2,0) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");

$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD det4 DECIMAL(2,0) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD r38a DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");

$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob MODIFY r52 DECIMAL(10,2) DEFAULT 0";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD r43pu DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD r44pu DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");

$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD t3v16 DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD t3p18 DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD t3v18 DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD t3p19 DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD t3v19 DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");

$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD r76a DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD r76b DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");

$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD r132 DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD r133 DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD r135 DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD r136 DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_mzdpriznanie_fob ADD r137 DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
...
$t3v16 = $fir_riadok->t3v16;
$t3v17 = $fir_riadok->t3v17;

$t3p18 = $fir_riadok->t3p18;
$t3v18 = $fir_riadok->t3v18;
$t3p19 = $fir_riadok->t3p19;
$t3v19 = $fir_riadok->t3v19;
...
$r75 = $fir_riadok->r75;
$r76 = $fir_riadok->r76;
$r76a = $fir_riadok->r76a;
$r76b = $fir_riadok->r76b;
$r77 = $fir_riadok->r77;
$r78 = $fir_riadok->r78;
$r79 = $fir_riadok->r79;
$r80 = $fir_riadok->r80;
...
$r132 = $fir_riadok->r132;
$r133 = $fir_riadok->r133;
$r134 = $fir_riadok->r134;
$r135 = $fir_riadok->r135;
$r136 = $fir_riadok->r136;
$r137 = $fir_riadok->r137;
$r138 = $fir_riadok->r138;
...
if ( $copern == 20 )
    {
?>
<form name="formv1" method="post" action="priznanie_fob2018.php?copern=23&cislo_oc=<?php echo $cislo_oc; ?>&strana=<?php echo $strana; ?>">
<?php
...
$clas15="noactive"; $clas16="noactive"; $clas17="noactive";
...
if ( $strana == 17 ) $clas17="active";
//$source="../ucto/priznanie_fob2018.php?cislo_oc=".$cislo_oc."&drupoh=1&page=1&subor=0";
?>
<div class="navbar">
...
<!-- III.ODDIEL -->
<input type="checkbox" name="r29" value="1" style="top:305px; left:746px;"/>
<input type="text" name="r30" id="r30" onkeyup="CiarkaNaBodku(this);" style="width:175px; top:355px; left:702px;"/>

<input type="text" name="mprie" id="mprie" style="width:571px; top:435px; left:51px;"/>
<input type="text" name="mrod" id="mrod" maxlength="10" style="width:240px; top:435px; left:646px;"/>
<input type="text" name="mpri" id="mpri" onkeyup="CiarkaNaBodku(this);" style="width:153px; top:473px; left:601px;"/>
<input type="text" name="mpom" id="mpom" style="width:38px; top:473px; left:850px;"/>

<input type="checkbox" name="nzdm" value="1" style="top:475px; left:85px;"/>
<input type="checkbox" name="kupm" value="1" style="top:516px; left:85px;"/>
<input type="text" name="kupme" id="kupme" onkeyup="CiarkaNaBodku(this);" style="width:150px; top:513px; left:740px;"/>

<!-- DETI -->
<!-- 1.riadok -->
<input type="text" name="d1prie" id="d1prie" style="width:202px; top:635px; left:47px;"/>
<input type="text" name="d1rod" id="d1rod" maxlength="10" style="width:244px; top:635px; left:260px;"/>
<input type="checkbox" name="kupd1" value="1" style="top:646px; left:528px;"/>
<input type="checkbox" name="d1pomc" value="1" style="top:646px; left:562px;"/>
<input type="checkbox" name="d1pom1" value="1" style="top:646px; left:598px;"/>
<input type="checkbox" name="d1pom2" value="1" style="top:646px; left:623px;"/>
<input type="checkbox" name="d1pom3" value="1" style="top:646px; left:649px;"/>
<input type="checkbox" name="d1pom4" value="1" style="top:646px; left:674px;"/>
<input type="checkbox" name="d1pom5" value="1" style="top:646px; left:699px;"/>
<input type="checkbox" name="d1pom6" value="1" style="top:646px; left:724px;"/>
<input type="checkbox" name="d1pom7" value="1" style="top:646px; left:750px;"/>
<input type="checkbox" name="d1pom8" value="1" style="top:646px; left:775px;"/>
<input type="checkbox" name="d1pom9" value="1" style="top:646px; left:800px;"/>
<input type="checkbox" name="d1pom10" value="1" style="top:646px; left:826px;"/>
<input type="checkbox" name="d1pom11" value="1" style="top:646px; left:851px;"/>
<input type="checkbox" name="d1pom12" value="1" style="top:646px; left:877px;"/>
<!-- 2.riadok -->
<input type="text" name="d2prie" id="d2prie" style="width:202px; top:679px; left:47px;"/>
<input type="text" name="d2rod" id="d2rod" maxlength="10" style="width:244px; top:679px; left:260px;"/>
<input type="checkbox" name="kupd2" value="1" style="top:691px; left:528px;"/>
<input type="checkbox" name="d2pomc" value="1" style="top:691px; left:562px;"/>
<input type="checkbox" name="d2pom1" value="1" style="top:691px; left:598px;"/>
<input type="checkbox" name="d2pom2" value="1" style="top:691px; left:623px;"/>
<input type="checkbox" name="d2pom3" value="1" style="top:691px; left:649px;"/>
<input type="checkbox" name="d2pom4" value="1" style="top:691px; left:674px;"/>
<input type="checkbox" name="d2pom5" value="1" style="top:691px; left:699px;"/>
<input type="checkbox" name="d2pom6" value="1" style="top:691px; left:724px;"/>
<input type="checkbox" name="d2pom7" value="1" style="top:691px; left:750px;"/>
<input type="checkbox" name="d2pom8" value="1" style="top:691px; left:775px;"/>
<input type="checkbox" name="d2pom9" value="1" style="top:691px; left:800px;"/>
<input type="checkbox" name="d2pom10" value="1" style="top:691px; left:826px;"/>
<input type="checkbox" name="d2pom11" value="1" style="top:691px; left:851px;"/>
<input type="checkbox" name="d2pom12" value="1" style="top:691px; left:877px;"/>
<!-- 3.riadok -->
<input type="text" name="d3prie" id="d3prie" style="width:202px; top:724px; left:47px;"/>
<input type="text" name="d3rod" id="d3rod" maxlength="10" style="width:244px; top:724px; left:260px;"/>
<input type="checkbox" name="kupd3" value="1" style="top:735px; left:528px;"/>
<input type="checkbox" name="d3pomc" value="1" style="top:735px; left:562px;"/>
<input type="checkbox" name="d3pom1" value="1" style="top:735px; left:598px;"/>
<input type="checkbox" name="d3pom2" value="1" style="top:735px; left:623px;"/>
<input type="checkbox" name="d3pom3" value="1" style="top:735px; left:649px;"/>
<input type="checkbox" name="d3pom4" value="1" style="top:735px; left:674px;"/>
<input type="checkbox" name="d3pom5" value="1" style="top:735px; left:699px;"/>
<input type="checkbox" name="d3pom6" value="1" style="top:735px; left:724px;"/>
<input type="checkbox" name="d3pom7" value="1" style="top:735px; left:750px;"/>
<input type="checkbox" name="d3pom8" value="1" style="top:735px; left:775px;"/>
<input type="checkbox" name="d3pom9" value="1" style="top:735px; left:800px;"/>
<input type="checkbox" name="d3pom10" value="1" style="top:735px; left:826px;"/>
<input type="checkbox" name="d3pom11" value="1" style="top:735px; left:851px;"/>
<input type="checkbox" name="d3pom12" value="1" style="top:735px; left:877px;"/>
<!-- 4.riadok -->
<input type="text" name="d4prie" id="d4prie" style="width:202px; top:768px; left:47px;"/>
<input type="text" name="d4rod" id="d4rod" maxlength="10" style="width:244px; top:768px; left:260px;"/>
<input type="checkbox" name="kupd4" value="1" style="top:780px; left:528px;"/>
<input type="checkbox" name="d4pomc" value="1" style="top:780px; left:562px;"/>
<input type="checkbox" name="d4pom1" value="1" style="top:780px; left:598px;"/>
<input type="checkbox" name="d4pom2" value="1" style="top:780px; left:623px;"/>
<input type="checkbox" name="d4pom3" value="1" style="top:780px; left:649px;"/>
<input type="checkbox" name="d4pom4" value="1" style="top:780px; left:674px;"/>
<input type="checkbox" name="d4pom5" value="1" style="top:780px; left:699px;"/>
<input type="checkbox" name="d4pom6" value="1" style="top:780px; left:724px;"/>
<input type="checkbox" name="d4pom7" value="1" style="top:780px; left:750px;"/>
<input type="checkbox" name="d4pom8" value="1" style="top:780px; left:775px;"/>
<input type="checkbox" name="d4pom9" value="1" style="top:780px; left:800px;"/>
<input type="checkbox" name="d4pom10" value="1" style="top:780px; left:826px;"/>
<input type="checkbox" name="d4pom11" value="1" style="top:780px; left:851px;"/>
<input type="checkbox" name="d4pom12" value="1" style="top:780px; left:877px;"/>

<input type="checkbox" name="det4" value="1" style="top:805px; left:85px;"/>
<input type="text" name="kupde" id="kupde" onkeyup="CiarkaNaBodku(this);" style="width:150px; top:838px; left:592px;"/>

<!-- IV.ODDIEL DB NA UROKY-->
<input type="checkbox" name="dbur" value="1" style="top:1128px; left:80px;"/>
<input type="text" name="dbure" id="dbure" onkeyup="CiarkaNaBodku(this);" style="width:150px; top:1125px; left:610px;"/>
<input type="text" name="dburm" id="dburm" onkeyup="CiarkaNaBodku(this);" style="width:50px; top:1125px; left:847px;"/>
...
<!-- VI.ODDIEL -->
<!-- Tabulka1 -->
<input type="text" name="t1p1" id="t1p1" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:517px; left:410px;"/>
...
<input type="text" name="t1v3" id="t1v3" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:597px; left:661px;"/>
<input type="text" name="t1p4" id="t1p4" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:637px; left:410px;"/>
<input type="text" name="t1v4" id="t1v4" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:637px; left:661px;"/>
<input type="text" name="t1p5" id="t1p5" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:706px; left:410px;"/>
<input type="text" name="t1v5" id="t1v5" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:706px; left:661px;"/>
<input type="text" name="t1p6" id="t1p6" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:784px; left:410px;"/>
<input type="text" name="t1v6" id="t1v6" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:784px; left:661px;"/>
<input type="text" name="t1p7" id="t1p7" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:824px; left:410px;"/>
<input type="text" name="t1v7" id="t1v7" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:824px; left:661px;"/>
<input type="text" name="t1p8" id="t1p8" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:864px; left:410px;"/>
<input type="text" name="t1v8" id="t1v8" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:864px; left:661px;"/>
<input type="text" name="t1p9" id="t1p9" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:907px; left:410px;"/>
<input type="text" name="t1v9" id="t1v9" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:907px; left:661px;"/>
<div class="input-echo right" style="width:230px; top:950px; left:413px;"><?php echo $t1p10; ?>&nbsp;</div>
<div class="input-echo right" style="width:230px; top:950px; left:662px;"><?php echo $t1v10; ?>&nbsp;</div>
<input type="text" name="t1p11" id="t1p11" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:990px; left:410px;"/>
<input type="text" name="t1v11" id="t1v11" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:990px; left:661px;"/>
<input type="text" name="t1p12" id="t1p12" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:1031px; left:410px;"/>
<input type="text" name="t1v12" id="t1v12" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:1031px; left:661px;"/>
<div class="input-echo right" style="width:230px; top:1072px; left:413px;"><?php echo $t1p13; ?>&nbsp;</div>
<div class="input-echo right" style="width:230px; top:1072px; left:662px;"><?php echo $t1v13; ?>&nbsp;</div>
...
<!-- uplatnujem -->
<input type="checkbox" name="uppr1" value="1" style="top:130px; left:65px;"/>
<input type="checkbox" name="uppr3" value="1" style="top:130px; left:360px;"/>
<input type="checkbox" name="uppr4" value="1" style="top:130px; left:633px;"/>

<input type="checkbox" name="uvp61" value="1" style="top:177px; left:64px;"/>
<input type="checkbox" name="uvp64" value="1" style="top:177px; left:440px;"/>

<input type="text" name="psp6" id="psp6" onkeyup="CiarkaNaBodku(this);" style="width:242px; top:211px; left:499px;"/>

<input type="checkbox" name="uos61" value="1" style="top:264px; left:65px;"/>
<input type="checkbox" name="uos64" value="1" style="top:264px; left:441px;"/>

<input type="checkbox" name="kos61" value="1" style="top:311px; left:65px;"/>
<input type="checkbox" name="kos64" value="1" style="top:311px; left:441px;"/>

<!-- Tabulka1a -->
<input type="text" name="t1az1" id="t1az1" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:433px; left:410px;"/>
<input type="text" name="t1ak1" id="t1ak1" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:433px; left:660px;"/>
<input type="text" name="t1az2" id="t1az2" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:473px; left:410px;"/>
<input type="text" name="t1ak2" id="t1ak2" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:473px; left:660px;"/>
<input type="text" name="t1az3" id="t1az3" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:510px; left:410px;"/>
<input type="text" name="t1ak3" id="t1ak3" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:510px; left:660px;"/>
<input type="text" name="t1az4" id="t1az4" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:550px; left:410px;"/>
<input type="text" name="t1ak4" id="t1ak4" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:550px; left:660px;"/>
<input type="text" name="t1az5" id="t1az5" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:590px; left:410px;"/>
<input type="text" name="t1ak5" id="t1ak5" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:590px; left:660px;"/>
<!-- Tabulka1b -->
<input type="text" name="t1bz1" id="t1bz1" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:694px; left:410px;"/>
<input type="text" name="t1bk1" id="t1bk1" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:694px; left:660px;"/>
<input type="text" name="t1bz2" id="t1bz2" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:734px; left:410px;"/>
<input type="text" name="t1bk2" id="t1bk2" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:734px; left:660px;"/>

<div class="input-echo right" style="width:242px; top:1133px; left:501px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r41; ?>&nbsp;</div>
<div class="input-echo right" style="width:242px; top:1173px; left:501px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r42; ?>&nbsp;</div>
...
<input type="text" name="r43" id="r43" onkeyup="CiarkaNaBodku(this);" style="width:243px; top:112px; left:504px;"/>
 <input type="text" name="r43pu" id="r43pu" onkeyup="CiarkaNaBodku(this);" style="width:130px; top:112px; left:766px;"/>
 <img src="../obr/ikony/info_blue_icon.png" class="btn-row-tool" style="top:112px; left:917px;"
...
<input type="text" name="r44" id="r44" onkeyup="CiarkaNaBodku(this);" style="width:243px; top:152px; left:504px;"/>
<input type="text" name="r44pu" id="r44pu" onkeyup="CiarkaNaBodku(this);" style="width:130px; top:152px; left:766px;"/>
 <img src="../obr/ikony/info_blue_icon.png" class="btn-row-tool" style="top:152px; left:917px;"
...
<input type="text" name="r45" id="r45" onkeyup="CiarkaNaBodku(this);" style="width:241px; top:200px; left:504px;"/>
<input type="text" name="r46" id="r46" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:243px; left:504px;"/>
<div class="input-echo right" style="width:242px; top:290px; left:504px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r47; ?>&nbsp;</div>
<div class="input-echo right" style="width:242px; top:335px; left:504px; title="Hodnota sa prepoËÌta po uloûenÌ zmien""><?php echo $r48; ?>&nbsp;</div>


<!-- prehlad straty -->
<input type="text" name="r49" id="r49" onkeyup="CiarkaNaBodku(this);" style="width:243px; top:400px; left:507px;"/>
<input type="text" name="r50" id="r50" onkeyup="CiarkaNaBodku(this);" style="width:243px; top:440px; left:507px;"/>
<input type="text" name="r51" id="r51" onkeyup="CiarkaNaBodku(this);" style="width:243px; top:480px; left:507px;"/>
<input type="text" name="r52" id="r52" onkeyup="CiarkaNaBodku(this);" style="width:243px; top:520px; left:507px;"/>
<input type="text" name="r53" id="r53" onkeyup="CiarkaNaBodku(this);" style="width:243px; top:567px; left:507px;"/>
...
<div class="input-echo right" style="width:242px; top:900px; left:510px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r59; ?>&nbsp;</div>
<div class="input-echo right" style="width:242px; top:939px; left:510px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r60; ?>&nbsp;</div>
<input type="text" name="r61" id="r61" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:977px; left:506px;"/>
<input type="text" name="r62" id="r62" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:1017px; left:506px;"/>
<input type="text" name="r63" id="r63" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:1065px; left:506px;"/>
<input type="text" name="r64" id="r64" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:1108px; left:506px;"/>
<div class="input-echo right" style="width:242px; top:1172px; left:510px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r65; ?>&nbsp;</div>
...
<!-- VII.ODDIEL -->
<!-- Tabulka2 -->
<input type="text" name="t2p1" id="t2p1" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:388px; left:410px;"/>
<input type="text" name="t2v1" id="t2v1" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:388px; left:660px;"/>
<input type="text" name="t2p2" id="t2p2" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:446px; left:410px;"/>
<input type="text" name="t2v2" id="t2v2" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:446px; left:660px;"/>

<input type="text" name="t2p3" id="t2p3" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:514px; left:410px;"/>
<input type="text" name="t2v3" id="t2v3" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:514px; left:660px;"/>
<input type="text" name="t2p4" id="t2p4" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:564px; left:410px;"/>
<input type="text" name="t2v4" id="t2v4" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:564px; left:660px;"/>

<input type="text" name="t2p5" id="t2p5" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:616px; left:410px;"/>
<input type="text" name="t2v5" id="t2v5" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:616px; left:660px;"/>
<input type="text" name="t2p6" id="t2p6" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:666px; left:410px;"/>
<input type="text" name="t2v6" id="t2v6" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:666px; left:660px;"/>
<input type="text" name="t2p7" id="t2p7" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:706px; left:410px;"/>
<input type="text" name="t2v7" id="t2v7" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:706px; left:660px;"/>
<input type="text" name="t2p8" id="t2p8" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:746px; left:410px;"/>
<input type="text" name="t2v8" id="t2v8" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:746px; left:660px;"/>
<input type="text" name="t2p9" id="t2p9" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:796px; left:410px;"/>
<input type="text" name="t2v9" id="t2v9" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:796px; left:660px;"/>
<input type="text" name="t2p10" id="t2p10" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:846px; left:410px;"/>
<input type="text" name="t2v10" id="t2v10" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:846px; left:660px;"/>
<div class="input-echo right" style="width:230px; top:889px; left:410px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $t2p11; ?>&nbsp;</div>
<div class="input-echo right" style="width:230px; top:889px; left:660px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $t2v11; ?>&nbsp;</div>

<input type="text" name="t2p12" id="t2p12" onkeyup="CiarkaNaBodku(this);" style="width:233px; top:939px; left:410px;"/>
...
<div class="input-echo right" style="width:242px; top:113px; left:484px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r66; ?>&nbsp;</div>
<div class="input-echo right" style="width:242px; top:153px; left:484px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r67; ?>&nbsp;</div>
<div class="input-echo right" style="width:242px; top:192px; left:484px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r68; ?>&nbsp;</div>

<!-- VIII.ODDIEL -->
<!-- Tabulka3 -->
<input type="text" name="t3p1" id="t3p1" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:348px; left:411px;"/>
<input type="text" name="t3v1" id="t3v1" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:348px; left:661px;"/>
<input type="text" name="t3p2" id="t3p2" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:394px; left:411px;"/>
<input type="text" name="t3v2" id="t3v2" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:394px; left:661px;"/>
<input type="text" name="t3p3" id="t3p3" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:434px; left:411px;"/>
<input type="text" name="t3v3" id="t3v3" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:434px; left:661px;"/>
<input type="text" name="t3p4" id="t3p4" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:474px; left:411px;"/>
<input type="text" name="t3v4" id="t3v4" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:474px; left:661px;"/>

<input type="text" name="t3p5" id="t3p5" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:514px; left:411px;"/>
<input type="text" name="t3v5" id="t3v5" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:514px; left:661px;"/>
<input type="text" name="t3p6" id="t3p6" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:559px; left:411px;"/>
<input type="text" name="t3v6" id="t3v6" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:559px; left:661px;"/>
<input type="text" name="t3p7" id="t3p7" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:609px; left:411px;"/>
<input type="text" name="t3v7" id="t3v7" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:609px; left:661px;"/>


<input type="text" name="t3p8" id="t3p8" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:650px; left:411px;"/>
<input type="text" name="t3v8" id="t3v8" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:650px; left:661px;"/>
<input type="text" name="t3p9" id="t3p9" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:688px; left:411px;"/>
<input type="text" name="t3v9" id="t3v9" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:688px; left:661px;"/>
<input type="text" name="t3p10" id="t3p10" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:729px; left:411px;"/>
<input type="text" name="t3v10" id="t3v10" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:729px; left:661px;"/>


<input type="text" name="t3p11" id="t3p11" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:769px; left:411px;"/>
<input type="text" name="t3v11" id="t3v11" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:769px; left:661px;"/>
<input type="text" name="t3p12" id="t3p12" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:814px; left:411px;"/>
<input type="text" name="t3v12" id="t3v12" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:814px; left:661px;"/>
<input type="text" name="t3p13" id="t3p13" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:857px; left:411px;"/>
<input type="text" name="t3v13" id="t3v13" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:857px; left:661px;"/>

<input type="text" name="t3p14" id="t3p14" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:900px; left:411px;"/>
<input type="text" name="t3v14" id="t3v14" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:900px; left:661px;"/>
<input type="text" name="t3p15" id="t3p15" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:940px; left:411px;"/>
<input type="text" name="t3v15" id="t3v15" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:940px; left:661px;"/>

<input type="text" name="t3p16" id="t3p16" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:980px; left:411px;"/>
<input type="text" name="t3v16" id="t3v16" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:980px; left:661px;"/>
<input type="text" name="t3p17" id="t3p17" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:1020px; left:411px;"/>
<input type="text" name="t3v17" id="t3v17" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:1020px; left:661px;"/>
<input type="text" name="t3p18" id="t3p18" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:1063px; left:411px;"/>


<div class="input-echo right" style="width:230px; top:1110px; left:413px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $t3p19; ?>&nbsp;</div>
<div class="input-echo right" style="width:230px; top:1110px; left:662px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $t3v19; ?>&nbsp;</div>
...
<div class="input-echo right" style="width:244px; top:367px; left:488px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r69; ?>&nbsp;</div>
<div class="input-echo right" style="width:244px; top:407px; left:488px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r70; ?>&nbsp;</div>
<div class="input-echo right" style="width:244px; top:447px; left:488px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r71; ?>&nbsp;</div>
...
<input type="text" name="r76" id="r76" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:708px; left:488px;"/>
<input type="text" name="r76a" id="r76a" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:750px; left:488px;"/>
<input type="text" name="r76b" id="r76b" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:788px; left:488px;"/>
<div class="input-echo right" style="width:242px; top:829px; left:489px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r77; ?>&nbsp;</div>


<div class="input-echo right" style="width:242px; top:868px; left:489px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r78; ?>&nbsp;</div>
<input type="text" name="r79" id="r79" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:907px; left:488px;"/>
<div class="input-echo right" style="width:242px; top:947px; left:489px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r80; ?>&nbsp;</div>
...
<input type="text" name="r85" id="r85" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:119px; left:500px;"/>
<input type="text" name="r86" id="r86" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:169px; left:500px;"/>
<input type="text" name="r87" id="r87" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:220px; left:500px;"/>
<input type="text" name="r88" id="r88" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:269px; left:500px;"/>
<input type="text" name="r89" id="r89" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:310px; left:500px;"/>
<div class="input-echo right" style="width:242px; top:357px; left:500px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r90; ?>&nbsp;</div>
...
<input type="text" name="r97" id="r97" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:695px; left:500px;"/>
<input type="text" name="r98" id="r98" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:735px; left:500px;"/>
<input type="text" name="r99" id="r99" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:776px; left:500px;"/>
<div class="input-echo right" style="width:242px; top:825px; left:500px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r100; ?>&nbsp;</div>

<input type="text" name="r101" id="r101" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:874px; left:500px;"/>
<input type="text" name="r102" id="r102" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:927px; left:500px;"/>
<input type="text" name="r103" id="r103" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:987px; left:500px;"/>
<div class="input-echo right" style="width:242px; top:1047px; left:500px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r104; ?>&nbsp;</div>

<div class="input-echo right" style="width:242px; top:1107px; left:500px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r105; ?>&nbsp;</div>
<input type="text" name="r106" id="r106" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:1158px; left:500px;"/>
<div class="input-echo right" style="width:242px; top:1198px; left:500px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r107; ?>&nbsp;</div>
...
<input type="text" name="r108" id="r108" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:115px; left:500px;"/>
<div class="input-echo right" style="width:242px; top:155px; left:500px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r109; ?>&nbsp;</div>
<div class="input-echo right" style="width:242px; top:195px; left:500px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r110; ?>&nbsp;</div>
<div class="input-echo right" style="width:242px; top:235px; left:500px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r111; ?>&nbsp;</div>

<input type="text" name="r112" id="r112" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:275px; left:500px;"/>
<div class="input-echo right" style="width:242px; top:320px; left:500px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r113; ?>&nbsp;</div>

<input type="text" name="r114" id="r114" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:362px; left:500px;"/>
<div class="input-echo right" style="width:242px; top:402px; left:500px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r115; ?>&nbsp;</div>
<div class="input-echo right" style="width:242px; top:442px; left:500px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r116; ?>&nbsp;</div>

<input type="text" name="r117" id="r117" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:482px; left:500px;"/>
<input type="text" name="r118" id="r118" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:522px; left:500px;"/>
<input type="text" name="r119" id="r119" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:564px; left:500px;"/>
<input type="text" name="r120" id="r120" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:609px; left:500px;"/>

<input type="text" name="r121" id="r121" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:649px; left:500px;"/>
<input type="text" name="r122" id="r122" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:689px; left:500px;"/>
<input type="text" name="r123" id="r123" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:729px; left:500px;"/>
<div class="input-echo right" style="width:242px; top:771px; left:500px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r124; ?>&nbsp;</div>

<div class="input-echo right" style="width:262px; top:821px; left:480px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r125; ?>&nbsp;</div>
<div class="input-echo right" style="width:262px; top:887px; left:480px;" title="Hodnota sa prepoËÌta po uloûenÌ zmien"><?php echo $r126; ?>&nbsp;</div>
...
<!-- X.ODDIEL -->
<input type="text" name="r127" id="r127" onkeyup="CiarkaNaBodku(this);" style="width:264px; top:374px; left:625px;"/>
<input type="text" name="r128" id="r128" onkeyup="CiarkaNaBodku(this);" style="width:264px; top:416px; left:625px;"/>
<input type="text" name="r129" id="r129" onkeyup="CiarkaNaBodku(this);" style="width:264px; top:458px; left:625px;"/>
<input type="text" name="r130" id="r130" onkeyup="CiarkaNaBodku(this);" style="width:264px; top:513px; left:625px;"/>

<input type="text" name="r131" id="r131" onkeyup="CiarkaNaBodku(this);" style="width:264px; top:570px; left:625px;"/>
<input type="text" name="r132" id="r132" onkeyup="CiarkaNaBodku(this);" style="width:264px; top:615px; left:625px;"/>
<input type="text" name="r133" id="r133" onkeyup="CiarkaNaBodku(this);" style="width:264px; top:667px; left:625px;"/>
<input type="text" name="r134" id="r134" onkeyup="CiarkaNaBodku(this);" style="width:264px; top:720px; left:625px;"/>

<!-- XI.ODDIEL -->
<input type="text" name="sdnr" id="sdnr" style="width:842px; top:846px; left:51px;"/>
<input type="text" name="r136" id="r136" onkeyup="CiarkaNaBodku(this);" style="width:245px; top:886px; left:648px;"/>
<input type="text" name="r137" id="r137" onkeyup="CiarkaNaBodku(this);" style="width:245px; top:926px; left:648px;"/>
<input type="text" name="r138" id="r138" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:965px; left:648px;"/>
<input type="checkbox" name="ldnr" value="1" style="top:1005px; left:413px;"/>
<input type="text" name="nrzsprev" id="nrzsprev" maxlength="2" style="width:37px; top:1005px; left:855px;"/>
...
<img src="../obr/ikony/info_blue_icon.png" title="ätatistick˝ ËÌselnÌk krajÌn" onclick="CisKrajin();" class="btn-row-tool" style="top:780px; left:7px;">
...
<input type="text" name="pril" id="pril" maxlength="2" style="width:37px; top:815px; left:184px;" title="Minim·lny poËet prÌloh je 2, vr·tane PrÌlohy Ë.1 V˝zkum a v˝voj a PrÌlohy Ë.2 ⁄daje SP a ZP"/>
...
<?php if ( $strana == 17 ) { ?>
<img src="<?php echo $jpg_source; ?>_str17.jpg" alt="<?php echo $jpg_title; ?>" class="form-background">
<span class="text-echo" style="top:74px; left:401px;"><?php echo $fir_fdic; ?></span>
<!-- PRILOHA 3 -->
...
?>
<script type="text/javascript">
alert ("Export do XML DaÚovÈho priznania FOB 2018 bude pripraven˝ hneÔ po zverejnenÌ novÈho formul·ra na port·le DRSR. Aktu·lne info n·jdete na vstupnej str·nke v bode Novinky, tipy, triky.");
window.close();
</script>
<?php
exit;
...
$riadok=$hlavicka->r38a;
if ( $riadok == 0 ) $riadok="";
  $text = "  <r38a><![CDATA[".$riadok."]]></r38a>"."\r\n"; fwrite($soubor, $text);
...
if ( $riadok == 0 ) $riadok="";
  ...
  $text = "   <t3r18>"."\r\n"; fwrite($soubor, $text);
$riadok=$hlavicka->t3p18;
if ( $riadok == 0 ) $riadok="";
  $text = "    <s1><![CDATA[".$riadok."]]></s1>"."\r\n"; fwrite($soubor, $text);
  $text = "   </t3r18>"."\r\n"; fwrite($soubor, $text);

  $text = "   <t3r19>"."\r\n"; fwrite($soubor, $text);
$riadok=$hlavicka->t3p19;
if ( $riadok == 0 ) $riadok="";
  $text = "    <s1><![CDATA[".$riadok."]]></s1>"."\r\n"; fwrite($soubor, $text);
$riadok=$hlavicka->t3v19;
if ( $riadok == 0 ) $riadok="";
  $text = "    <s2><![CDATA[".$riadok."]]></s2>"."\r\n"; fwrite($soubor, $text);
  $text = "   </t3r19>"."\r\n"; fwrite($soubor, $text);
...
$riadok=$hlavicka->r76a;
if ( $riadok == 0 ) $riadok="";
  $text = "  <r76a><![CDATA[".$riadok."]]></r76a>"."\r\n"; fwrite($soubor, $text);
$riadok=$hlavicka->r76b;
if ( $riadok == 0 ) $riadok="";
  $text = "  <r76b><![CDATA[".$riadok."]]></r76b>"."\r\n"; fwrite($soubor, $text);
...
$riadok=$hlavicka->sdnr;
  $text = "  <r135><![CDATA[".$riadok."]]></r135>"."\r\n"; fwrite($soubor, $text);

$riadok=$hlavicka->r136;
if ( $riadok == 0 ) $riadok="";
  $text = "  <r136><![CDATA[".$riadok."]]></r136>"."\r\n"; fwrite($soubor, $text);
$riadok=$hlavicka->r137;
if ( $riadok == 0 ) $riadok="";
  $text = "  <r137><![CDATA[".$riadok."]]></r137>"."\r\n"; fwrite($soubor, $text);
$riadok=$hlavicka->r138;
if ( $riadok == 0 ) $riadok="";
  $text = "  <r138><![CDATA[".$riadok."]]></r138>"."\r\n"; fwrite($soubor, $text);

$riadok=1*$hlavicka->ldnr;
if ( $riadok == 0 ) $riadok="";
  $text = "  <r139><![CDATA[".$riadok."]]></r139>"."\r\n"; fwrite($soubor, $text);

$riadok=1*$hlavicka->nrzsprev;
if ( $riadok == 0 ) $riadok="";
...
$riadok=$hlavicka->zpld;
if ( $riadok == 0 ) $riadok="";
  $text = "  <r141><![CDATA[".$riadok."]]></r141>"."\r\n"; fwrite($soubor, $text);
...
$riadok=iconv("CP1250", "UTF-8", $hlavicka->pdrm1);
  $text = "    <druhPrimuPis><![CDATA[".$riadok."]]></druhPrimuPis>"."\r\n"; fwrite($soubor, $text);
...
$riadok=iconv("CP1250", "UTF-8", $hlavicka->pdro2);
  $text = "    <druhPrimuOds><![CDATA[".$riadok."]]></druhPrimuOds>"."\r\n"; fwrite($soubor, $text);
$riadok=iconv("CP1250", "UTF-8", $hlavicka->pdrm2);
  $text = "    <druhPrimuPis><![CDATA[".$riadok."]]></druhPrimuPis>"."\r\n"; fwrite($soubor, $text);
...
$riadok=iconv("CP1250", "UTF-8", $hlavicka->pdro3);
  $text = "    <druhPrimuOds><![CDATA[".$riadok."]]></druhPrimuOds>"."\r\n"; fwrite($soubor, $text);
$riadok=iconv("CP1250", "UTF-8", $hlavicka->pdrm3);
  $text = "    <druhPrimuPis><![CDATA[".$riadok."]]></druhPrimuPis>"."\r\n"; fwrite($soubor, $text);
...
$riadok=iconv("CP1250", "UTF-8", $hlavicka->pdro4);
  $text = "    <druhPrimuOds><![CDATA[".$riadok."]]></druhPrimuOds>"."\r\n"; fwrite($soubor, $text);
$riadok=iconv("CP1250", "UTF-8", $hlavicka->pdrm4);
  $text = "    <druhPrimuPis><![CDATA[".$riadok."]]></druhPrimuPis>"."\r\n"; fwrite($soubor, $text);
...
$riadok=iconv("CP1250", "UTF-8", $hlavicka->pdro5);
  $text = "    <druhPrimuOds><![CDATA[".$riadok."]]></druhPrimuOds>"."\r\n"; fwrite($soubor, $text);
$riadok=iconv("CP1250", "UTF-8", $hlavicka->pdrm5);
  $text = "    <druhPrimuPis><![CDATA[".$riadok."]]></druhPrimuPis>"."\r\n"; fwrite($soubor, $text);
...
$riadok=iconv("CP1250", "UTF-8", $hlavicka->pdro6);
  $text = "    <druhPrimuOds><![CDATA[".$riadok."]]></druhPrimuOds>"."\r\n"; fwrite($soubor, $text);
$riadok=iconv("CP1250", "UTF-8", $hlavicka->pdrm6);
  $text = "    <druhPrimuPis><![CDATA[".$riadok."]]></druhPrimuPis>"."\r\n"; fwrite($soubor, $text);
...
$vyplatbonus=$hlavicka->zurk;
  $text = "   <vyplatitDanovyBonusUroky><![CDATA[".$vyplatbonus."]]></vyplatitDanovyBonusUroky>"."\r\n"; fwrite($soubor, $text);
...
$ucet=$hlavicka->ucet;
  $text = "    <ucetZahranicie><![CDATA[".$ucet."]]></ucetZahranicie>"."\r\n"; fwrite($soubor, $text);
  $text = "   </sposobPlatby>"."\r\n"; fwrite($soubor, $text);
  $text = "   <bankovyUcet>"."\r\n"; fwrite($soubor, $text);
$iban=$hlavicka->diban;
...
$riadok=$hlavicka->prpodv1;
if ( $riadok == 0 ) $riadok="";
  $text = "    <r07><![CDATA[".$riadok."]]></r07>"."\r\n"; fwrite($soubor, $text);

$riadok=$hlavicka->prpodv2;
if ( $riadok == 0 ) $riadok="";
...
{
$upozorni12=1;
echo "<strong>NeuplatÚujem postup</strong> podæa ß 50 z·kona a z·roveÚ poukazujem sumu v <strong>bode 141</strong>.";
}
?>
</li>
<li class="orange">
...
{
$upozorni12=1;
echo "<strong>NeuplatÚujem postup</strong> podæa ß 50 z·kona a z·roveÚ s˙ vyplnenÈ <strong>˙daje o prijÌmateæovi</strong> v bode 142.";
}
?>
</li>
<li class="orange">
...
{
$upozorni12=1;
echo "Nie s˙ vyplnenÈ <strong>˙daje o prÌjimateæovi</strong> v bode 142.";
}
?>
</li>
<li class="orange">
...
{
$upozorni12=1;
echo "VyplnenÈ <strong>osobitnÈ z·znamy</strong>, ale <strong>nie je vybratÈ uv·dzam</strong> osobitnÈ z·znamy na strane 12.";
}
?>
</li>
</ul>
...
<li class="header-section">STRANA 15,16,17 - PRÕLOHY</li>
<li class="orange">
<?php
$wrongdat=1;
...
{
$upozorni15=1;
echo "<strong>D·tum v PrÌlohe SP a ZP strana 17</strong> nemÙûe byù vyööÌ ako aktu·lny d·tum.";
}
?>
</li>
<li class="orange">
...
{
$upozorni15=1;
echo "Je vyplnen˝ riadok 9 v PrÌlohe SP a ZP strana 17, ale ch˝ba vyplnen˝ <strong>d·tum v riadku 15</strong>.";
}
?>
</li>
<li class="orange">
...
{
$upozorni15=1;
echo "Riadok 39 zo strany 3 sa musÌ rovnaù <strong>riadku 8</strong> v PrÌlohe SP a ZP strana 17.";
}
?>
</li>
<li class="orange">
...
{
$upozorni15=1;
echo "Hodnota v riadku \"preuk·zateænÈ zaplatenÈ poistnÈ\" na strane 4 sa musÌ rovnaù <strong>riadok 12 + 14</strong> v PrÌlohe SP a ZP strana 17.";
}
?>
</li>
</ul>
...
<?php if ( $strana == 3 OR $strana == 9999 ) { ?>
   ...
   document.formv1.r38a.value = '<?php echo $r38a; ?>';
...
<?php if ( $strana == 5 OR $strana == 9999 ) { ?>
   ...
   document.formv1.r43pu.value = '<?php echo $r43pu; ?>';
   document.formv1.r44pu.value = '<?php echo $r44pu; ?>';
...
//   document.formv1.r68.value = '<?php echo $r68; ?>';
   ...
   document.formv1.t3p17.value = '<?php echo $t3p17; ?>';
   document.formv1.t3p18.value = '<?php echo $t3p18; ?>';
//   document.formv1.t3p16.value = '<?php echo $t3p16; ?>';
   ...
   document.formv1.t3v16.value = '<?php echo $t3v16; ?>';
   document.formv1.t3v17.value = '<?php echo $t3v17; ?>';
//   document.formv1.t3v18.value = '<?php echo $t3v18; ?>';
...
//   document.formv1.r72.value = '<?php echo $r72; ?>';
   ...
   document.formv1.r76a.value = '<?php echo $r76a; ?>';
   document.formv1.r76b.value = '<?php echo $r76b; ?>';
...
<?php if ( $strana == 11 OR $strana == 9999 ) { ?>
   ...
   document.formv1.r132.value = '<?php echo $r132; ?>';
   document.formv1.r133.value = '<?php echo $r133; ?>';
   document.formv1.r134.value = '<?php echo $r134; ?>';

   document.formv1.sdnr.value = '<?php echo $sdnr; ?>';
   document.formv1.r136.value = '<?php echo $r136; ?>';
   document.formv1.r137.value = '<?php echo $r137; ?>';
   document.formv1.r138.value = '<?php echo $r138; ?>';
...
<?php if ( $strana == 17 OR $strana == 9999 ) { ?>
...
//Z ciarky na bodku
  ...
  {
    window.open('priznanie_fob2018_pdf.php?cislo_oc=<?php echo $cislo_oc; ?>&copern=11&strana=' + strana + '&drupoh=1&subor=0', '_blank', blank_param);
  }
  function editForm(strana)
  {
    window.open('priznanie_fob2018.php?cislo_oc=<?php echo $cislo_oc; ?>&copern=20&prepocitaj=101&strana=' + strana + '&drupoh=1&subor=0', '_self');
  }
  ...
  {
   window.open('../ucto/priznanie_fob2018.php?cislo_oc=<?php echo $cislo_oc;?>&copern=3155&drupoh=1', '_self');
  }
  ...
  function vypocetOP()
  {
   window.open('priznanie_fob2018.php?copern=20&strana=<?php echo $strana; ?>&miliondan=1', '_self');
  }
  function namanzelku()
  {
   window.open('priznanie_fob2018.php?copern=20&strana=<?php echo $strana; ?>&namanzelku=1', '_self');
  }
  function NacitajVHpredDanou()
  {
   window.open('../ucto/priznanie_fob2018.php?strana=3&copern=200&drupoh=1&typ=PDF&dppo=1', '_self');
  }
  function NacitajSz9()
  {
...
//dopyt, vraziù na konkrÈtnu stranu
  ...
  function FormXML()
  {
   window.open('priznanie_fob2018.php?copern=10&drupoh=1', '_blank', blank_param);
  }
  function CisKrajin()
  {
