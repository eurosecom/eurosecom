...
<div class="navbar">
 ...
 <a href="#" onclick="window.open('priznanie_dppriloha2015.php?copern=1101&drupoh=1&page=1&volapo=<?php echo $volapo; ?>', '_self')" class="<?php echo $clas991; ?> toleft">P1</a>
 <a href="#" onclick="window.open('priznanie_dppriloha2015.php?copern=101&drupoh=1&page=1&volapo=<?php echo $volapo; ?>', '_self')" class="<?php echo $clas992; ?> toleft">P2</a>
 <a href="#" onclick="window.open('priznanie_dppriloha2015.php?copern=11&drupoh=1&page=1&volapo=<?php echo $volapo; ?>', '_blank')" class="<?php echo $clas992; ?> toright">P2</a>
 <a href="#" onclick="window.open('priznanie_dppriloha2015.php?copern=1011&drupoh=1&page=1&volapo=<?php echo $volapo; ?>', '_blank')" class="<?php echo $clas991; ?> toright">P1</a>
...
if ( $riadok->p1cpl > 0 ) { ?>
 <tbody>
  <tr>
   ...
   <td align="center">
    <img src="../obr/ikony/pencil_blue_icon.png" onclick="UpravPrmatel(<?php echo $riadok->p1cpl;?>);" title="Upraviù prijÌmateæa">&nbsp;&nbsp;
    <img src="../obr/ikony/xmark_lred_icon.png" onclick="ZmazPrmatel(<?php echo $riadok->p1cpl;?>);" title="Vymazaù prijÌmateæa">
   </td>
  </tr>
 </tbody>
<?php
...
<div class="wrap-prijimatelia">
 <table class="prijimatelia">
 <caption>
  <h3 class="toleft">PrÌloha k IV. Ëasti - œalöÌ proj</h3>
  <img src="../obr/ikony/plus_lgreen_icon.png" onclick="NovyProj();"
       title="Pridaù proj" class="toleft">
 </caption>
 <thead>
 <tr>
  <td width="5%" align="center">pol.</td>
  <td width="65%">ËÌslo projektu - popis</td>
  <td width="15%" align="right">Suma</td>
  <td width="15%" align="center">&nbsp;</td>
 </tr>
 </thead>
...
if ( $riadok->prcpl > 0 ) { ?>
 <tbody>
  <tr>
   ...
   <td align="center">
    <img src="../obr/ikony/pencil_blue_icon.png" onclick="UpravProj(<?php echo $riadok->prcpl;?>);" title="Upraviù proj">&nbsp;&nbsp;
    <img src="../obr/ikony/xmark_lred_icon.png" onclick="ZmazProj(<?php echo $riadok->prcpl;?>);" title="Vymazaù proj">
   </td>
  </tr>
 </tbody>
<?php
