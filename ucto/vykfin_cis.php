...
if ( !confirm ("Chcete naËÌtaù generovanie z minulÈho roka ?") )
         ...
         { location.href='vykfin_cis.php?copern=4056&page=1&drupoh=<?php echo $drupoh; ?>' }
</script>
<?php
    }
...
$dsqlt = "TRUNCATE TABLE F$kli_vxcf"."_".$uctsys." ";
...
$ixn=$ix;
if( $ix < 10 ) $ixn="0".$ix;
$dsqlt = "INSERT INTO F$kli_vxcf"."_pov_fin6a04 SELECT '0', '".$ix."', r".$ixn." FROM ".$databaza."F$h_ycf"."_prcvykfins6a04".$kli_uzid." WHERE r".$ixn." != 0 ";   
$dsql = mysql_query("$dsqlt");
...
if( !confirm ("Chcete naËÌtaù ötandardn˝ ËÌselnÌk generovania ?") )
         ...
         { location.href='vykfin_cis.php?copern=156&page=1&drupoh=<?php echo $drupoh; ?>'  }
</script>
<?php
    }
...
$sql = "DELETE FROM F$kli_vxcf"."_crv_fin6a04 ";
...
if( !confirm ("Chcete zmazaù vöetky poloûky generovania ?") )
         ...
         { location.href='vykfin_cis.php?copern=1416&page=1&drupoh=<?php echo $drupoh; ?>'  }
</script>
<?php
    }
...
$sql = "DELETE FROM F$kli_vxcf"."_pov_fin6a04 ";
$vysledok = mysql_query("$sql");
...
<title>EuroSecom -
<?php
if ( $drupoh >= 91 AND $drupoh <= 96 ) echo "FIN 6a04";
?>
&nbsp;nastavenie</title>
<style type="text/css">
...
//Kontrola cisla desatinneho
  ...
  {
   var cislo_cpl = cpl;
   window.open('../ucto/vykfin_cis.php?copern=316&page=1&sysx=UCT&cislo_cpl=' + cislo_cpl + '&drupoh=<?php echo $drupoh; ?>&uprav=0', '_self');
  }
  function UpravPolozku(cpl)
  {
   var cislo_cpl = cpl;
   window.open('../ucto/vykfin_cis.php?copern=308&page=1&sysx=UCT&uprav_cpl=' + cislo_cpl + '&cislo_cpl=' + cislo_cpl + '&drupoh=<?php echo $drupoh; ?>&uprav=1', '_self');
  }
  function ZmazVsetky()
  {
   window.open('../ucto/vykfin_cis.php?copern=1316&page=1&sysx=UCT&drupoh=<?php echo $drupoh; ?>&uprav=0', '_self');
  }
...
?>
  ...
  <td>
   ...
   <ul class="toleft legend-vykazy">
    ...
    <li><span class="purple">&nbsp;</span>FIN 6a04</li>
...
$source="../ucto/vykfin_cis.php?copern=308";
?>
...
<div class="content">
 <div class="content-heading" style="height:30px;">
  <h2>
<?php
if ( $drupoh == 92 OR $drupoh == 192 ) { echo "FIN 6a04 - generovanie"; }
if ( $drupoh == 94 OR $drupoh == 194 ) { echo "FIN 6a04 - predch·dzaj˙ce ˙ËtovnÈ obdobie"; }
?>
...
?>
<FORM name="formv1" method="post" action="vykfin_cis.php?copern=315&uprav=<?php echo $uprav;?>&drupoh=<?php echo $drupoh;?>&xtrd=0">
...
<?php if ( $drupoh != 95 AND $drupoh != 96 AND $drupoh != 195 AND $drupoh != 196 ) { ?>
  <th><a href="#" title="Zoradiù" class="sort-field" onclick="window.open('vykfin_cis.php?copern=308&uprav=<?php echo $uprav;?>&drupoh=<?php echo $drupoh;?>&xtrd1=<?php echo $xtrd1;?>&xtrd2=0&xtrd3=0', '_self');">⁄Ëet</a></th>
  <th colspan="2"><a href="#" title="Zoradiù" class="sort-field" onclick="window.open('vykfin_cis.php?copern=308&uprav=<?php echo $uprav;?>&drupoh=<?php echo $drupoh;?>&xtrd2=<?php echo $xtrd2;?>&xtrd1=0&xtrd3=0', '_self');">»Ìslo riadku</a></th>
<?php                                                                              } ?>
...
?>
<?php if ( $minul == 1 ) { ?>
  <th><a href="#" title="Zoradiù" class="sort-field" onclick="window.open('vykfin_cis.php?copern=308&uprav=<?php echo $uprav;?>&drupoh=<?php echo $drupoh;?>&xtrd1=<?php echo $xtrd1;?>&xtrd2=0&xtrd3=0', '_self');">Riadok</a></th>
  <th colspan="2"><a href="#" title="sort-field" class="sort-field" onclick="window.open('vykfin_cis.php?copern=308&uprav=<?php echo $uprav;?>&drupoh=<?php echo $drupoh;?>&xtrd2=<?php echo $xtrd2;?>&xtrd1=0&xtrd3=0', '_self');">Hodnota</a></th>
<?php                    } ?>
  <th>&nbsp;</th>
 </tr>
 <tr style="">
