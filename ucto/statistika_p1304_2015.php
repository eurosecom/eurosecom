...
<script type="text/javascript">
 window.open('../ucto/statistika_p1304_2015.php?copern=102&drupoh=1&page=1&strana=3', '_self' )
</script>
<?php
}
...
//Z ciarky na bodku
  ...
  function TlacVykaz()
  {
   window.open('../ucto/statistika_p1304_2015.php?copern=11&strana=9999', '_blank');
  }
  ...
  {
   window.open('../ucto/statistika_p1304_2015.php?h_mfir=<?php echo $kli_vxcf; ?>&copern=200&drupoh=1&page=1&typ=PDF&cstat=1304&vyb_ume=<?php echo $vyb_umk; ?>', '_self');
  }
  function zarch( stvrtrok )
  {
   window.open('../ucto/statistika_p1304_2015.php?copern=11&drupoh=1&page=1&typ=PDF&zarchivu=1&stvarch=' + stvrtrok +  '&xxx=1', '_blank', 'width=980, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes, menubar=yes, toolbar=yes');
  }
</script>
</HEAD>
<BODY onload="ObnovUI();">
...
<div id="content">
<FORM name="formv1" method="post" action="statistika_p1304_2015.php?copern=103&strana=<?php echo $strana; ?>">
<?php
$clas1="noactive"; $clas2="noactive"; $clas3="noactive";
if ( $strana == 1 ) $clas1="active"; if ( $strana == 2 ) $clas2="active"; if ( $strana == 3 ) $clas3="active";
$source="statistika_p1304_2015.php?";
?>
<div class="navbar">
...
<img src="../dokumenty/statistika2014/prod1304/prod1304v14_str1.jpg"
 alt="tlaËivo ätvrùroËn˝ v˝kaz produkËn˝ch odvetvÌ v mal˝ch podnikoch Prod 13-04 1.strana 132kB" class="form-background">
<?php
...
<img src="../dokumenty/statistika2014/prod1304/prod1304v14_str2.jpg"
 alt="tlaËivo ätvrùroËn˝ v˝kaz produkËn˝ch odvetvÌ v mal˝ch podnikoch Prod 13-04 2.strana 120kB" class="form-background">
...
<img src="../dokumenty/statistika2014/prod1304/prod1304v14_str3.jpg"
 alt="tlaËivo ätvrùroËn˝ v˝kaz produkËn˝ch odvetvÌ v mal˝ch podnikoch Prod 13-04 3.strana 165kB" class="form-background">
...
<img src="../obr/ikony/download_blue_icon.png" title="NaËÌtaù Celkov˝ ˙hrn aktÌv zo S˙vahy"
