...
<td>EuroSecom  -  ⁄hrady dokladu ËÌslo <?php echo $cislo_dok; ?> pre OdpoËet a uplatnenie DPH aû po prijatÌ platby
 ...
 <a href="#" onClick="TZoznamDPHPRP();" title="VytlaËiù Zoznam prijat˝ch platieb pre uplatnenie DPH za <?php echo $kli_vume; ?> vo form·te PDF">
Platby <img src='../obr/tlac.png' width=20 height=15 border=0 ></a>

 <a href="#" onClick="TZoznamDPHFAK();" title="VytlaËiù Zoznam fak˙r v reûÌme uplatnenia DPH aû po prijatÌ platby za <?php echo $kli_vume; ?> vo form·te PDF" >
Fakt˙ry <img src='../obr/tlac.png' width=20 height=15 border=0 ></a>
