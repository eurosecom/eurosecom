...
"Chcete naËÌtaù ˙daje o vekovej ötrukt˙re pohæad·vok (tab.16) zo saldokonta ?</a>";
    htmlmenu += "</td></tr>";  

    htmlmenu += "<tr><td width='100%' class='ponuka' colspan='2'>"; 
htmlmenu += "<a href=\"#\" onClick=\"NacitajHodnotu( 402 );\">" +
"Chcete naËÌtaù ˙daje o z·v‰zkoch (tab.26) zo saldokonta ?</a>";
    htmlmenu += "</td></tr>"; 
...
"Chcete naËÌtaù ˙daje z miezd (tab.1) firma ËÌslo</a> ";
...
//hlavicka strany
$pdf->SetY(5);
$pdf->Cell(38,7,"Pozn·mky ⁄Ë MUJ 3 - 04","1",0,"L");
...
$pdf->Cell(10,6," ","$rmc1",0,"L");$pdf->Cell(180,6,"A. INFORM¡CIE O ⁄»TOVNEJ JEDNOTKE","$rmc",1,"L");
...
$pdf->SetFont('arial','',8);
$pdf->Cell(12,4," ","$rmc1",0,"L");$pdf->Cell(0,4,"1. Inform·cie k Ëasti A. pÌsm. c) prÌlohy Ë.3 o poËte zamestnancov","$rmc",1,"L");
