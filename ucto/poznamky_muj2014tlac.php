...
<FORM name='emzdy' method='post' action='#'>
 ...
 <li>
  <a href="#" onclick="NacitajHodnotu( 999 );">NaËÌtaù <strong>minul˝ rok</strong> z Pozn·mok PO 2013</a>
 </li>
 <li>
...
$pdf->SetFont('arial','',10);
$pdf->Cell(10,6," ","$rmc1",0,"L");$pdf->Cell(180,6,"»l.2 Inform·cie o prijat˝ch postupoch.","$rmc",1,"L");


$pdf->Cell(90,10,"     ","$rmc1",1,"L");
$pdf->SetFont('arial','',9);
$pdf->Cell(10,4," ","$rmc1",0,"L");$pdf->Cell(0,4,"»l.2.1 NepretrûitÈ pokraËovanie v Ëinnosti.","$rmc",1,"L");
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
...
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
$pdf->SetFont('arial','',9);
$pdf->Cell(10,4," ","$rmc1",0,"L");$pdf->Cell(0,4,"»l.2.2 SpÙsob oceÚovania jednotliv˝ch poloûiek majetku a z·v‰zkov.","$rmc",1,"L");
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
...
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
$pdf->SetFont('arial','',9);
$pdf->Cell(10,4," ","$rmc1",0,"L");$pdf->Cell(0,4,"»l.2.3 SpÙsob zostavenia odpisovÈho pl·nu majetku.","$rmc",1,"L");
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
...
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
$pdf->SetFont('arial','',9);
$pdf->Cell(10,4," ","$rmc1",0,"L");$pdf->Cell(0,4,"»l.2.4 Zmeny ˙Ëtovn˝ch z·sad a zmeny ˙Ëtovn˝ch metÛd.","$rmc",1,"L");
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
...
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
$pdf->SetFont('arial','',9);
$pdf->Cell(10,4," ","$rmc1",0,"L");$pdf->Cell(0,4,"»l.2.5 Inform·cie o dot·ci·ch a ich oceÚovanie v ˙ËtovnÌctve.","$rmc",1,"L");
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
...
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
$pdf->SetFont('arial','',9);
$pdf->Cell(10,4," ","$rmc1",0,"L");$pdf->Cell(0,4,"»l.2.6 Inform·cie o ˙ËtovanÌ v˝znamn˝ch opr·v ch˝b minul˝ch ˙Ëtovn˝ch obdobÌ v beûnom ˙Ëtovnom obdobÌ.","$rmc",1,"L");
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
...
$pdf->SetLeftMargin(10);
$pdf->SetTopMargin(10);
if ( File_Exists('../dokumenty/dan_z_prijmov2014/poznamkymuj2014tabtext/poznamkymuj_tab301.jpg') AND $hlavicka->tlt301 == 1 )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/poznamkymuj2014tabtext/poznamkymuj_tab301.jpg',0,150,210,70);
}
...
$pdf->Cell(190,8,"                          ","$rmc1",1,"L");
$pdf->SetFont('arial','',10);
$pdf->Cell(10,6," ","$rmc1",0,"L");$pdf->Cell(180,6,"»l.3. Inform·cie, ktorÈ vysvetæuj˙ a dopÂÚaj˙ s˙vahu a v˝kaz ziskov a str·t.","$rmc",1,"L");

$pdf->Cell(90,10,"     ","$rmc1",1,"L");

$pdf->SetFont('arial','',9);
$pdf->Cell(10,4," ","$rmc1",0,"L");$pdf->Cell(0,4,"»l.3.1 Inform·cia o sume a dÙvodoch vzniku jednotliv˝ch poloûiek n·kladov alebo v˝nosov, ktorÈ maj˙ v˝nimoËn˝ rozsah.","$rmc",1,"L");
$pdf->Cell(90,10,"     ","$rmc1",1,"L");

$pdf->Cell(90,80,"     ","$rmc1",1,"L");

$pdf->Cell(90,10,"     ","$rmc1",1,"L");
$pdf->SetFont('arial','',9);
$pdf->Cell(10,4," ","$rmc1",0,"L");$pdf->Cell(0,4,"»l.3.2 Inform·cie o z·v‰zkoch.","$rmc",1,"L");
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
...
$pdf->SetLeftMargin(10);
$pdf->SetTopMargin(10);
if ( File_Exists('../dokumenty/dan_z_prijmov2014/poznamkymuj2014tabtext/poznamkymuj_tab302.jpg') AND $hlavicka->tlt302 == 1 )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/poznamkymuj2014tabtext/poznamkymuj_tab302.jpg',0,40,210,40);
}
...
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
$pdf->SetFont('arial','',9);
$pdf->Cell(10,4," ","$rmc1",0,"L");$pdf->Cell(0,4,"»l.3.3 Inform·cie o vlastn˝ch akci·ch.","$rmc",1,"L");
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
...
$pdf->SetLeftMargin(10);
$pdf->SetTopMargin(10);
if ( File_Exists('../dokumenty/dan_z_prijmov2014/poznamkymuj2014tabtext/poznamkymuj_tab303.jpg') AND $hlavicka->tlt303 == 1 )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/poznamkymuj2014tabtext/poznamkymuj_tab303.jpg',0,140,210,140);
}
...
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
$pdf->SetFont('arial','',9);
$pdf->Cell(10,4," ","$rmc1",0,"L");$pdf->Cell(0,4,"»l.3.4 Inform·cie o org·noch ˙Ëtovnej jednotky.","$rmc",1,"L");
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
...
$pdf->SetLeftMargin(10);
$pdf->SetTopMargin(10);
if ( File_Exists('../dokumenty/dan_z_prijmov2014/poznamkymuj2014tabtext/poznamkymuj_tab304.jpg') AND $hlavicka->tlt304 == 1 )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/poznamkymuj2014tabtext/poznamkymuj_tab304.jpg',0,80,210,80);
}

if ( File_Exists('../dokumenty/dan_z_prijmov2014/poznamkymuj2014tabtext/poznamkymuj_tab305.jpg') AND $hlavicka->tlt305 == 1 )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/poznamkymuj2014tabtext/poznamkymuj_tab305.jpg',0,210,210,62);
}
...
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
$pdf->SetFont('arial','',9);
$pdf->Cell(10,4," ","$rmc1",0,"L");$pdf->Cell(0,4,"»l.3.5 Inform·cie o povinnostiach ˙Ëtovnej jednotky.","$rmc",1,"L");
$pdf->Cell(90,10,"     ","$rmc1",1,"L");
...
$pdf->SetLeftMargin(10);
$pdf->SetTopMargin(10);
if ( File_Exists('../dokumenty/dan_z_prijmov2014/poznamkymuj2014tabtext/poznamkymuj_tab306.jpg') AND $hlavicka->tlt306 == 1 )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/poznamkymuj2014tabtext/poznamkymuj_tab306.jpg',0,40,210,60);
}

if ( File_Exists('../dokumenty/dan_z_prijmov2014/poznamkymuj2014tabtext/poznamkymuj_tab307.jpg') AND $hlavicka->tlt307 == 1 )
{
$pdf->Image('../dokumenty/dan_z_prijmov2014/poznamkymuj2014tabtext/poznamkymuj_tab307.jpg',0,210,210,74);
}
