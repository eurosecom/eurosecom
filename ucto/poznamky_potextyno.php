...
$sql = "ALTER TABLE F$kli_vxcf"."_poznamky_no2011texty MODIFY ozntxt VARCHAR(10) PRIMARY KEY not null ";
...
$ulozttt = "DROP TABLE F$kli_vxcf"."_poznamky_no2011textyxxx "; 
$ulozene = mysql_query("$ulozttt"); 
$ulozttt = "CREATE TABLE F$kli_vxcf"."_poznamky_no2011textyxxx SELECT * FROM ".$databaza."F$firmax"."_poznamky_no2011texty WHERE  ozntxt='$oznacx' "; 
$ulozene = mysql_query("$ulozttt"); 
if( !$ulozene )
{
$ulozttt = "DROP TABLE F$kli_vxcf"."_poznamky_no2011textyxxx "; 
$ulozene = mysql_query("$ulozttt"); 
$ulozttt = "CREATE TABLE F$kli_vxcf"."_poznamky_no2011textyxxx SELECT * FROM ".$databaza."F$firmax"."_poznamky_po2011texty WHERE  ozntxt='$oznacx' "; 
$ulozene = mysql_query("$ulozttt"); 
}


$ulozttt = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamky_no2011textyxxx SET ".
" F$kli_vxcf"."_poznamky_no2011texty.hdntxt=F$kli_vxcf"."_poznamky_no2011textyxxx.hdntxt ".
" WHERE F$kli_vxcf"."_poznamky_no2011texty.ozntxt='$h_ozntxt' "; 
$ulozene = mysql_query("$ulozttt"); 
...
$ulozttt = "INSERT INTO F$kli_vxcf"."_poznamky_no2011texty ( ozntxt, hdntxt ) VALUES ('$h_ozntxt', '$h_hdntxt' ) "; 
//echo $ulozttt;
$ulozene = mysql_query("$ulozttt"); 

$ulozttt = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET hdntxt='$h_hdntxt' WHERE ozntxt='$h_ozntxt' "; 
$ulozene = mysql_query("$ulozttt"); 
//echo $ulozttt;
$copern=1;
$ulozenx="Text uloûen˝";
...
//import z ../import/FIR$kli_vxcf/POZNAMKYNO2011.CSV
    if ( $copern == 55 )
    {
$odkial="../import/FIR".$kli_vxcf."/POZNAMKYNO".$kli_vrok.".CSV";
$firxyz = 1*strip_tags($_REQUEST['firx']);
if( $firxyz == 9999 ) { $odkial="../import/POZNAMKYNO".$kli_vrok.".CSV"; }
...
if( !confirm ("Chcete importovaù poloûky \r zo s˙boru <?php echo $odkial; ?> ? \r POZOR!!! Pred importom bud˙ terajöie pozn·mky v tejto firme vymazanÈ .") )
         ...
         { location.href='poznamky_potextyno.php?copern=56&page=1&firx=<?php echo $firxyz; ?>'  }
</script>
<?php
    }
    if ( $copern == 56 )
...
$sqult = "TRUNCATE TABLE F$kli_vxcf"."_poznamky_no2011texty ";
...
$sqult = "INSERT INTO F$kli_vxcf"."_poznamky_no2011texty ( ozntxt, hdntxt ) VALUES ('$h_ozntxt', '$h_hdntxt' ) ";
//echo $sqult;
...
echo "Tabulka F$kli_vxcf"."_poznamky_no2011texty!"." naimportovan· <br />";

fclose ($subor);

$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET hdntxt=REPLACE(hdntxt,'###rn###','\r\n') ";
$ulozene = mysql_query("$sqult"); 
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET hdntxt=REPLACE(hdntxt,'###r###','\r') ";
$ulozene = mysql_query("$sqult"); 
...
//polozky
$sqltt = "SELECT * FROM F$kli_vxcf"."_poznamky_no2011texty ORDER BY ozntxt";
...
if( !confirm ("Chcete naËÌtaù pozn·mky z firmy Ë. <?php echo $fix;?> ? \r POZOR !!! CelÈ pozn·mky bud˙ najprv vymazanÈ .") )
         ...
         { location.href='poznamky_potextyno.php?&copern=356&drupoh=1&page=1&h_ozntxt=<?php echo $h_ozntxt; ?>&firx=<?php echo $firxyz; ?>'  }
</script>
<?php
    }
...
$dsqlt = "TRUNCATE TABLE F$kli_vxcf"."_poznamky_no2011texty ";
...
$dsqlt = "INSERT INTO F$kli_vxcf"."_poznamky_no2011texty".
...
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=99 ";
$ulozene = mysql_query("$sqult");

//Acka
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='A_text1' WHERE oldp = 'A' AND oldc1 = 0 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamkypoprc ".
...
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='A_text2' WHERE oldp = 'A' AND oldc1 = 2 ";
$ulozene = mysql_query("$sqult");

//Bcka
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='B_text1' WHERE oldp = 'B' AND oldc1 = 1 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamkypoprc ".
...
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='B_text2' WHERE oldp = 'B' AND oldc1 = 4 ";
$ulozene = mysql_query("$sqult");

//Ccka
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='C_text1' WHERE oldp = 'C' AND oldc1 = 0 ";
$ulozene = mysql_query("$sqult");

//Ecka
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='E_text1' WHERE oldp = 'E' AND oldc1 = 1 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='E_text2' WHERE oldp = 'E' AND oldc1 = 2 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamkypoprc ".
...
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='E_text3' WHERE oldp = 'E' AND oldc1 = 7 ";
$ulozene = mysql_query("$sqult");

//Fka
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='F_text1' WHERE oldp = 'F' AND oldc1 = 0 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamkypoprc ".
" SET psys=0, hdntxt=CONCAT('\r', hdntxt, pozn )  WHERE ozntxt='F_text1' AND r00 = 'F' AND r01 = '18' ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='F_text2' WHERE oldp = 'F' AND oldc1 = 1 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='F_text5' WHERE oldp = 'F' AND oldc1 = 2 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='F_text8' WHERE oldp = 'F' AND oldc1 = 3 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='F_text7' WHERE oldp = 'F' AND oldc1 = 4 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamkypoprc ".
...
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='F_text9' WHERE oldp = 'F' AND oldc1 = 5 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamkypoprc ".
" SET psys=0, hdntxt=CONCAT('\r', hdntxt, pozn )  WHERE ozntxt='F_text9' AND r00 = 'F' AND r01 = '6' ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='F_text14' WHERE oldp = 'F' AND oldc1 = 7 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='F_text17' WHERE oldp = 'F' AND oldc1 = 9 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='F_text21' WHERE oldp = 'F' AND oldc1 = 10 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='F_text25' WHERE oldp = 'F' AND oldc1 = 12 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='F_text30' WHERE oldp = 'F' AND oldc1 = 13 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='F_text3' WHERE oldp = 'F' AND oldc1 = 14 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='F_text31' WHERE oldp = 'F' AND oldc1 = 19 ";
$ulozene = mysql_query("$sqult");

//Gcka
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='G_text8' WHERE oldp = 'F' AND oldc1 = 11 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='G_text1' WHERE oldp = 'G' AND oldc1 = 0 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='G_text4' WHERE oldp = 'G' AND oldc1 = 2 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='G_text7' WHERE oldp = 'G' AND oldc1 = 3 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamkypoprc ".
" SET psys=0, hdntxt=CONCAT('\r', hdntxt, pozn )  WHERE ozntxt='G_text8' AND r00 = 'G' AND r01 = '4' ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='G_text9' WHERE oldp = 'G' AND oldc1 = 5 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='G_text10' WHERE oldp = 'G' AND oldc1 = 6 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='G_text11' WHERE oldp = 'G' AND oldc1 = 7 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='G_text14' WHERE oldp = 'G' AND oldc1 = 8 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='G_text18' WHERE oldp = 'G' AND oldc1 = 10 ";
$ulozene = mysql_query("$sqult");

//Hcka
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='H_text1' WHERE oldp = 'H' AND oldc1 = 0 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamkypoprc ".
...
//Icka
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='I_text1' WHERE oldp = 'I' AND oldc1 = 0 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamkypoprc ".
...
//Jcka
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='J_text1' WHERE oldp = 'J' AND oldc1 = 0 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamkypoprc ".
...
//Kcka
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='K_text1' WHERE oldp = 'K' AND oldc1 = 0 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamkypoprc ".
...
//Lcka
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='L_text1' WHERE oldp = 'L' AND oldc1 = 0 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamkypoprc ".
...
//Mcka
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='M_text1' WHERE oldp = 'M' AND oldc1 = 0 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamkypoprc ".
...
//Ncka
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='N_text1' WHERE oldp = 'N' AND oldc1 = 0 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamkypoprc ".
...
//Ocka
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='O_text1' WHERE oldp = 'O' AND oldc1 = 0 ";
$ulozene = mysql_query("$sqult");
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty,F$kli_vxcf"."_poznamkypoprc ".
...
//Pcko
$sqult = "UPDATE F$kli_vxcf"."_poznamky_no2011texty SET psys=0, ozntxt='P_text1' WHERE oldp = 'G' AND oldc1 = 1 ";
$ulozene = mysql_query("$sqult");

$sqult = "DELETE FROM F$kli_vxcf"."_poznamky_no2011texty WHERE psys = 99 ";
$ulozene = mysql_query("$sqult");
...
$dsqlt = "INSERT INTO F$kli_vxcf"."_poznamky_no2011texty SELECT * FROM ".$databaza."F$fix"."_poznamky_no2011texty WHERE ico >= 0 ";
$dsql = mysql_query("$dsqlt");
//echo $dsqlt;
...
$sqlfir = "SELECT * FROM F$kli_vxcf"."_poznamky_no2011texty ".
...
window.open('poznamky_potextyno.php?&copern=55&page=1&firx=' + firma + '&h_ozntxt=<?php echo $h_ozntxt; ?>',
 '_self', 'width=1080, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes' );
    }

    function nacitajMin()
    {
window.open('poznamky_potextyno.php?copern=355&drupoh=1&page=1&h_ozntxt=<?php echo $h_ozntxt; ?>',
 '_self', 'width=1080, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes' );
    }
...
if( firma > 0 && firma != <?php echo $kli_vxcf; ?> )
       {
window.open('poznamky_potextyno.php?copern=355&drupoh=1&page=1&firx='+ firma + '&h_ozntxt=<?php echo $h_ozntxt; ?>',
 '_self', 'width=1080, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes' );
       }
    }
...
window.open('poznamky_potextyno.php?copern=4055&drupoh=1&page=1&firmax='+ firmax + '&oznacx='+ oznacx + '&h_ozntxt=<?php echo $h_ozntxt; ?>',
 '_self', 'width=1080, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes' );
    }
...
<script type="text/javascript" src="poznamky_textyno_xml.js"></script>
</HEAD>
...
<?php if ( $kli_uzall > 90000 ) { ?>
  &nbsp;&nbsp;&nbsp;|&nbsp;
<a href='poznamky_potextyno.php?&copern=655&page=1'>
...
<?php                           } ?>
  &nbsp;|&nbsp;
<a href='poznamky_potextyno.php?&copern=55&page=1&firx=9999' >
...
if ( $copern == 1  )
     {
?>
<FORM name="formv1" method="post" action="poznamky_potextyno.php?page=1&copern=116&h_ozntxt=<?php echo $h_ozntxt;?>">
