...
if( $jednapolozka != 1 ) $pdf->Cell(130,6,"HROMADNÝ PRÍKAZ NA ÚHRADU ","0",1,"C");
if( $jednapolozka == 1 ) $pdf->Cell(130,6,"PRÍKAZ K ÚHRADE ","0",1,"C");
$pdf->SetFont('arial','',10);
...
if( $eurofp == 0 ) {
$pdf->Cell(40,6,"Úèet platite¾a","1",0,"R");$pdf->Cell(20,6,"NumKód","1",0,"R");
$pdf->Cell(30,6,"Celkom suma","1",0,"R");$pdf->Cell(35,6,"Dòa","LBR",0,"R");$pdf->Cell(55,6," ","LBR",1,"L");
                   }
if( $eurofp == 1 ) {
$pdf->Cell(40,6,"Úèet platite¾a","1",0,"R");$pdf->Cell(20,6,"NumKód","1",0,"R");
$pdf->Cell(30,6,"Celkom suma","1",0,"R");$pdf->Cell(35,6,"Dátum splatnosti","LBR",0,"R");$pdf->Cell(55,6," ","LBR",1,"L");
                   }
...
$pdf->Cell(30,6,"Sumy","LRB",0,"R");$pdf->Cell(35,6,"Variabilný","1",0,"R");$pdf->Cell(20,6,"Konštantný","1",0,"R");$pdf->Cell(35,6,"Špecifický","1",1,"R");
}
