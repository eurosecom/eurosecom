...
$pdf->Cell(190,2," ","$rmc1",1,"L");
$pdf->Cell(52,6," ","$rmc1",0,"L");$pdf->Cell(123,5,"$fod","$rmc",1,"L"); //dopyt, $fod nefunguje + podmienka, aby zobrazil, iba keÔ je 999
...
$pdf->Cell(37,6," ","$rmc1",0,"L");$pdf->Cell(15,4,"$dcdm","$rmc",0,"L"); //dopyt, rozdeliù na pred lomÌtkom a za lomÌtkom
