...
<div>
 <img src='../obr/flag_gb.png' style='width:20px; height:28px;' title='Ak chcete anglick˙ verziu Uz·vierky, zaökrtnite checkbox a potom kliknite zobraziù v PDF'>
 <input type="checkbox" name="eng" value="1" style='width:20px; height:28px;' title='Ak chcete anglick˙ verziu Uz·vierky, zaökrtnite checkbox a potom kliknite zobraziù v PDF' />
</div>
</div>
...
<a href="#" onclick="KompletPOD2014len1();" title="Zobraziù ˙vodn˙ stranu vo form·te PDF"
   class="toleft line-box box-blue"><img src='../obr/tlac.png'></a>
...
<a href="#" onclick="KompletNUJ2013doxml();" title="Export do XML"
   class="toleft line-box box-red"><img src='../obr/export.png'></a>
<a href="#" onclick="KompletNUJ2013len1();" title="Zobraziù ˙vodn˙ stranu vo form·te PDF"
   class="toleft line-box box-blue"><img src='../obr/tlac.png'></a>
...
<a href="#" onclick="KompletNO2013doxml();" title="Export do XML"
   class="toleft line-box box-red"><img src='../obr/export.png'></a>
<a href="#" onclick="KompletNO2013len1();" title="Zobraziù ˙vodn˙ stranu vo form·te PDF"
   class="toleft line-box box-blue"><img src='../obr/tlac.png'></a>
...
<div class="line-area"> <!-- oznamenie odloû -->
<div class="toleft line-box"></div>
<a href="#" onclick="TlacOzOdl();" title="Zobraziù v PDF"
   class="toleft line-box box-blue"><img src='../obr/tlac.png'></a>
<div class="toleft line-box-text">
<div>
 <strong>Ozn·menie daÚovnÌka o predÂûenÌ lehoty na podanie daÚovÈho priznania</strong>
</div>
</div>
<a href="#" onclick="OzOdldoXML();" title="export do XML"
   class="toleft line-box box-red"><img src='../obr/export.png'></a>
<a href="#" onclick="UpravOzOdl();" title="Upraviù hodnoty"
   class="toleft line-box box-green"><img src='../obr/zoznam.png'></a>
</div> <!-- .line-area oznamenie odloû -->
<?php } ?>
...
<div class="toleft line-box"></div>
  <a href="#" onclick="TlacOzn176();" title="Zobraziù v PDF" class="toleft line-box box-blue"><img src='../obr/tlac.png'></a>
<div class="toleft line-box-text">
<div>
 <strong>Ozn·menie o vykonanÌ ˙pravy z·kladu dane </strong>
</div>
</div>
  <a href="#" onclick="UpravOzn176();" title="Upraviù hodnoty" class="toleft line-box box-green"><img src='../obr/zoznam.png'></a>
</div>
