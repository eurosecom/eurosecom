...
if( $copern != 901 )
{
$sql = "SELECT * FROM F".$kli_vxcf."_poznamky_po2011s4 ";
$vysledok = mysql_query("$sql");
if (!$vysledok) { echo "<br /><br />Nemáte inicializované Poznámky POD, najprv 1x vojdite do úpravy Poznámok POD."; exit; }
...
$vysledok = mysql_query("$sql");
if (!$vysledok) { echo "<br /><br />Nemáte vytvorený súbor pre naèítanie, 1x kliknite na odkaz Súbor v Naèítaní údajov do Poznámok POD."; exit; }
...
$ttvv = "DELETE FROM F$kli_vxcf"."_poznamky_po2011set WHERE polozka ='$premenna' ";
$ttqq = mysql_query("$ttvv");

$ttvv = "INSERT INTO F$kli_vxcf"."_poznamky_po2011set ( polozka,ucm1,ucm2,ucm3,ucm4,ucm5,ico1,ico2,ico3,ico4,ico5,zmd,zdl,omd,odl,pmd,pdl,mnl ) ".
...
window.open('../ucto/poznamky_po2013tlac.php?copern=1&drupoh=1&page=1&strana=<?php echo $strana; ?>&dopoz=1', '_self' )
