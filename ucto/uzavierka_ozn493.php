...
<div id="wrap-heading">
 <table id="heading">
  ...
  <tr>
   <td class="header">Ozn·menie o predÂûenÌ lehoty na podanie priznania
<?php if ( $copern == 40 ) { ?><span class="subheader">/ export xml</span><?php } ?>
   </td>
   <td>
...
$nazsub="../tmp/ozn493".$kli_vrok."_id".$kli_uzid."_".$kli_nxcf10."_".$hhmm.".xml";
