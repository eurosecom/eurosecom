...
<HTML>
<?php
//celkovy zaciatok dokumentu Oznamenie daòovníka o predåžení lehoty na podanie daòového priznania v. 2017
do
{
$sys = 'UCT';
$urov = 2000;
...
<title>EuroSecom - Uzávierka oznámenie 493</title>
<style type="text/css">
span.text-echo {
  font-size: 18px;
  letter-spacing: 13px;
...
<div id="wrap-heading">
 <table id="heading">
  ...
  <tr>
   <td class="header">Oznámenie daòovníka o predåžení lehoty na podanie daòového priznania
   </td>
   <td>
...
<img src="../dokumenty/dan_z_prijmov2014/uzozn_v14.jpg"
 alt="tlaèivo Oznámenie o dátume schválenia úètovnej závierky pre rok 2014 204kB"
