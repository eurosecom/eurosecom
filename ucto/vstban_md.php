...
if ( $cisdokodd == 1 )
        {
 if ( $cislo_dok > 1 ) { $upravttt = "UPDATE F$kli_vxcf"."_dban SET cban='$cislo_dok' WHERE cban > '$cislo_dok' AND dban = $hladaj_uce"; }
 //echo $upravtt;
...
<title>BankovÈ v˝pisy | EuroSecom</title>
<style>
/* list layout */
...
<form name="formhl1" method="post" action="vstban_md.php?sysx=<?php echo $sysx; ?>&hladaj_uce=<?php echo $hladaj_uce; ?>
&rozuct=<?php echo $rozuct; ?>&page=1&copern=9">
  <div class="mdl-layout__header-row ui-header-title-row">
    ...
    <li class="breadcrumb-item active">
      <a href="#" id="header_dropdown_menu" class="dropdown">BankovÈ v˝pisy</a>
<?php
...
<!-- header dropdown nav menu -->
    <li class="wrap-dropdown-menu">
      <ul for="header_dropdown_menu" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
        <li onclick="BankaVypisy();" class="mdl-menu__item active">BankovÈ v˝pisy</li>
        <li onclick="BankaUcty();" class="mdl-menu__item">BankovÈ ˙Ëty</li>
      </ul>
    </li>
...
<FORM name="formhl2" class="hmenu" method="post" action="vstban_md.php?sysx=<?php echo $sysx; ?>&hladaj_uce=<?php echo $hladaj_uce; ?>
&rozuct=<?php echo $rozuct; ?>&page=1&copern=1" >
...
<?php echo $riadok->dok; ?>
    ...
    <td><?php echo $riadok->zk0u; ?></td>
    <td><?php echo $riadok->zk1u; ?></td>
    <td><?php echo $riadok->zk2u; ?></td>
    <td>
      <button type="button" id="view<?php echo $riadok->dok; ?>" onclick="VytlacPokl(<?php echo $riadok->dok;?>);" class="mdl-button mdl-js-button mdl-button--icon mdl-layout--large-screen-only">
...
<img src='../obr/zmaz.png' width=15 height=10 border=0 alt="Vymazanie vybranÈho dokladu" title="Vymazanie vybranÈho dokladu" ></a>
<?php } ?>
<?php
...
<form name="forma3" method="post" action="vstvse_md.php?sysx=<?php echo $sysx; ?>&hladaj_uce=<?php echo $hladaj_uce; ?>&rozuct=<?php echo $rozuct; ?>&copern=4&page=<?php echo $xstr;?>">
  <div class="ui-list-footer ui-list ui-container">

<INPUT type="submit" id="sstrana" value="Prejsù na stranu:" style="visibility: hidden;">
<input type="text" name="page" id="page" value="<?php echo $xstr;?>" onkeyup="KontrolaCisla(this, Ax)" style="visibility: hidden;"/>
...
var vyskawin = screen.height-175;
  ...
  var okno = window.open("vstban_md.php?sysx=UCT&hladaj_uce=" + ucet + "&rozuct=ANO&page=1&copern=1", "_self");
      }
...
?>
    ...
    var ucet = document.formhl1.hladaj_uce.value;
    window.open('pokl_kniha.php?copern=40&page=1&typ=HTML&cislo_uce=' + ucet + '&page=1&cele=1', '_blank', 'width=1080, height=900, top=0, left=10, status=yes, resizable=yes, scrollbars=yes' )
...
//header nav
  ...
  {
    window.open('../ucto/vstban_md.php?copern=1&page=1', '_self');
  }
  function BankaUcty()
  {
