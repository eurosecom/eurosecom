...
<form name="forma3" method="post" action="vstpok.php?sysx=<?php echo $sysx; ?>&hladaj_uce=<?php echo $hladaj_uce; ?>&rozuct=<?php echo $rozuct; ?>&copern=4&drupoh=<?php echo $drupoh;?>&page=<?php echo $xstr;?>">
...
<?php if( $sysx != 'UCT' ) { ?>
  var okno = window.open("vstban_md.php?sysx=<?php echo $sysx; ?>&hladaj_uce=" + ucet + "&rozuct=<?php echo $rozuct; ?>&drupoh=<?php echo $drupoh;?>&page=1&copern=1", "_self");
<?php                      } ?>
<?php if( $sysx == 'UCT' ) { ?>
  var okno = window.open("vstban_md.php?sysx=UCT&hladaj_uce=" + ucet + "&rozuct=ANO&drupoh=<?php echo $drupoh;?>&page=1&copern=1", "_self");
<?php                      } ?>
      }
