...
if ( ( $copern == 5 AND $drupoh == 2 ) OR ( $copern == 7 AND $drupoh == 2 ) )
     {
...
$vsql = "INSERT INTO F".$kli_vxcf."_autopausal".$kli_uzid." ( id, udp, adp, uzk, azk, ajo, aju ) VALUES ( '$kli_uzid', '', '', '', '99', 1, '54999' ) ";
$vytvor = mysql_query("$vsql");
...
window.open('fak_setulozpau.php?cislo_dok=<?php echo $cislo_dok; ?>&udp=' + udp + '&adp=' + adp + '&uzk=' + uzk + '&azk=' + azk + '&ajo=' + ajo + '&aju=' + aju + '&copern=900', '_self' );
                }
...
?>
<td class="pvstup" width="15%" >&nbsp;⁄Ëel:</td>
...
<img src='../obr/naradie.png' onClick="nastavpaux.style.display='';" width=15 height=15 border=0 title="Nastavenie ˙Ëtovania pauö·lu 80%" ></a>
&nbsp;
Pauö·l 80%<input type="checkbox" name="pau80" nid="pau80" value="1" />
<?php                     } ?>
<?php
if( $textpopis == 1 )
     {
