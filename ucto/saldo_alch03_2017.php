<HTML>
<?php
//VYHODNOTENIE UHRAD ZA DEALEROV ALCHEM "HNOJIVA" 2017
$sys = 'UCT';
$urov = 1000;
...
//ikony JARH,JESH  hnojivá 2017
//platia èísla faktúr 3278...
//ikona JSOH – hnojivá odklad 2016, platia èísla 3268...
...
if( $h_jar == 1 )
{
$dsqlt = "DELETE FROM F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid WHERE dat < '2017-01-01' OR dat > '2017-06-30'";
$dsql = mysql_query("$dsqlt");
}
if( $h_jar == 2 )
{
$dsqlt = "DELETE FROM F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid WHERE dat < '2017-07-01' OR dat > '2017-12-31' OR das > '2018-03-31' ";
$dsql = mysql_query("$dsqlt");
}
if( $h_jar == 3 )
{

$dsqlt = "DELETE FROM F$kli_vxcf"."_prsaldoicofaknesp$kli_uzid WHERE dat < '2016-01-01' OR dat > '2016-12-31' OR das <= '2017-01-31' ";
$dsql = mysql_query("$dsqlt");
}
...
if( $h_jar == 1 ) { $pdf->Cell(90,5,"Vyhodnotenie predaja HNOJÍV za dealerov - JAR 2017","0",0,"L"); }
if( $h_jar == 2 ) { $pdf->Cell(90,5,"Vyhodnotenie predaja HNOJÍV za dealerov - JESEÒ 2017","0",0,"L"); }
if( $h_jar == 3 ) { $pdf->Cell(90,5,"Vyhodnotenie predaja HNOJÍV za dealerov - JESEÒ 2016 odkladové","0",0,"L"); }
