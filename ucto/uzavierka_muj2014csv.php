...
<div id="wrap-heading">
 <table id="heading">
  ...
  <tr>
   <td class="header">Uz·vierka MUJ / Export CSV <span class="subheader"></span></td>
   <td></td>
  </tr>
 </table>
</div>
...
<div id="content">
<?php if ( $elsubor == 2 ) { ?>
<p>Stiahnite si niûöie uveden˝ s˙bor <strong><?php echo $nazsub; ?></strong> do V·öho poËÌtaËa s n·zvom UZ_MUJ.csv a naËÌtajte ho na
<a href="https://www.rissam.sk/vpn/rissam.html" target="_blank" title="Str·nka RIS pre Samospr·vu">RIS pre Samospr·vu</a>.
<br />
K naËÌtaniu MUJ uz·vierky vo form·te CSV na RISSAM budete eöte potrebovaù Pozn·mky MUJ vo form·te PDF a ⁄vodn˙ stranu uz·vierky MUJ vo form·te PDF.
</p>
<p>
