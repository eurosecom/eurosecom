...
<?php if( $fir_fico == 31416853  ) { ?>
window.open('../ucto/saldo_ramex06.php?h_deal=0&h_uce=' + h_uce + '&h_ico=' + h_ico + '&h_obd=' + h_obd + '&copern=11&drupoh=1&page=1&analyzy=<?php echo $analyzy; ?>',
 '_blank', 'width=1080, height=900, top=0, left=10, status=yes, resizable=yes, scrollbars=yes' );
<?php                              } ?>
...
PO30<img src='../obr/tlac.png' onClick="Pol30();" width=15 height=15 border=0 title='Pohæad·vky tohtoroËnÈ 30 dnÌ po lehote' >
...
<a href="#" onclick="Rucnespar();">RuËnÈ sp·rovanie</a>
<a href="#" onclick="OdberPoc();">OdberateæskÈ fakt˙ry poË.stav</a>
<a href="#" onclick="DodavPoc();">Dod·vateæskÈ fakt˙ry poË.stav</a>
<a href="#" onclick="UhradyPoc();">⁄hrady poË.stav</a>
...
<script>
  function Rucnespar()
  {
    window.open("../ucto/saldo_md.php?copern=1&drupoh=1&page=1&sysx=UCT&typhtml=1&cinnost=9","_blank",'<?php echo $parwin; ?>');
  }

  function OdberPoc()
  {
    window.open('../faktury/vstfak.php?copern=1&drupoh=1001&page=1&pocstav=1', '_blank');
  }
  function DodavPoc()
  {
    window.open('../faktury/vstfak.php?copern=1&drupoh=1002&page=1&pocstav=1', '_blank');
  }
  function UhradyPoc()
  {
    window.open('../ucto/oprsys.php?copern=308&drupoh=8', '_blank');
  }
</script>
</BODY>
</HTML>
