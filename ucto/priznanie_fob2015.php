...
if ( !confirm ("Chcete naËÌtaù ˙daje do FOB z firmy minulÈho roka ?") )
         ...
         { location.href='priznanie_fob2015.php?copern=3156&page=1&drupoh=1&cislo_oc=<?php echo $cislo_oc; ?>' }
</script>
<?php                  }
...
" rr63='$rr63', r64='$r64', r65='$r65', r66='$r66', r67='$r67', r68='$r68', r69='$r69', r70='$r70', r71='$r71', r72='$r72'  ".
" WHERE oc = $cislo_oc";
                    }
...
$uprtxt = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET ".
" r73='$r73', r74='$r74', r75='$r75', r76='$r76', r77='$r77', r78='$r78', r79='$r79', r80='$r80', r81='$r81', r82='$r82', r83='$r83', ".
" r84='$r84', r85='$r85', r86='$r86', r87='$r87', r88='$r88', r89='$r89', r90='$r90', r91='$r91', r92='$r92', r93='$r93', r94='$r94', r95='$r95', r96='$r96', r97='$r97'   ".
" WHERE oc = $cislo_oc";
                    }
...
$uprtxt = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET ".
" r98='$r98', r99='$r99', r100='$r100', r101='$r101', r102='$r102', r103='$r103', ".
...
$uprtxt = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET ".
" r111='$r111', r112='$r112', r113='$r113', r114='$r114', r115='$r115', r116='$r116', r117='$r117', r118='$r118', ".
" sdnr='$sdnr', ldnr='$ldnr', nrzsprev='$nrzsprev', upl50='$upl50', spl3d='$spl3d', r121='$r121', ".
...
//vsetky vypocty su upravene na rok 2014
//vypocty
//odstavene vypocty
//$prepocitaj=0;
$alertprepocet="";
...
//zaklady dane zo zav.cinnosti 2014 str2
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r36=r34-r35 WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");

//prijmy,vydavky z tabulky 1.(na str3) 2014
...
//prijmy,vydavky z tabulky 1.(na str4) 2014
...
//prijmy,vydavky z tabulky 2.(na str 5) 2014
...
//prijmy,vydavky z tabulky 3.(na str6) 2014
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r53=t2p11, r54=t2v11, r55=0 WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");
...
//odpocet danovej straty (str 7) 2014
...
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r64=r60+r61+r62+r63 WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");

//vypocet zakladu dane str7 2014
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r66=0, r67=0, r68=0, r69=0, r71=0  WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r66=r43  WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r67=r59+r65  WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r67=r66  WHERE oc = $cislo_oc AND r67 > r66";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r68=r66-r67  WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r69=r52-r55+r58 WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r70=r59 WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r70=r69  WHERE oc = $cislo_oc AND r70 > r69";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r71=r69-r70  WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");

//zaklad dane  a odpocitatelne (str 8) 2014 vypocitaj odpocitatelnu na danovnika a manzelku na kliknutie ( milionarska dan)
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r73=r36+r68  WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");
...
//max.nezdanitelna cast na danovnika za 2014
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET des6=0, des2=0 WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r74=3803.33 WHERE oc = $cislo_oc  ";
$oznac = mysql_query("$sqtoz");

//milionarska dan 2014
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET des6=8755.578-(r73/4) WHERE oc = $cislo_oc AND r73 > 19809.00 ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob".
" SET des2=des6*100, des2=ceil(des2), r73=des2/100  WHERE oc = $cislo_oc AND r73 > 19809.00 ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r74=0 WHERE oc = $cislo_oc AND r74 < 0 ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r74=0 WHERE oc = $cislo_oc AND r73 >= 35022.32 ";
$oznac = mysql_query("$sqtoz");
     }
//koniec max.nezdanitelna cast na danovnika za 2014
...
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET des6=0, des2=0 WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r75=3803.33-mpri WHERE oc = $cislo_oc AND r73 <= 35022.32 ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET des6=12558.906-(r73/4) WHERE oc = $cislo_oc AND r73 > 35022.32 ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob".
" SET des2=des6*100, des2=ceil(des2), r75=des2/100  WHERE oc = $cislo_oc AND r73 > 35022.32 ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r75=0 WHERE oc = $cislo_oc AND r75 < 0 ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r75=0 WHERE oc = $cislo_oc AND r73 >= 50235.63 ";
$oznac = mysql_query("$sqtoz");
     }

//vypocet zakladu dane (str 8) 2014
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r78=r74+r75+r76+r77  WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r78=r73  WHERE oc = $cislo_oc AND r78 > r73 ";
$oznac = mysql_query("$sqtoz");

$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r79=r73-r78 WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");

$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r79=0 WHERE oc = $cislo_oc AND r79 < 0 ";
$oznac = mysql_query("$sqtoz");

$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r80=r79+r71+r72 WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");

$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET r80=0 WHERE oc = $cislo_oc AND r80 < 0 ";
$oznac = mysql_query("$sqtoz");

//dan z prijmu 2014 posun o 2 r oproti 2013
$sqtoz = "UPDATE F$kli_vxcf"."_mzdpriznanie_fob SET des6=0, des2=0 WHERE oc = $cislo_oc ";
$oznac = mysql_query("$sqtoz");
...
//dan po vynati prijmov 2014 dan zo zakladu na r83 nepocitam
...
//dan po vynati prijmov a zapocte 2014
...
//Z ciarky na bodku
 ...
 '_blank', 'width=1080, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes');
  ...
  function vypocetOP()
  {
   window.open('priznanie_fob2015.php?copern=20&strana=<?php echo $strana; ?>&miliondan=1', '_self');
  }
  function namanzelku()
  {
   window.open('priznanie_fob2015.php?copern=20&strana=<?php echo $strana; ?>&namanzelku=1', '_self');
  }
  function NacitajVHpredDanou()
  {
   window.open('../ucto/priznanie_fob2015.php?strana=3&copern=200&drupoh=1&page=1&typ=PDF&dppo=1', '_self');
  }
  function UpravFO()
  {
...
<div id="content">
<FORM name="formv1" method="post" action="priznanie_fob2015.php?copern=23&cislo_oc=<?php echo $cislo_oc;?>&strana=<?php echo $strana;?>">
<?php
...
<div class="navbar">
 ...
 <a href="#" onclick="window.open('<?php echo $source; ?>&copern=10&strana=13', '_blank');"
    class="<?php echo $clas13; ?> toright">P2</a>
 <a href="#" onclick="window.open('<?php echo $source; ?>&copern=10&strana=12', '_blank');"
    class="<?php echo $clas12; ?> toright">P1</a>
...
<input type="text" name="r34" id="r34" onkeyup="CiarkaNaBodku(this);"
       style="width:242px; top:1031px; left:501px;"/>
<input type="text" name="r34a" id="r34a" onkeyup="CiarkaNaBodku(this);"
       style="width:242px; top:1071px; left:501px;"/>
<input type="text" name="r35" id="r35" onkeyup="CiarkaNaBodku(this);"
       style="width:175px; top:1110px; left:568px;"/>
<input type="text" name="r36" id="r36" onkeyup="CiarkaNaBodku(this);"
       style="width:242px; top:1150px; left:501px;"/>
<?php                     } ?>
...
<input type="text" name="r39pu" id="r39pu" onkeyup="CiarkaNaBodku(this);" style="width:130px; top:807px; left:762px;"/> <!-- dopyt, asi zruöiù -->
<input type="text" name="r40pu" id="r40pu" onkeyup="CiarkaNaBodku(this);" style="width:130px; top:847px; left:762px;"/> <!-- dopyt, asi zruöiù -->

 <img src="../obr/ikony/info_blue_icon.png" 
  title="Ak FO vedie podvojnÈ ˙ËtovnÌctvo vyplnÌ ZISK v tejto poloûke, nie v riadku 37,38,39,40 a tabuæku Ë. 1 v VI. oddiely na strane 3. nevypÂÚa." class="btn-row-tool"
  style="top:807px; left:910px;"> <!-- dopyt, asi zruöiù -->

 <img src="../obr/ikony/info_blue_icon.png" 
  title="Ak FO vedie podvojnÈ ˙ËtovnÌctvo vyplnÌ STRATU v tejto poloûke, nie v riadku 37,38,39,40 a tabuæku Ë. 1 v VI. oddiely na strane 3. nevypÂÚa." class="btn-row-tool"
  style="top:847px; left:910px;"> <!-- dopyt, asi zruöiù -->

<input type="text" name="r41" id="r41" onkeyup="CiarkaNaBodku(this);" style="width:243px; top:880px; left:500px;"/>
...
<!-- VI. ODDIEL pokracovanie -->
<input type="text" name="r49" id="r49" onkeyup="CiarkaNaBodku(this);" style="width:243px; top:115px; left:507px;"/> <!-- dopyt, oöetriù -->
<input type="text" name="r50" id="r50" onkeyup="CiarkaNaBodku(this);" style="width:80px; top:155px; left:381px;"/> <!-- dopyt, bez desatinnej -->
<input type="text" name="r51" id="r51" onkeyup="CiarkaNaBodku(this);" style="width:80px; top:196px; left:381px;"/> <!-- dopyt, bez desatinnej -->
<input type="text" name="r52" id="r52" onkeyup="CiarkaNaBodku(this);" style="width:80px; top:235px; left:381px;"/> <!-- dopyt, bez desatinnej -->
<input type="text" name="r53" id="r53" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:277px; left:506px;"/> <!-- dopyt, oöetriù -->
<input type="text" name="r54" id="r54" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:317px; left:506px;"/> <!-- dopyt, oöetriù -->
<input type="text" name="r55" id="r55" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:392px; left:506px;"/> <!-- dopyt, oöetriù -->
<input type="text" name="r56" id="r56" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:466px; left:506px;"/> <!-- dopyt, oöetriù -->
<input type="text" name="r57" id="r57" onkeyup="CiarkaNaBodku(this);" style="width:243px; top:512px; left:506px;"/> <!-- dopyt, oöetriù -->

<input type="text" name="r58" id="r58" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:564px; left:506px;"/> <!-- dopyt, oöetriù -->
<input type="text" name="r59" id="r59" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:603px; left:506px;"/> <!-- dopyt, oöetriù -->
<input type="text" name="r60" id="r60" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:643px; left:506px;"/> <!-- dopyt, oöetriù -->
<input type="text" name="r61" id="r61" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:681px; left:506px;"/> <!-- dopyt, oöetriù -->
<input type="text" name="r62" id="r62" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:721px; left:506px;"/> <!-- dopyt, oöetriù -->
<input type="text" name="r63" id="r63" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:769px; left:506px;"/> <!-- dopyt, oöetriù -->
<input type="text" name="r64" id="r64" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:814px; left:506px;"/> <!-- dopyt, oöetriù -->
<input type="text" name="r65" id="r65" onkeyup="CiarkaNaBodku(this);" style="width:244px; top:876px; left:506px;"/> <!-- dopyt, oöetriù -->
...
<!-- VII. ODDIEL tabulka 2 pokracovanie -->
...
<!-- VIII. ODDIEL tabulka 3 pokracovanie -->
...
<input type="text" name="t3v13" id="t3v13" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:570px; left:661px;"/> <!-- dopyt, novÈ -->
<input type="text" name="t3p14" id="t3p14" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:613px; left:411px;"/>
<input type="text" name="t3v14" id="t3v14" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:1998px; left:661px;"/> <!-- dopyt, zruöiù -->
<input type="text" name="t3p15" id="t3p15" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:658px; left:411px;"/> <!-- dopyt, novÈ -->
<input type="text" name="t3v15" id="t3v15" onkeyup="CiarkaNaBodku(this);" style="width:232px; top:658px; left:661px;"/> <!-- dopyt, novÈ -->
...
<input type="text" name="r119" id="r119" onkeyup="CiarkaNaBodku(this);" style="width:245px; top:589px; left:648px;"/> <!-- dopyt, novÈ -->
<input type="text" name="r120" id="r120" onkeyup="CiarkaNaBodku(this);" style="width:245px; top:626px; left:648px;"/> <!-- dopyt, novÈ -->
...
<input type="checkbox" name="zslu" value="1" style="top:1183px; left:59px;"/> <!-- dopyt, novinka -->
<?php                      } ?>
...
<input type="text" name="dat" id="dat" onkeyup="CiarkaNaBodku(this);" style="width:195px; top:905px; left:277px;"/> <!-- dopyt, nemalo by predplÚaù aktu·lny d·tum -->
...
<!-- PRILOHA 1 -->
<!-- dopyt, cel· strana novinky -->
<input type="text" name="" id="" style="width:35px; top:166px; left:268px;"/>
<input type="text" name="" id="" style="width:35px; top:166px; left:337px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:196px; top:166px; left:697px;"/>

<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:196px; top:254px; left:72px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:196px; top:293px; left:72px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:289px; top:254px; left:293px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:289px; top:254px; left:604px;"/>

<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:196px; top:333px; left:72px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:196px; top:370px; left:72px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:289px; top:333px; left:293px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:289px; top:333px; left:604px;"/>

<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:196px; top:410px; left:72px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:196px; top:448px; left:72px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:289px; top:410px; left:293px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:289px; top:410px; left:604px;"/>

<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:196px; top:488px; left:72px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:196px; top:526px; left:72px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:289px; top:488px; left:293px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:289px; top:488px; left:604px;"/>

<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:196px; top:566px; left:72px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:196px; top:604px; left:72px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:289px; top:566px; left:293px;"/>
<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:289px; top:566px; left:604px;"/>

<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:289px; top:644px; left:604px;"/>

<textarea name="" id="" style="width:838px; height:400px; top:700px; left:53px;"></textarea>

<input type="text" name="" id="" onkeyup="CiarkaNaBodku(this);" style="width:289px; top:1149px; left:604px;"/>
<?php                      } ?>


<?php if ( $strana == 13 ) { ?>
<img src="../dokumenty/dan_z_prijmov2015/dpfob2015/dpfob_v15_str13.jpg"
     alt="tlaËivo DaÚ z prÌjmov FO typ B pre rok 2015 13.strana 282kB" class="form-background">
<span class="text-echo" style="top:74px; left:401px;"><?php echo $fir_fdic; ?></span>
...
$t02=substr($text,1,1);
$pdf->SetY(187);
$pdf->Cell(78,6," ","$rmc1",0,"R");$pdf->Cell(4,6,"$t01","$rmc",0,"C");$pdf->Cell(1,6," ","$rmc",0,"C");$pdf->Cell(4,6,"$t02","$rmc",1,"L");
//riadok 2
$pdf->Cell(190,4," ","$rmc1",1,"L");
...
if ( $hodx == 0 ) $hodx=""; //dopyta, m· v˝znam?
$text=sprintf("% 10s",$hodx);
$t01=substr($text,0,1);
$t02=substr($text,1,1);
$t03=substr($text,2,1);
...
$pdf->Cell(84,4," ","$rmc1",0,"R");$pdf->Cell(3,5,"$text","$rmc",0,"C");
...
$pdf->Cell(5,5," ","$rmc1",0,"R");$pdf->Cell(5,4,"$text1","$rmc",1,"R");
