...
$sqltt = "SELECT * FROM ".$databaza."F$cfirmy"."_poznamky_no2011texty WHERE psys >= 0 ORDER BY ozntxt";
$sql = mysql_query("$sqltt");

if( $sql ) { $cpol = 1*mysql_num_rows($sql); }

if( $cpol == 0 )
  {
$sqltt = "SELECT * FROM ".$databaza."F$cfirmy"."_poznamky_po2011texty WHERE psys >= 0 ORDER BY ozntxt";
$sql = mysql_query("$sqltt");
  }
