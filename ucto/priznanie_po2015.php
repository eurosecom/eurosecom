  ...
  <tr>
   ...
   <td>
    <div class="bar-btn-form-tool">
     ...
     <img src="../obr/ikony/upbox_blue_icon.png" onclick="POdoXML();" title="Export do XML" class="btn-form-tool"> <!-- dopyt, nie je funkËnÈ -->
...
<input type="text" name="r920" id="r920" onkeyup="CiarkaNaBodku(this);" style="width:289px; top:177px; left:529px;"/>
 ...
 <img src="../obr/ikony/calculator_blue_icon.png" onclick="LicenciaTabK();"
      title="Kladn˝ rozdiel medzi daÚovou licenciou a daÚou z predch. obdobÌ z r.5 stÂpec 4. tabuæky K na 9.strane"
