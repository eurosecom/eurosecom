...
//zmena filozofie = nech·m oznaËenie nahl·senia
   ...
   <td>
    <div class="bar-btn-form-tool">
     <img src="../obr/ikony/floppy_blue_icon.png" onclick="doZIP();"
          title="Uloûiù hl·senia do ZIP" class="btn-form-tool">
     <img src="../obr/ikony/file12_blue_x32.png" onclick="doCSV();"
          title="Vytvoriù hl·senia v CSV" class="btn-form-tool">
...
onclick="pridajHla(<?php echo $rsluz->ico; ?>);" title="Pridaù do hl·senia" style="position:relative; top:1px;">&nbsp;<?php echo $ico_nai; ?>
 </td>
...
//urob jedno pdf
$ico_naibez = StrTr($ico_nai, "·‰ËÔÈÏÎÌæÚÙÛˆ‡¯öù˙˘¸˝û¡ƒ»œ…ÃÀÕº“”÷‘ÿ¿äç⁄Ÿ‹›é",
...
$ico_naib = StrTr($ico_nai, "·‰ËÔÈÏÎÌæÚÙÛˆ‡¯öù˙˘¸˝û¡ƒ»œ…ÃÀÕº“”÷‘ÿ¿äç⁄Ÿ‹›é","aacdeeeilnooorrstuuuyzAACDEEELINOOORRSTUUUYZ");
