...
//CisloSlovom ("1 234 567,890", true, "-", "Mužský") 
...
<tr>
<td>
<?php if( $zandroidu == 0 ) { echo "EuroSecom  -  Doklad <?php echo $cislo_dok;?> PDF formát"; } ?> 
<?php if( $zandroidu == 1 ) { echo "Doklad PDF prebraný, tlaèidlo Spä - do zoznamu dokladov"; } ?> 
</td>
...
$pdf->Cell(65,6,"P R Í J M O V Ý pokladnièný doklad: ","0",0,"L");$pdf->Cell(20,6,"$riadok->dok ","0",0,"L");$pdf->Cell(5,6,"  ","0",0,"L"); 
$pdf->Cell(45,6,"Zo dòa: $dat_sk      Pokladnica: $riadok->uce  ","0",1,"L"); 

$pdf->Cell(90,2," ","0",1,"L");

$pdf->Cell(90,6,"Príjemca:","LRTB",0,"L");$pdf->Cell(90,6,"Plátca: ","LRTB",1,"L"); 
}
if ( $drupoh == 2 )
{ 
$pdf->Cell(90,2," ","0",1,"L");

$pdf->Cell(65,6,"V Ý D A V K O V Ý pokladnièný doklad: ","0",0,"L");$pdf->Cell(20,6,"$riadok->dok ","0",0,"L");$pdf->Cell(5,6,"  ","0",0,"L"); 
$pdf->Cell(45,6,"Zo dòa: $dat_sk      Pokladnica: $riadok->uce  ","0",1,"L"); 

$pdf->Cell(90,2," ","0",1,"L");

$pdf->Cell(90,6,"Plátca:","LRTB",0,"L");$pdf->Cell(90,6,"Príjemca:","LRTB",1,"L"); 
}
...
$pdf->Cell(65,6,"B A N K O V Ý výpis: ","1",0,"L");$pdf->Cell(25,6,"$riadok->dok ","1",0,"L"); 
$pdf->Cell(0,6,"Zo dòa: $dat_sk      Banka: $riadok->uce  ","1",1,"L"); 

$pdf->Cell(128,5,"Úèel : $riadok->txp","0",0,"L");$pdf->Cell(50,5,"UNIkód: $riadok->unkd","0",1,"L");
$pdf->Cell(90,2," ","0",1,"L");
...
$pdf->Cell(25,5,"FAK","1",0,"L");$pdf->Cell(25,5,"IÈO","1",0,"L");$pdf->Cell(15,5,"STR","1",0,"L");$pdf->Cell(20,5,"ZÁK","1",0,"L");
...
$ucd="UCD";
$pdf->Cell(0,2," ","B",1,"L");
$pdf->Cell(20,5,"Dátum","1",0,"L");$pdf->Cell(20,5,"$ucm","1",0,"L");$pdf->Cell(20,5,"$ucd","1",0,"L");$pdf->Cell(10,5,"RDP","1",0,"L");
$pdf->Cell(25,5,"FAK","1",0,"L");$pdf->Cell(20,5,"IÈO","1",0,"L");$pdf->Cell(15,5,"STR","1",0,"L");$pdf->Cell(20,5,"ZÁK","1",0,"L");
$pdf->Cell(0,5,"Hodnota    ","1",1,"R");
...
$pdf->Cell(65,6,"V Š E O B E C N Ý interný doklad: ","1",0,"L");$pdf->Cell(25,6,"$riadok->dok ","1",0,"L"); 
$pdf->Cell(0,6,"Zo dòa: $dat_sk        ","1",1,"L"); 
...
{ 
$pdf->Cell(90,5,"IÈO: $fir_fico","LR",0,"L");$pdf->Cell(90,5,"IÈO: $riadok->icod","LR",1,"L");
...
$pdf->Cell(90,5,"DIÈ: $fir_fdic IÈDPH: $fir_ficd","LR",0,"L");$pdf->Cell(90,5,"DIÈ: $riadok->dic IÈDPH: $riadok->icd","LR",1,"L");
$pdf->Cell(90,5,"Registrovaný: $fir_obreg ","LRB",0,"L");

if ( $drupoh == 1 ) { $pdf->Cell(90,5,"Prijaté od: $riadok->kto","LRB",1,"L"); }
if ( $drupoh == 2 ) { $pdf->Cell(90,5,"Vyplatené komu: $riadok->kto","LRB",1,"L"); }
if ( $drupoh == 3 ) { $pdf->Cell(90,5,"Prijaté od: $riadok->kto","LRB",1,"L"); }
$pdf->Cell(90,2," ","0",1,"L");

if ( $riadok->zmend == 1 ) { 

$pdf->Cell(130,5,"Doklad zaplatený v cudzej mene kurz $riadok->kurzd $riadok->menad /1Eur  ","0",0,"L");
$pdf->Cell(50,5,"$riadok->hodmd $riadok->menad ","0",1,"R");
$pdf->Cell(90,2," ","0",1,"L");
                            }


$pdf->Cell(130,5,"Úèel platby: $riadok->txp","0",0,"L");$pdf->Cell(50,5,"UNIkód: $riadok->unkd","0",1,"L");
$pdf->Cell(90,2," ","0",1,"L");

$ucm="UCM";
$ucd="UCD";
if( $kli_vduj == 9 AND $drupoh == 2 ) { $ucm="Druh výdavku"; $ucd="Pokladnica è."; } 
if( $kli_vduj == 9 AND $drupoh == 1 ) { $ucd="Druh príjmu"; $ucm="Pokladnica è."; } 
...
if( $rozpkls > 0 ) { $pdf->SetFont('arial','',7); $pdf->Cell(30,2,"Rozpoètová klasifikácia $rozpkls","0",1,"L"); $pdf->SetFont('arial','',9);  }
   }
                        }
}
if ( $drupoh == 4 AND $fir_allx15 == 1 )
...
$pdf->Cell(90,5,"Rozúètovanie dokladu - Rozpis DPH","LT",0,"L");$pdf->Cell(15,5,"%DPH","T",0,"R");
$pdf->Cell(25,5,"Základ","T",0,"R");$pdf->Cell(25,5,"Daò","T",0,"R");$pdf->Cell(25,5,"Spolu","RT",1,"R");
if( $riadok->zk0u != 0 ) {
...
$pdf->Cell(90,5,"Celkom súèet za doklad","T",0,"L");$pdf->Cell(90,5,"$riadok->hod","T",1,"R");
...
$znamienko="";
if( $hodnota < 0 ) { $minusove=1; $sCelkomslovo=-$sCelkom; $sCelkomslovo=sprintf("%0.2f", $sCelkomslovo); $znamienko="mínus"; }


$sSlovom=CisloSlovom ($sCelkomslovo, false, " ", "Zensky");

$pdf->SetFont('arial','',10);
$pdf->Cell(150,6,"Celkom zaplatené (slovom): $znamienko $sSlovom $com1p $mena1 ","1",0,"L");
$pdf->Cell(30,6,"$sCelkom $mena1","1",1,"R");

if( $ajprepocetnask == 1 )
   {
$pdf->SetFont('arial','',9);
$pdf->Cell(150,6,"Info prepoèet na $mena2 konverzným kurzom $kurz12 Sk/Eur","1",0,"L");
