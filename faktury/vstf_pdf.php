...
$fakturadanovy="F  A  K  T  ⁄  R  A   -   DaÚov˝ doklad ";
$cislofak="»Ìslo:";
$dodavatel="Dod·vateæ";
$odberatel="Odberateæ";
$ico="I»O:";
$dic="DI»:";
$icdph="I» DPH:";
$registrovany="Registrovan˝";
$fakprevzal="Fakt˙ru prevzal (meno,»OP,podpis)"; 
$bankovespojenie="BankovÈ spojenie dod·vateæa:";
$odberne="OdbernÈ miesto:";
$vyhotovena="D·tum vyhotovenia: ";
$variabilny="Variabiln˝ symbol: ";
$dodane="D·tum dodania: ";
if( $drupoh == 2 ) { $dodane="D·tum dodania - odpoËtu: "; }
$konstantny="Konötantn˝ symbol: ";
$splatna="D·tum splatnosti: ";
$specificky="äpecifick˝ symbol: ";
$objednavkauni="Objedn·vka - UNIkÛd: ";
$dodacipredfak="Dod.list - Predfakt˙ra: ";
$strzakdok="STR - Z¡K - Doklad: ";
$doprava="Doprava: ";
$polozka="Poloûka"; 
$sadzbadph="DPH";
...
$vystavil="Vystavil(a):";
$cenapoloziek="ceny poloûiek v ";
$kurz="kurz";
$celkomvmene="Celkom hodnota"; 

if( $jazyk == 1 )
{
$fakturadanovy="Fakt˙ra / Rechnung";
$cislofak="»Ìslo / Nr.:";
$dodavatel="Dod·vateæ / Lieferant";
$odberatel="Odberateæ / Abnehmer";
$ico="I»O / ID-Nr:";
$dic="DI»";
$icdph="I»DPH/UStID:";
$registrovany="Registrovan˝ / Handelregister/Gewerbenummer";
$fakprevzal="";
$bankovespojenie="BankovÈ spojenie dod·vateæa / Lieferant - Bank:";
$odberne="OdbernÈ miesto / Entnahmestelle:";
$vyhotovena="D.vystav. / Ausstellungsdat.:";
$variabilny="Var. symbol / Variabelsym.:";
$dodane="D.dodania / Leistungsdat.:";
$konstantny="Konö. symbol / Konst. Sym.:";
$splatna="D.splatnosti / F‰lligkeitsdat.:";
$specificky="äpec. symbol / Spec.Sym.:";
$objednavkauni="Objedn·vka / Bestellung:";
$dodacipredfak="DodacÌ-Predf./Lieferschein.:";
$strzakdok="STR - Z¡K - Doklad:";
...
$celkomhodnota="Spolu na ˙hradu / Gesamt zahlungsbetrag";
...
if( $jazyk == 2 )
{
$fakturadanovy="Fakt˙ra / Invoice";
$cislofak="»Ìslo / No.";
$dodavatel="Dod·vateæ / Supplier";
$odberatel="Odberateæ / Customer";
$ico="I»O / ID #";
$dic="DI»";
$icdph="I»DPH/VAT No.";
$registrovany="Registrovan˝ / Register";
$fakprevzal="";
$bankovespojenie="BankovÈ spojenie dod·vateæa / Supplier - Bank contact:";
$odberne="OdbernÈ miesto / Place of delivery:";
$vyhotovena="D.vystav. / Issue date:";
$variabilny="Var. sym. / Var. symbol:";
$dodane="D.dodania / Shipment date:";
$konstantny="Konö.sym. / Const. symbol:";
$splatna="D.splatnosti / Due date:";
$specificky="äpec.symbol/Spec.Sym.:";
$objednavkauni="Objedn·vka / Order No.:";
$dodacipredfak="DodacÌ-Predf/Bill of delivery:";
$strzakdok="STR - Z¡K - Doklad:";
...
$rozpisdph="Rozpis DPH";
$percentodph="%DPH / %VAT";
$zakladdph="Z·klad/Tax basis";
$sumadph="DaÚ / VAT";
$spolusdph="Spolu / Total";
$celkomhodnota="Spolu na ˙hradu / TOTAL PAYABLE";
...
$pdf->Cell(90,6,"DODACÕ LIST  -  Nie je daÚov˝ doklad","1",0,"L");$pdf->Cell(45,6,"»Ìslo:","1",0,"R");$pdf->Cell(45,6,"$dodacicislo ","1",1,"L");
...
if( $drupoh == 21 OR $drupoh == 22 )
  {
$pdf->Cell(120,6,"VN⁄TROPODNIKOV¡ FAKT⁄RA  -  Nie je daÚov˝ doklad","1",0,"L");$pdf->Cell(30,6,"»Ìslo:","1",0,"R");$pdf->Cell(30,6,"$hlavicka->fak ","1",1,"L");
...
$pdf->Cell(90,6,"PREDFAKT⁄RA  -  Nie je daÚov˝ doklad","1",0,"L");$pdf->Cell(45,6,"»Ìslo:","1",0,"R");$pdf->Cell(45,6,"$prfcislo ","1",1,"L");

$fakprevzal="PredFakt˙ru prevzal(meno,»OP,podpis)";
  }
...
if( $hlavicka->ico == 31355161 ) { $nazov2r="STRABAG PozemnÈ a inûinierske staviteæstvo s.r.o."; }
...
if( $fir_fsw1 == '' ) { $pdf->Cell(180,4,"IBAN: $fir_fib1 ˙Ëet: $fir_fuc1 / $fir_fnm1 $fir_fnb1","0",1,"L"); }
if( $fir_fsw1 != '' AND $jazyk == 0 ) { $pdf->Cell(180,4,"IBAN: $fir_fib1 SWIFT: $fir_fsw1 ˙Ëet: $fir_fuc1 / $fir_fnm1 $fir_fnb1 ","0",1,"L"); }
...
if( $fir_fsw2 == '' ) { $pdf->Cell(180,4,"IBAN: $fir_fib2 ˙Ëet: $fir_fuc2 / $fir_fnm2 $fir_fnb2","0",1,"L"); }
if( $fir_fsw2 != '' AND $jazyk == 0 ) { $pdf->Cell(180,4,"IBAN: $fir_fib2 SWIFT: $fir_fsw2 ˙Ëet: $fir_fuc2 / $fir_fnm2 $fir_fnb2","0",1,"L"); }
...
if( $fir_fsw3 == '' ) { $pdf->Cell(180,4,"IBAN: $fir_fib3 ˙Ëet: $fir_fuc3 / $fir_fnm3 $fir_fnb3","0",1,"L"); }
if( $fir_fsw3 != '' AND $jazyk == 0 ) { $pdf->Cell(180,4,"IBAN: $fir_fib3 SWIFT: $fir_fsw3 ˙Ëet: $fir_fuc3 / $fir_fnm3 $fir_fnb3","0",1,"L"); }
...
$pdf->Cell(90,6,"I»O: $fir_fico","0",1,"R");

$registtext="Registrovan˝: ".$fir_obreg;
$dlzkareg=strlen($registtext);
if( $dlzkareg > 40 ) { $pdf->SetFont('arial','',8); }
if( $dlzkareg > 45 ) { $pdf->SetFont('arial','',7); }
$pdf->Cell(90,6,"$registtext","0",0,"L");
$pdf->SetFont('arial','',10);
$pdf->Cell(90,6,"DI»: $fir_fdic, I»DPH: $fir_ficd","0",1,"R");
  }

$pdf->Cell(90,6,"⁄ Ë t o v n ˝  d o k l a d ","1",0,"L");$pdf->Cell(45,6,"»Ìslo:","1",0,"R");$pdf->Cell(45,6,"$hlavicka->dok ","1",1,"L");
$pdf->Cell(180,3,"     ","0",1,"L");
$pdf->Cell(0,6,"Odberateæ: I»O: $hlavicka->ico, $hlavicka->nai, $hlavicka->uli, $hlavicka->mes, $hlavicka->psc, iËDPH $hlavicka->icd","0",1,"L");
...
if( $mini == 0 )
          {
$pdf->Cell(90,6,"Dod·vateæsk· F  A  K  T  ⁄  R  A  ","1",0,"L");$pdf->Cell(45,6,"»Ìslo:","1",0,"R");$pdf->Cell(45,6,"$hlavicka->fak ","1",1,"L");
$pdf->Cell(180,3,"     ","0",1,"L");

$pdf->Cell(90,6,"Dod·vateæ:","1",0,"L");$pdf->Cell(90,6,"Odberateæ:","1",1,"L");
$pdf->Cell(90,6,"I»O: $hlavicka->ico","0",0,"L");$pdf->Cell(90,6,"I»O: $fir_fico ","0",1,"L");
...
$pdf->Cell(180,3,"     ","0",1,"L");
$pdf->Cell(90,4,"DI»: $hlavicka->dic I»DPH: $hlavicka->icd","0",0,"L");$pdf->Cell(90,4,"DI»: $fir_fdic I»DPH: $fir_ficd","0",1,"L");

$pdf->Line(15, 90, 195, 90); 
$pdf->SetY(92);
$pdf->Cell(180,4,"BankovÈ spojenie dod·vateæa:","0",1,"L");
$pdf->Cell(180,4,"˙Ëet: $hlavicka->uc1 / $hlavicka->nm1 IBAN: $hlavicka->ib1 ","0",1,"L");
...
$pdf->Cell(90,6,"⁄ Ë t o v n ˝  d o k l a d","1",0,"L");$pdf->Cell(45,6,"»Ìslo:","1",0,"R");$pdf->Cell(45,6,"$hlavicka->dok ","1",1,"L");
$pdf->Cell(180,3,"     ","0",1,"L");
$pdf->Cell(0,6,"Dod·vateæ: I»O: $hlavicka->ico, $hlavicka->nai, $hlavicka->uli, $hlavicka->mes, $hlavicka->psc, iËDPH $hlavicka->icd","0",1,"L");
...
if( $ajvsy == 1 AND $mini == 0 AND  $rozuct == 'ANO' ) { $variabilny="Ë.Fakt˙ry / VSY:"; $cislo_fak=$hlavicka->sz3." / ".$cislo_fak; }
...
if( $ajvsy == 1 AND $mini == 1 AND $ajopravna == 0 ) { $variabilny="Ë.Fakt˙ry / VSY:"; $cislo_fak=$hlavicka->sz3." / ".$cislo_fak; }
if( $ajvsy == 1 AND $mini == 1 AND $ajopravna == 1 ) { $variabilny="Ë.Fakt˙ry / VSY / Oprav.:"; $cislo_fak=$hlavicka->sz3." / ".$cislo_fak." / ".$hlavicka->dav; }
...
$opravna="Oprav.fakt˙ra $hlavicka->dav";
...
{
$pdf->Cell(180,1,"","B",1,"L");
$pdf->Cell(180,8,"Fakt˙rujeme V·m "," ",1,"L");
}
...
$pdf->SetFont('arial','',6);
$vcene="";
if( $hlavicka->zmen == 1 AND $hlavicka->dn2 == 0 ) { $vcene=" - ceny poloûiek v ".$hlavicka->mena; }
$pdf->Cell(180,0,"","-1",1,"L");
$pdf->Cell(72,4,"Poloûka / $vcene","0",0,"L");
...
$pdf->Cell(13,4,"Mnoûstvo /","0",0,"C");$pdf->Cell(2,4,"","0",0,"C");
...
$pdf->Cell(180,5,"PokraËovanie fakt˙ry na $stranast.strane","0",1,"L");
...
$pdf->Cell(180,5,"$stranast.strana fakt˙ry Ë. $faktura","0",1,"L");
$pdf->Cell(180,2," ","0",1,"L");
...
{ 
$rsluz->nslp=trim($rsluz->nslp)." ".trim($rsluz->pon);
$rsluz->pon="";
} 
...
$pdf->Cell(31,4,"Z·klad /","0",0,"R");$pdf->Cell(31,4,"DaÚ /","0",0,"R");$pdf->Cell(31,4,"Spolu /","0",1,"R");
...
if( $hlavicka->zao != 0 )
{
$pdf->Cell(72,5,"Zaokr˙hlenie","0",0,"L");$pdf->Cell(15,5," ","0",0,"R");
...
if( $mini == 0 AND $ajprepocetnask == 1 )
          {
$pdf->SetFont('arial','',10);
$pdf->Cell(72,5,"Info prepoËet na $mena2 konverzn˝m kurzom $kurz12 Sk/Eur","0",0,"L");$pdf->Cell(15,5," ","0",0,"R");
...
{
$pdf->SetFont('arial','',10);
$pdf->Cell(72,5,"Zaplaten· z·loha ","0",0,"L");$pdf->Cell(15,5," ","0",0,"R");
...
$pdf->SetFont('arial','B',12);
$pdf->Cell(72,5,"K ˙hrade zost·va ","0",0,"L");$pdf->Cell(15,5," ","0",0,"R");
...
$pdf->SetFont('arial','',8);
$pdf->Cell(60,2," ","0",1,"L");
$pdf->Cell(60,5,"Vy˙Ëtovanie DPH $fir_dph2% na fakt˙re $cislo_dok po odpoËÌtanÌ z·lohy","0",1,"L");
$pdf->Cell(10,5," ","0",0,"L");$pdf->Cell(30,5,"Z·klad DPH","0",0,"R");$pdf->Cell(30,5,"DaÚ","0",0,"R");$pdf->Cell(30,5,"Spolu","0",1,"R");
$pdf->Cell(10,5,"fakt˙ra","0",0,"L");$pdf->Cell(30,5,"$hlavicka->zk2","0",0,"R");$pdf->Cell(30,5,"$hlavicka->dn2","0",0,"R");$pdf->Cell(30,5,"$hlavicka->sp2","0",1,"R");
$pdf->Cell(10,5,"z·loha","0",0,"L");$pdf->Cell(30,5,"$zaklzaks","0",0,"R");$pdf->Cell(30,5,"$zakldphs","0",0,"R");$pdf->Cell(30,5,"$zaklzals","0",1,"R");
...
$pdf->Cell(148,5,"⁄Ëtovn˝ predpis dokladu $cislo_dokhl","0",1,"L");
$pdf->SetFont('arial','',10);
...
if( $jedak == 1 ) { $pdf->Cell(45,4,"ZaradenÈ do KV DPH: $dak_set","0",1,"L"); }

                                  }


$pdf->Cell(18,5,"M·Daù","1",0,"L");$pdf->Cell(18,5,"Dal","1",0,"L");
$pdf->Cell(10,5,"RDP","1",0,"L");$pdf->Cell(20,5,"I»O","1",0,"R");
$pdf->Cell(22,5,"Fakt˙ra","1",0,"R");$pdf->Cell(15,5,"STR","1",0,"R");
$pdf->Cell(20,5,"Z¡K","1",0,"R");$pdf->Cell(25,5,"Hodnota","1",1,"R");
...
if( $rozpkls > 0 ) { $pdf->SetFont('arial','',7); $pdf->Cell(30,2,"RozpoËtov· klasifik·cia $rozpkls","0",1,"L"); $pdf->SetFont('arial','',10);  }
   }
...
if( $drupoh == 1 )
  {
$pdf->Cell(30,5," ","0",1,"L");
$pdf->Cell(90,5,"Za˙Ëtoval: $hlavicka->meno $hlavicka->priezvisko","1",0,"L");
$pdf->Cell(90,5,"Schv·lil:","1",1,"L");
  }
if( $drupoh == 2 )
  {
$pdf->Cell(30,5," ","0",1,"L");
...
$pdf->Cell(60,5,"S˙hlasÌm s ˙hradou:","1",1,"L");
  }
$pdf->Cell(30,5," ","0",1,"L");
...
if( $dodaci == 1 )
  {
$pdf->SetY(260);
$pdf->Cell(84,6,"Tovar za odberateæa prevzal(meno,podpis,peËiatka):","0",0,"L");$pdf->Cell(70,6," ","B",1,"L");
  }
...
if( $podpis == 1 )
  {
$pdf->SetY(230);
if( $kli_vrok <  2019 ) { $pdf->Cell(90,5,"","0",0,"L");$pdf->Cell(53,5,"Ing.Alena KovaËiËov·, riaditeæka","T",1,"L"); }
if( $kli_vrok >= 2019 AND $kli_vxcf != 1053 ) { $pdf->Cell(90,5,"","0",0,"L");$pdf->Cell(53,5,"Mgr. Eva Volkov·, riaditeæka","T",1,"L"); }
if( $kli_vrok >= 2019 AND $kli_vxcf == 1053 ) { $pdf->Cell(90,5,"","0",0,"L");$pdf->Cell(53,5,"Ivan Tobi·ö, riaditeæ","T",1,"L"); }
  }
...
<tr>
<td>
<?php if( $zandroidu == 0 ) { echo "EuroSecom  -  Fakt˙ra <?php echo $cislo_dok;?> PDF form·t"; } ?> 
