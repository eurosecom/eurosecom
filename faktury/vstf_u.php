...
function Penpz(druh)
  ...
  mytextpenp = document.getElementById("textpenp");
    ...
    if( druh == 1 ) { var htmlpenp = "<table  class='ponuka' width='100%'><tr><td width='60%'>Text Fakt˙ry - pred poloûkami " }
    if( druh == 2 ) { var htmlpenp = "<table  class='ponuka' width='100%'><tr><td width='60%'>Text Fakt˙ry - za poloûkami " }

    htmlpenp += "<img border=0 src='../obr/ok.png' style='width:12; height:12;'";
    htmlpenp += "onClick='UlozPenpz("+ druh + ");' alt='Uloû zmeny v texte' title='Uloû zmeny v texte' > ";

    htmlpenp += " <span id='myTextElement'></span></td>";

    htmlpenp += "<td width='40%' align='right'>";
    htmlpenp += " text <img border=0 src='../obr/zoznam.png' style='width:12; height:12;' onClick='DajText("+ druh + ");' title='Vybraù text z ponuky' > &nbsp&nbsp&nbsp&nbsp";
    htmlpenp += "&nbsp&nbsp<img border=0 src='../obr/zmazuplne.png' style='width:12; height:12;'onClick='ZhasniPenpz();' title='Zhasni okno a neuloû zmeny v texte' ></td></tr>";  
...
<?php if( $drupoh != 2 ) { ?>
<tr><td class="pvstup" >&nbsp;D·tum dodania:</td><td class="hvstup"><?php echo $riadok->daz; ?></td></tr>
<?php                    } ?>
<?php if( $drupoh == 2 ) { ?>
<tr><td class="pvstup" >&nbsp;D·tum dodania - odpoËtu:</td><td class="hvstup"><?php echo SkDatum($riadok->sz4); ?> - <?php echo $riadok->daz; ?></td></tr>
<?php                    } ?>
...
?>
<td class="pvstup">
<img src='../obr/icon_calendar.png' onClick="nastavdakx.style.display=''; volajDakset(<?php echo $kli_uzid;?>);" width=15 height=15 border=0 title="D·tum zaradenia do KV DPH, ak je in˝ ako d·tum odpoËtu" ></a>
<?php echo $textdak; ?>
</td>
<?php
     }
...
if ( $copern == 7 AND $drupoh == 1 AND $sysx != 'UCT' )
     {
?>
<img src='../obr/uprav.png' width=12 height=12 border=1 onClick="Penpz(1)" title="Upraviù text pred poloûkami fakt˙ry" >
<?php
     }
?>
...
<?php                        } ?>
<?php if( $textnadpol == 1 ) { ?>
<td class="bmenu" colspan="2" >Text nad poloûkou:<td class="bmenu" colspan="9" ><input type="text" name="h_pon" id="h_pon" size="80" maxlength="80" ></td></tr><tr>
<?php                        } ?>
<?php                                                         } ?>
...
&nbsp&nbsp&nbsp
<img src='../obr/naradie.png' onClick="nastavfakx.style.display=''; volajFakset(<?php echo $kli_uzid;?>);" width=15 height=15 border=0 title="Nastaviù parametre fakt˙ry" ></a>
&nbsp&nbsp&nbsp
...
if ( $copern == 7 AND $drupoh == 1 AND $sysx != 'UCT' )
     {
?>
<img src='../obr/uprav.png' width=12 height=12 border=1 onClick="Penpz(2)" title="Upraviù text za poloûkami fakt˙ry" >
<?php
     }
?>
