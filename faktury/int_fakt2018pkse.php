...
//toto je prenos faktur poliklinika se do firmy 909 z 911,912,914 rok 2018
...
//$copern=41;
if( $copern == 41 ) {
echo "Na nastavenÌ prevodu fakt˙r do firmy 909 sa moment·lne pracuje."; 
exit;
                    }
...
if( $poliklinikase == 1 ) {
if( $kli_vxcf != 909 )    { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
if( $kli_vxcf == 909 AND $h_sys != 911 AND $h_sys != 912 AND $h_sys != 914 ) { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
                 }
...
if( !confirm ("Chcete za˙Ëtovaù fakt˙ry z podsystÈmu <?php echo $h_sys; ?> Odbyt, fakt˙ry za obdobie <?php echo $h_obdp; ?>.<?php echo $kli_vrok; ?> ?") )
  ...
  var okno = window.open("../faktury/int_fakt2018pkse.php?copern=56&page=1&h_sys=<?php echo $h_sys; ?>&h_obdp=<?php echo $h_obdp; ?>&drupoh=1&uprav=1","_self");
</script>
...
{
$uceodb="311100";
if( $h_sys == 911 ) $uceodb="311100";
if( $h_sys == 912 ) $uceodb="311100";
if( $h_sys == 914 ) $uceodb="311000";
