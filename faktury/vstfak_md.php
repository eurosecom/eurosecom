...
<?php if ( $pocstav == 1 ) echo " - PoËiatoËn˝ stav"; ?> <!-- dopyt, neskÙr pÙjde preË -->
...
<?php
if ( $drupoh == 1 OR $drupoh == 31 ) { $link_odber="active"; }
if ( $drupoh == 2 ) { $link_dodav="active"; }
?>
      <ul for="header_dropdown_menu" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
        <li onclick="OdberFa();" class="mdl-menu__item <?php echo $link_odber; ?>">OdberateæskÈ fakt˙ry</li>
        <li onclick="DodavFa();" class="mdl-menu__item <?php echo $link_dodav; ?>">Dod·vateæskÈ fakt˙ry</li>
<?php if ( $drupoh == 1 OR $drupoh == 31 ) { ?>
        <li onclick="OdberUcty();" class="mdl-menu__item">OdberateæskÈ ˙Ëty</li>
<?php } ?>
<?php if ( $drupoh == 2 ) { ?>
        <li onclick="DodavUcty();" class="mdl-menu__item">Dod·vateæskÈ ˙Ëty</li>
<?php } ?>
      </ul>
    </li>
...
<!-- period nav -->
    <div class="clearfix" style=" margin-right: 16px;">
      ...
      <span class="toleft" style="font-size: 14px; line-height: 32px; margin-left: 4px;"><?php echo $kli_vume; ?></span>
    </div>
...
<?php if ( ( $drupoh == 2 OR $drupoh == 1 OR $drupoh == 12 ) AND $pocstav == 1 AND $kli_uzall > 3000 ) { ?> <!-- dopyt, $drupoh zbytoËnÈ, alebo aj tam je poËiatoËn˝ stav -->
    <li class="mdl-menu__item" onclick="window.open('../faktury/vstfak_md.php?regpok=<?php echo $regpok; ?>&vyroba=<?php echo $vyroba; ?>&copern=167&page=1&drupoh=<?php echo $drupoh; ?>&pocstav=<?php echo $pocstav; ?>', '_self');">
      <i class="material-icons vacenter">cancel</i>Vöetky poloûky
    </li> <!-- dopyt, pred vymazanÌm op˝taù -->
    <li class="mdl-menu__item" onclick="window.open('../faktury/vstfak_md.php?regpok=<?php echo $regpok; ?>&vyroba=<?php echo $vyroba; ?>&copern=155&page=1&drupoh=<?php echo $drupoh; ?>&pocstav=<?php echo $pocstav; ?>', '_self');">
...
<button type="button" id="new_item" onclick="newItem(); window.name = 'zoznam';" class="mdl-button mdl-js-button mdl-button--fab mdl-button--colored mdl-js-ripple-effect mdl-shadow--4dp">
  ...
  <span data-mdl-for="new_item" class="mdl-tooltip mdl-tooltip--left">Vytvoriù nov˙ fakt˙ru</span>
