...
if ($ulozene):
$uloz="OK";
//echo "POLOéKA ddod:$h_ddod SPR¡VNE ULOéEN¡ ";
endif;
    }
//koniec ulozenia
//vymazanie
...
if ($zmazane):
$zmaz="OK";
//echo "POLOéKA ddod:$cislo_ddod BOLA VYMAZAN¡ ";
endif;
    }
     }
//koniec vymazania
...
if ($upravene):
$uprav="OK";
//echo "POLOéKA ddod:$cislo_ddod UPRAVEN¡ ";
endif;
  }
...
<tr>
<td>EuroSecom  -  Druhy dod·vateæsk˝ch dokladov
<?php
...
<th class="hmenu">CFAK
 ...
 alt="N·sleduj˙ce ËÌslo dod·vateæskÈho dokladu pri oddelenom ËÌslovanÌ dokladov , nastavÌ V·m ho V·ö spr·vca webu ">
...
<td class="fmenu" width="5%" ><a href='ddod.php?copern=6&page=<?php echo $page;?>&cislo_ddod=<?php echo $riadok->ddod;?>'>Zmaû</a></td>
</tr>
<?php
  }
$i = $i + 1;
...
<span id="Dx" style="display:none; width:100%; align:center; font-family:bold; font-weight:bold; background-color:red; color:black;">
 Druh musÌ byù ËÌslo v rozsahu 1 aû 9</span>
...
<span id="Ul" style="display:none; width:100%; align:center; font-family:bold; font-weight:bold; background-color:yellow; color:black;">
 Poloûka ddod=<?php echo $h_ddod;?> spr·vne uloûen·</span>
</tr>
<tr>
...
<span id="Zm" style="display:none; width:100%; align:center; font-family:bold; font-weight:bold; background-color:yellow; color:black;">
 Poloûka ddod=<?php echo $cislo_ddod;?> zmazan·</span>
<span id="Up" style="display:none; width:100%; align:center; font-family:bold; font-weight:bold; background-color:yellow; color:black;">
 Poloûka ddod=<?php echo $cislo_ddod;?> upraven·</span>
</tr>
