...
// prenos faktur na domene medosro.sk do uctovnictva rok 2019
...
if( $medo == 1 ) {
if( $kli_vxcf != 95 AND $kli_vxcf != 78 ) { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
if( $kli_vxcf == 95 AND $h_sys == 649 ) { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
if( $kli_vxcf == 95 AND $h_sys == 679 ) { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
if( $kli_vxcf == 78 AND $h_sys != 649 AND $h_sys != 679 ) { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
                 }
//$h_sys=74;
...
if( !confirm ("Chcete za˙Ëtovaù fakt˙ry z podsystÈmu <?php echo $h_sys; ?> Odbyt, fakt˙ry za obdobie <?php echo $h_obdp; ?>.<?php echo $kli_vrok; ?> ?") )
  ...
  var okno = window.open("../faktury/int_fakt2019medo.php?copern=56&page=1&h_sys=<?php echo $h_sys; ?>&h_obdp=<?php echo $h_obdp; ?>&drupoh=1&uprav=1","_self");
</script>
