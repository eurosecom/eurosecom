...
//toto je prenos faktur poliklinika se do firmy 609 z 611,612,614 rok 2015
...
//$copern=41;
if( $copern == 41 ) {
echo "Na nastavenÌ prevodu fakt˙r do firmy 609 sa moment·lne pracuje."; 
exit;
                    }
...
if( $poliklinikase == 1 ) {
if( $kli_vxcf != 609 )    { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
if( $kli_vxcf == 609 AND $h_sys != 611 AND $h_sys != 612 AND $h_sys != 614 ) { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
                 }
...
if( !confirm ("Chcete za˙Ëtovaù fakt˙ry z podsystÈmu <?php echo $h_sys; ?> Odbyt, fakt˙ry za obdobie <?php echo $h_obdp; ?>.<?php echo $kli_vrok; ?> ?") )
  ...
  var okno = window.open("../faktury/int_fakt2015pkse.php?copern=56&page=1&h_sys=<?php echo $h_sys; ?>&h_obdp=<?php echo $h_obdp; ?>&drupoh=1&uprav=1","_self");
</script>
...
{
$uceodb="311100";
if( $h_sys == 611 ) $uceodb="311100";
if( $h_sys == 612 ) $uceodb="311100";
if( $h_sys == 614 ) $uceodb="311000";
