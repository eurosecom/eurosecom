...
//toto je prenos faktur poliklinika se do firmy 709 z 711,712,714 rok 2016
//POZOR prenasaju podla daz a tento daz davaju do dat v uctovnictve takze ked je vystavena 11.4.2013 a datum dodania je 30.3.2013 da ju do 3.2013
...
//$copern=41;
if( $copern == 41 ) {
echo "Na nastavenÌ prevodu fakt˙r do firmy 709 sa moment·lne pracuje."; 
exit;
                    }
...
if( $poliklinikase == 1 ) {
if( $kli_vxcf != 709 )    { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
if( $kli_vxcf == 709 AND $h_sys != 711 AND $h_sys != 712 AND $h_sys != 714 ) { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
                 }
...
if( !confirm ("Chcete za˙Ëtovaù fakt˙ry z podsystÈmu <?php echo $h_sys; ?> Odbyt, fakt˙ry za obdobie <?php echo $h_obdp; ?>.<?php echo $kli_vrok; ?> ?") )
  ...
  var okno = window.open("../faktury/int_fakt2016pkse.php?copern=56&page=1&h_sys=<?php echo $h_sys; ?>&h_obdp=<?php echo $h_obdp; ?>&drupoh=1&uprav=1","_self");
</script>
...
{
$uceodb="311100";
if( $h_sys == 711 ) $uceodb="311100";
if( $h_sys == 712 ) $uceodb="311100";
if( $h_sys == 714 ) $uceodb="311000";
