...
function volajFakset(premenna, doklad)
{
  ...
  if (xmlHttp)
  {
    ...
    try
    {
      ...
      xmlHttp.open("GET", "fak_setx.php?" + params, true);
      xmlHttp.onreadystatechange = cakajFakset;
      xmlHttp.send(null);
    }
...
function tabulka_FaksetXML()
{
  ...
  for (var i=0; i<pol01Array.length; i++)
    ...
    var u1f = pol19Array.item(i).firstChild.data;
    var u2f = pol20Array.item(i).firstChild.data;
    var u3f = pol21Array.item(i).firstChild.data;
    }
...
if( u1f == 1 ) { document.enast.u1f.checked = 'checked'; }
if( u2f == 1 ) { document.enast.u2f.checked = 'checked'; }
if( u3f == 1 ) { document.enast.u3f.checked = 'checked'; }
