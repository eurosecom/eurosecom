...
// prenos faktur na domene medosro.sk do uctovnictva rok 2018
...
if( $medo == 1 ) {
if( $kli_vxcf != 85 AND $kli_vxcf != 77 ) { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
if( $kli_vxcf == 85 AND $h_sys == 648 ) { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
if( $kli_vxcf == 85 AND $h_sys == 678 ) { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
if( $kli_vxcf == 77 AND $h_sys != 648 AND $h_sys != 678 ) { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
                 }
//$h_sys=74;
...
if( !confirm ("Chcete za˙Ëtovaù fakt˙ry z podsystÈmu <?php echo $h_sys; ?> Odbyt, fakt˙ry za obdobie <?php echo $h_obdp; ?>.<?php echo $kli_vrok; ?> ?") )
  ...
  var okno = window.open("../faktury/int_fakt2018medo.php?copern=56&page=1&h_sys=<?php echo $h_sys; ?>&h_obdp=<?php echo $h_obdp; ?>&drupoh=1&uprav=1","_self");
</script>
...
{
$uceodb="31100";
if( $h_sys == 648 ) $uceodb="31149";
if( $h_sys == 658 ) $uceodb="31149";
if( $h_sys == 689 ) $uceodb="31147";
if( $h_sys == 608 ) $uceodb="31144";
