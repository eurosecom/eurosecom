...
$sql = "SELECT zmd FROM F$kli_vxcf"."_fakturaset";
$vysledok = mysql_query("$sql");
if (!$vysledok)
{

$vsql = 'DROP TABLE F'.$kli_vxcf.'_fakturaset'.$kli_uzid;
$vytvor = mysql_query("$vsql");
$vsql = 'DROP TABLE F'.$kli_vxcf.'_fakturaset';
$vytvor = mysql_query("$vsql");
...
$vsql = 'CREATE TABLE F'.$kli_vxcf.'_fakturaset'.$kli_uzid.$sqlt;
$vytvor = mysql_query("$vsql");

$vsql = "CREATE TABLE F".$kli_vxcf."_fakturaset SELECT * FROM F".$kli_vxcf."_fakturaset".$kli_uzid." ";
$vytvor = mysql_query("$vsql");
}

$vsql = "CREATE TABLE F".$kli_vxcf."_fakturaset".$kli_uzid." SELECT * FROM F".$kli_vxcf."_fakturaset ";
$vytvor = mysql_query("$vsql");
...
$sqltt = "SELECT * FROM F$kli_vxcf"."_fakturaset$kli_uzid ";
...
$sqltt = "SELECT * FROM F$kli_vxcf"."_fakturaset ";
$sql = mysql_query("$sqltt");
...
$fir_uc1fk=1; $fir_uc2fk=1; $fir_uc3fk=1; 
...
$txp19 = $retezec = iconv("CP1250", "UTF-8", $fir_uc1fk);
$txp20 = $retezec = iconv("CP1250", "UTF-8", $fir_uc2fk);
$txp21 = $retezec = iconv("CP1250", "UTF-8", $fir_uc3fk);
