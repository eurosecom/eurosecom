...
<img src="../obr/import.png" onClick="importSluzby();" width=20 height=12 border=0 title="Import ËÌselnÌka sluûieb z CSV s˙boru, POZOR pred naËÌtanÌm vöetky poloûky ËÌselnÌka vymaûe." ></td>
<?php                          } ?>
</td>
<td class="hmenu" ></td>
<td class="hmenu" ><a href='cslu_xml.php?copern=10&page=1' target="_blank">
<img src='../obr/export.png' width=20 height=15 border=0 title="Export do XML s˙boru"></a></td>
<td class="hmenu" ><a href='cslu_web.php?copern=1&page=1' target="_blank">
<img src='../obr/ziarovka.png' width=20 height=15 border=0 title="Vzhæad webstr·nky sluûieb"></a></td>
</tr>
<tr>
...
<img src='../obr/zoznam.png' width=15 height=10 border=0 title="DoplÚuj˙ce ˙daje o sluûbovej poloûke" ></a>
...
{
?>
<a href='vstf_s.php?copern=31&drupoh=1&page=1&cislo_dok=<?php echo $riadok->slu;?>' target="_blank"><img src='../obr/ziarovka.png' width=15 height=10 border=0 title="Uloûenie obr·zku A do datab·zy" ></a>
<a href='vstf_s.php?copern=32&drupoh=1&page=1&cislo_dok=<?php echo $riadok->slu;?>' target="_blank"><img src='../obr/ziarovka.png' width=15 height=10 border=0 title="Uloûenie obr·zku B do datab·zy" ></a>
<a href='vstf_s.php?copern=33&drupoh=1&page=1&cislo_dok=<?php echo $riadok->slu;?>' target="_blank"><img src='../obr/ziarovka.png' width=15 height=10 border=0 title="Uloûenie obr·zku C do datab·zy" ></a>
<a href='vstf_s.php?copern=34&drupoh=1&page=1&cislo_dok=<?php echo $riadok->slu;?>' target="_blank"><img src='../obr/ziarovka.png' width=15 height=10 border=0 title="Uloûenie obr·zku D do datab·zy" ></a>
<?php
}
?>
</td>
