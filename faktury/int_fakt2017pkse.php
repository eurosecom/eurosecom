...
//toto je prenos faktur poliklinika se do firmy 809 z 811,812,814 rok 2017
//POZOR prenasaju podla daz a tento daz davaju do dat v uctovnictve takze ked je vystavena 11.4.2017 a datum dodania je 30.3.2017 da ju do 3.2017
...
//$copern=41;
if( $copern == 41 ) {
echo "Na nastavenÌ prevodu fakt˙r do firmy 809 sa moment·lne pracuje."; 
exit;
                    }
...
if( $poliklinikase == 1 ) {
if( $kli_vxcf != 809 )    { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
if( $kli_vxcf == 809 AND $h_sys != 811 AND $h_sys != 812 AND $h_sys != 814 ) { echo "SYS $h_sys nemÙûete prev·dzaù do  FIR $kli_vxcf ."; exit; } 
                 }
...
if( !confirm ("Chcete za˙Ëtovaù fakt˙ry z podsystÈmu <?php echo $h_sys; ?> Odbyt, fakt˙ry za obdobie <?php echo $h_obdp; ?>.<?php echo $kli_vrok; ?> ?") )
  ...
  var okno = window.open("../faktury/int_fakt2017pkse.php?copern=56&page=1&h_sys=<?php echo $h_sys; ?>&h_obdp=<?php echo $h_obdp; ?>&drupoh=1&uprav=1","_self");
</script>
...
{
$uceodb="311100";
if( $h_sys == 811 ) $uceodb="311100";
if( $h_sys == 812 ) $uceodb="311100";
if( $h_sys == 814 ) $uceodb="311000";
