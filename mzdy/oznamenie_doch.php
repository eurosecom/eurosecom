...
$sql = "SELECT oc FROM F".$kli_vxcf."_mzdoznam_doch";
$vysledok = mysql_query($sql);
if (!$vysledok)
{
$sqlt = 'DROP TABLE F'.$kli_vxcf.'_mzdoznam_doch';
$vysledok = mysql_query("$sqlt");
...
$vsql = 'CREATE TABLE F'.$kli_vxcf.'_mzdoznam_doch'.$sqlt;
...
$vsql = 'CREATE TABLE F'.$kli_vxcf.'_mzdprcvypl'.$kli_uzid." SELECT * FROM F$kli_vxcf"."_mzdoznam_doch";
$vytvor = mysql_query("$vsql");
$vsql = 'CREATE TABLE F'.$kli_vxcf.'_mzdprcvyplx'.$kli_uzid." SELECT * FROM F$kli_vxcf"."_mzdoznam_doch";
$vytvor = mysql_query("$vsql");
...
$jepotvrd=0;
$sql = "SELECT * FROM F$kli_vxcf"."_mzdoznam_doch WHERE oc = $cislo_oc";
...
//uloz do priznania
$sqtoz = "DELETE FROM F$kli_vxcf"."_mzdoznam_doch WHERE oc = $cislo_oc";
$oznac = mysql_query("$sqtoz");

$dsqlt = "INSERT INTO F$kli_vxcf"."_mzdoznam_doch".
...
<title>EuroSecom - Oznámenie dôchodca</title>
<style>
...
//Z ciarky na bodku
  ...
  {
   window.open('oznamenie_doch.php?copern=20&drupoh=1&page=1&subor=0&cislo_oc=' + prevoc + '', '_self');
  }
  function nextOC(nextoc)
  {
   window.open('oznamenie_doch.php?copern=20&drupoh=1&page=1&subor=0&cislo_oc=' + nextoc + '', '_self');
  }
...
<div id="wrap-heading">
 <table id="heading">
  ...
  <tr>
   <td class="header">Oznámenie a èestné vyhlásenie dôchodca - <span class="subheader"><?php echo "$oc $meno $prie"; ?></span>
<?php if ( $novy == 0 ) { ?>
...
<div id="content">
<FORM name="formv1" method="post" action="oznamenie_doch.php?copern=23&cislo_oc=<?php echo $cislo_oc;?>&strana=<?php echo $strana;?>">
 <INPUT type="submit" id="uloz" name="uloz" value="Uloži zmeny" class="btn-top-formsave" style="top:4px;">
<img src="../dokumenty/tlacivo2018/oznamenie_dochodca_v18/oznamenie_dochodca_v18.jpg"
...
if ( File_Exists('../dokumenty/tlacivo2018/oznamenie_dochodca_v18/oznamenie_dochodca_v18.jpg') )
{
$pdf->Image('../dokumenty/tlacivo2018/oznamenie_dochodca_v18/oznamenie_dochodca_v18.jpg',0,0,210,297);
}
$pdf->SetY(10);
...
if ( File_Exists('../dokumenty/tlacivo2018/oznamenie_dochodca_v18/oznamenie_dochodca_v18_poucenie.jpg') )
{
$pdf->Image('../dokumenty/tlacivo2018/oznamenie_dochodca_v18/oznamenie_dochodca_v18_poucenie.jpg',0,0,210,297);
}
