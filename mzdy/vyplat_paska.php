...
//ak viac pracovn˝ch pomerov odvod do DOVERA je odvod zo suctu zakladov andrejko
$prepsub=0;
$podm_hlvn="hlvn > 0";
if( $all_oc == 0 )
{
...
//koniec ak viac pracovn˝ch pomerov odvod do DOVERA je odvod zo suctu zakladov andrejko
