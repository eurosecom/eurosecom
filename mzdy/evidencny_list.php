...
//echo "xrok ".$xrok."lenjedenrok ".$lenjedenrok."<br />";
...
<div id="wrap-heading">
 <table id="heading">
  ...
  <tr>
   <td class="header">EvidenËn˝ list DP - <span class="subheader"><?php echo "$oc $meno $prie";?></span>
<?php if ( $novy == 0 ) { ?>
...
<a href="#" onclick="window.open('<?php echo $source; ?>&copern=20&strana=2', '_self');" title="Prejsù na vypÂÚanie 14 a viac obdobÌ"
   style="position:absolute; top:463px; left:850px; color:#39f; font-size:12px; font-weight:bold;">viac obdobÌ</a>
