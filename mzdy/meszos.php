...
<td class="bmenu" width="28%">»erpanie a zostatok dovolenky zamestnancov

<a href="#" onClick="DovolenkyDoCsv();">
<img src='../obr/export.png' width=20 height=15 border=0 title='Export »erpanie a zostatok dovolenky zamestnancov do form·tu CSV' ></a>
