...
$pdf->Cell(100,5,"Pars.Nr.: $hlavicka->oc $hlavicka->titl $hlavicka->meno $hlavicka->prie STR: $hlavicka->stz Z¡K: $hlavicka->zkz VM: $hlavicka->wms","T",1,"R");
...
$textlekdop="Arzt tage - Anrecht $lek_nrk geshˆpft $lek_cerp, Beglaitung Tage - Anrecht $dop_nrk geshˆpft $dop_cerp";
$popispomer="";
if( $fisit == 1 )
{
...
$texthl2x="Arbeitverh‰ltnis: $hlavicka->pom Arbeitsumfang: $hlavicka->suva Studn./Tag PrNah: $hlavicka->znah";
...
$pdf->Cell(100,4,"Urlaub tage - Anrecht $hlavicka->nrk ¸bertragen $hlavicka->nev geshˆpft $hlavicka->cerp_dni = Rest $sZostdov","0",1,"R");

$pdf->SetFont('arial','',8);
$pdf->Cell(40,4,"Art des Lohne","BT",0,"L");$pdf->Cell(20,4,"Tage","BT",0,"R");$pdf->Cell(20,4,"Stdn.","BT",0,"R");
$textsk="($mena2)";
...
if( $rtov->konx != 9999 AND ( $rtov->dm != 9504 AND $rtov->dm != 9505 ) ) 
     {
if( $rtov->dm == 105 ) { $rtov->nzdm="LOHN SR"; }
if( $rtov->dm == 107 ) { $rtov->nzdm="LOHN ÷STERREICH"; }
if( $rtov->dm == 201 ) { $rtov->nzdm="‹berzeitarbeit"; }
if( $rtov->dm == 202 ) { $rtov->nzdm="‹berstunden geshˆpft"; }
if( $rtov->dm == 223 ) { $rtov->nzdm="ZUSCHLAG NACHT"; }
if( $rtov->dm == 506 ) { $rtov->nzdm="Urlaub"; }
if( $rtov->dm == 510 ) { $rtov->nzdm="Feiertag"; }
if( $rtov->dm == 901 ) { $rtov->nzdm="EINKOMMENSTEUER"; }
if( $rtov->dm == 903 ) { $rtov->nzdm="JAHRESABRECHNUNG"; }
if( $rtov->dm == 904 ) { $rtov->nzdm="Abz¸ge.FONDS"; }
if( $rtov->dm == 926 ) { $rtov->nzdm="MITTAGESSEN"; }

if( $rtov->dm == 301 ) { $rtov->nzdm="Pr‰mien"; }
if( $rtov->dm == 304 ) { $rtov->nzdm="Pr‰mien mon."; }
if( $rtov->dm == 528 ) { $rtov->nzdm="Reisekosten ausl‰ndische"; }
if( $rtov->dm == 529 ) { $rtov->nzdm="Reisekosten SR"; }
if( $rtov->dm == 902 ) { $rtov->nzdm="Steuerbonus"; }
if( $rtov->dm == 948 ) { $rtov->nzdm="Arbeitgeberdarlehen"; }
if( $rtov->dm == 998 ) { $rtov->nzdm="Geldlose Einnahme"; }
...
$pdf->Cell(60,1,"","0",1,"R");
$pdf->SetFont('arial','',7);
$pdf->Cell(40,4,"ZdravotnÈ poistenie","0",0,"L");$pdf->Cell(40,4,"percento za prac. $zam_zp","0",0,"R");$pdf->Cell(20,4,"$hlavicka->ozam_zp","0",1,"R");
$pdf->Cell(40,4,"NemocenskÈ poistenie","0",0,"L");$pdf->Cell(40,4," $zam_np","0",0,"R");$pdf->Cell(20,4,"$hlavicka->ozam_np","0",1,"R");
$pdf->Cell(40,4,"StarobnÈ poistenie","0",0,"L");$pdf->Cell(40,4," $zam_sp","0",0,"R");$pdf->Cell(20,4,"$hlavicka->ozam_sp","0",1,"R");
$pdf->Cell(40,4,"InvalidnÈ poistenie","0",0,"L");$pdf->Cell(40,4," $zam_ip","0",0,"R");$pdf->Cell(20,4,"$hlavicka->ozam_ip","0",1,"R");
$pdf->Cell(40,4,"Poistenie v nezamestnanosti","0",0,"L");$pdf->Cell(40,4," $zam_pn","0",0,"R");$pdf->Cell(20,4,"$hlavicka->ozam_pn","0",1,"R");
$pdf->Cell(20,2," ","0",1,"R");
$pdf->Cell(40,4,"Nezdaniteæn· Ëasù ZD na zamestnanca","0",0,"L");$pdf->Cell(40,4,"  ","0",0,"R");$pdf->Cell(20,4,"$hlavicka->pdan_dnv","0",1,"R");
...
$pdf->SetFont('arial','',10);
$pdf->Cell(40,6,"ZUSAMMEN","BT",0,"L");$pdf->Cell(20,6,"$hlavicka->sum_dni","BT",0,"R");$pdf->Cell(20,6,"$hlavicka->sum_hod","BT",0,"R");
$pdf->SetFont('arial','',7);
...
if( $hlavicka->sum_ban != 0 )
{
$pdf->Cell(50,6,"$hlavicka->sum_ban Ä Bank","LBT",0,"R");
$pdf->SetFont('arial','',6);
...
$pdf->Cell(55,4,"Brutto Lohn $hlavicka->sum_hru Ä","0",0,"L");
$pdf->SetFont('arial','',8);
$pdf->Cell(55,4,"Andere Auflagen $hlavicka->sum_nem Ä","0",0,"L");
$pdf->Cell(30,4,"Abz¸ge $hlavicka->sum_zrz Ä","0",0,"L");
...
$pdf->Cell(55,4,"Netto Lohn $hlavicka->cista_mzda Ä$textsk","0",0,"L");
$pdf->Cell(55,4,"Abz¸ge Zamtel $hlavicka->ofir_spolu Ä","0",0,"L");

$textsk="/$hlavicka->sum_cccpsk Sk";
if( $fir_mzdx04 == 1 ) { $textsk="";  }

$pdf->Cell(55,4,"Arbeitspreise gesamt $hlavicka->sum_cccp Ä$textsk","0",0,"L");
$pdf->Cell(10,4,"","0",1,"L");
...
$pdf->Cell(60,1,"","0",1,"R");
$pdf->SetFont('arial','',7);
$pdf->Cell(24,3,"Abf¸runggrundlage","0",0,"L");
...
$pdf->Cell(24,3,"Abf¸rung Znec/Ztel","0",0,"L");
...
$pdf->Cell(60,1,"","0",1,"R");
$pdf->SetFont('arial','',7);
$pdf->Cell(20,3,"Cena pr·ce $hlavicka->sum_cccp Ä (HM $hlavicka->sum_hru, ZP $hlavicka->ofir_zp, NP $hlavicka->ofir_np, SP $hlavicka->ofir_sp,  IP $hlavicka->ofir_ip, PvN $hlavicka->ofir_pn, UP $hlavicka->ofir_up, GP $hlavicka->ofir_gf, RF $hlavicka->ofir_rf)","0",1,"L");
}

$pdf->Cell(20,2,"","0",1,"L");

$pdf->Cell(16,3,"Lohnsteuer","0",0,"L");
$pdf->Cell(30,3,"Eikommen gesamt $hlavicka->zdan_dnp","0",0,"L");
$pdf->Cell(29,3,"Versicherunggeld $hlavicka->pdan_fnd","0",0,"L");
$pdf->Cell(20,3,"Steuerfrei $hlavicka->pdan_dnv","0",0,"L");
$pdf->Cell(20,3,"Zpl.DDP $hlavicka->pdan_zn1","0",0,"L");

$pdf->Cell(28,3,"Besteuerter Lohn $hlavicka->zakl_dan","0",0,"L");
$pdf->Cell(16,3,"Steuer $hlavicka->odan_dnp","0",0,"L");
...
$pdf->SetFont('arial','',5); 
$pdf->Cell(25,1," ","0",1,"L");
$pdf->Cell(70,3,"Konto der Arbeitszeit ß87a Gesetz 311/2001 ff., Gesetzsammlung Arbeitsgesetzbuch ","0",0,"L"); 
$pdf->Cell(29,3,"¸bertragen: $preh h/$pree e ","0",0,"L"); 
$pdf->Cell(29,3,"$kli_vume(+): $pluh h/$plue e ","0",0,"L");
$pdf->Cell(29,3,"$kli_vume(-): $minh h/$mine e ","0",0,"L");
$pdf->Cell(29,3,"rest: $zosh h/$zose e ","0",1,"L");
                 }
