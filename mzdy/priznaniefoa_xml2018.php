...
alert ("Daòové priznanie XML bude pripravené v priebehu januára 2019. Aktuálne info nájdete na vstupnej stránke v bode Novinky, tipy, triky.");
window.close();
</script>
<?php
exit;
...
$hhmm = Date ("His", MkTime (date("H"),date("i"),date("s"),date("m"),date("d"),date("Y"))); 
$idx=$kli_uzid.$hhmm;
...
$rodneCislo=$hlavicka->mrod;
  ...
  $text = "  <r30>"."\r\n"; fwrite($soubor, $text);
$hodnota=1*$hlavicka->nzdm;
  $text = "   <uplatnujemNaManzelku><![CDATA[".$hodnota."]]></uplatnujemNaManzelku>"."\r\n"; fwrite($soubor, $text);
$hodnota=$hlavicka->mpri;
if ( $hodnota == 0 ) $vlastnePrijmy="0.00";
  $text = "   <vlastnePrijmy><![CDATA[".$hodnota."]]></vlastnePrijmy>"."\r\n"; fwrite($soubor, $text);
...
if ( $hlavicka->mpom == 0 ) $pocetMesiacov="";
  ...
  $text = "  <r31>"."\r\n"; fwrite($soubor, $text);
$hodnota=1*$hlavicka->kupm;
  $text = "   <uplatnujemKupelnuStarost><![CDATA[".$hodnota."]]></uplatnujemKupelnuStarost>"."\r\n"; fwrite($soubor, $text);
$hodnota=1*$hlavicka->kupm;
if ( $hodnota == 0 ) $hodnota="";
  $text = "   <zaplateneUhrady><![CDATA[".$hodnota."]]></zaplateneUhrady>"."\r\n"; fwrite($soubor, $text);
  $text = "  </r31>"."\r\n"; fwrite($soubor, $text);
...
if ( $riadok == 0 ) $riadok="";
  $text = "    <rodneCislo><![CDATA[".$rodneCislo."]]></rodneCislo>"."\r\n"; fwrite($soubor, $text);
$kup=1*$hlavicka->kupd1;
  $text = "    <kupelnaStarost><![CDATA[".$kup."]]></kupelnaStarost>"."\r\n"; fwrite($soubor, $text);
$m00="$hlavicka->d1pomc";
...
if ( $riadok == 0 ) $riadok="";
  ...
  $text = "  <r35>"."\r\n"; fwrite($soubor, $text);
$hodnota=1*$hlavicka->dbur;
  $text = "   <uplatnujemBonusPar33a><![CDATA[".$hodnota."]]></uplatnujemBonusPar33a>"."\r\n"; fwrite($soubor, $text);
$hodnota=$hlavicka->dbure;
if ( $hodnota == 0 ) $vlastnePrijmy="0.00";
  $text = "   <zaplateneUroky><![CDATA[".$hodnota."]]></zaplateneUroky>"."\r\n"; fwrite($soubor, $text);
$pocetMesiacov=$hlavicka->dburm;
if ( $hlavicka->mpom == 0 ) $pocetMesiacov="";
  $text = "   <pocetMesiacov><![CDATA[".$pocetMesiacov."]]></pocetMesiacov>"."\r\n"; fwrite($soubor, $text);
  $text = "  </r35>"."\r\n"; fwrite($soubor, $text);
...
$riadok=$hlavicka->r36a;
if ( $riadok == 0 ) $riadok="";
  $text = "  <r36a><![CDATA[".$riadok."]]></r36a>"."\r\n"; fwrite($soubor, $text);

$riadok=$hlavicka->r37;
if ( $riadok == 0 ) $riadok="";
  $text = "  <r37><![CDATA[".$riadok."]]></r37>"."\r\n"; fwrite($soubor, $text);

$riadok=$hlavicka->r37a;
if ( $riadok == 0 ) $riadok="";
  $text = "  <r37a><![CDATA[".$riadok."]]></r37a>"."\r\n"; fwrite($soubor, $text);

$riadok=$hlavicka->r37b;
if ( $riadok == 0 ) $riadok="";
  $text = "  <r37b><![CDATA[".$riadok."]]></r37b>"."\r\n"; fwrite($soubor, $text);
...
$riadok=$hlavicka->r42a;
if ( $riadok == 0 ) $riadok="";
  $text = "  <r42a><![CDATA[".$riadok."]]></r42a>"."\r\n"; fwrite($soubor, $text);

$riadok=$hlavicka->r42b;
if ( $riadok == 0 ) $riadok="";
  $text = "  <r42b><![CDATA[".$riadok."]]></r42b>"."\r\n"; fwrite($soubor, $text);
...
$pgf50=1*$hlavicka->upl50;
  $text = "  <paragraf50><![CDATA[".$pgf50."]]></paragraf50>"."\r\n"; fwrite($soubor, $text);

$riadok=1*$hlavicka->spln3;
...
$riadok=1*$hlavicka->zurk;
  $text = "   <vyplatitDanovyBonusUroky><![CDATA[".$riadok."]]></vyplatitDanovyBonusUroky>"."\r\n"; fwrite($soubor, $text);
...
$ucet=1*$hlavicka->uzhr;
  $text = "    <ucetZahranicnyIny><![CDATA[".$ucet."]]></ucetZahranicnyIny>"."\r\n"; fwrite($soubor, $text);
  $text = "   </sposobPlatby>"."\r\n"; fwrite($soubor, $text);
...
{
$upozorni6=1;
echo "<strong>Dátum žiadosti o vrátenie</strong> nemôže by vyšší ako aktuálny dátum.";
}
?>
</li>
<li class="orange">
