...
alert ("RoËnÈ z˙Ëtovanie 2018 bude pripravenÈ v priebehu janu·ra 2019.\n Aktu·lne info n·jdete na vstupnej str·nke v bode Novinky, tipy, triky.");
window.close();
</script>
<?php
exit;
...
<div id="content">
<form name="formv1" method="post" action="rocne_dane2018.php?copern=23&cislo_oc=<?php echo $cislo_oc; ?>&strana=<?php echo $strana; ?>">
<?php
$clas1="noactive"; $clas2="noactive"; $clas3="noactive";
if ( $strana == 1 ) $clas1="active"; if ( $strana == 2 ) $clas2="active"; if ( $strana == 3 ) $clas3="active";
//$source="../mzdy/rocne_dane2018.php?cislo_oc=".$cislo_oc."&drupoh=1&page=1&subor=0";
?>
<div class="navbar">
...
//Z ciarky na bodku
  ...
  function prevOC()
  {
   window.open('rocne_dane2018.php?copern=20&subor=0&cislo_oc=<?php echo $prev_oc;?>', '_self');
  }
  function nextOC()
  {
   window.open('rocne_dane2018.php?copern=20&subor=0&cislo_oc=<?php echo $next_oc;?>', '_self');
  }

  function reNacitajMzdy()
  {
   window.open('../mzdy/rocne_dane2018.php?cislo_oc=<?php echo $cislo_oc;?>&copern=26&subor=0', '_self');
  }
  ...
  function NacitajMzdy()
  {
   ...
   window.open('../mzdy/rocne_dane2018.php?fix=' + fix + '&zamprex=' + zamprex + '&zampre=' + zampre + '&prebon=' + prebon +  '&nedbon=' + nedbon + '&pre=' + pre + '&ned=' + ned + '&umx=' + umx + '&dmx=' + dmx + '&cislo_oc=<?php echo $cislo_oc;?>&copern=27&subor=0', '_self', 'width=1080, height=900, top=0, left=10, status=yes, resizable=yes, scrollbars=yes');
  }
...
?>
  ...
  {
    window.open('rocne_dane2018.php?cislo_oc=<?php echo $cislo_oc; ?>&copern=20&strana=' + strana + '&subor=0', '_self');
  }
  function FormPDF(strana)
  {
    window.open('rocne_dane2018.php?cislo_oc=<?php echo $cislo_oc; ?>&copern=10&strana=' + strana + '&subor=0', '_blank', blank_param);
  }
