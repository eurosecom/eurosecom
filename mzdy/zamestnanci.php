...
//banka
    ...
    htmlbanka += "<td width='40%'>Bankov˝ ˙Ëet: ";
    htmlbanka += "" + ibanb + " / ";
    htmlbanka += "" + uceb + " / ";
    htmlbanka += "" + numb + "";
    htmlbanka += "</td>";
...
<td width='5%'>
<img border=0 src='../obr/ok.png' style='width:15; height:10;' onclick="ulozitBANKUnew(1,<?php echo $h_oc;?>);" title='Uloûiù' >
</td>
...
<td class="fmenu" colspan="2">Neprihl·sen˝ do ZP:
