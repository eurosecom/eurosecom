...
˙æava DP doch. <img src='../obr/tlac.png' width=20 height=15 border=0 title="Zamestnanci s nastavenou odvodovou ˙æavou DP pre dÙchodcov-dohod·rov"></a>
...
<img src='../obr/import.png' width=20 height=20 border=0 title='Nastavenie zr·ûok zo mzdy pri v˝kone rozhodnutia' >Zr·ûky zo mzdy</a>
<?php                     } ?>
...
?>
<?php if( $_SESSION['newzam'] == 1 ) { ?>
 <img src='../obr/pdf.png' onClick="histSprac();" width=15 height=15 border=1 title="HistÛria ostr˝ch spracovanÌ">
<?php                                } ?>
&nbsp&nbsp&nbsp
<a href='zamestnanci.php?sys=<?php echo $sys; ?>&copern=67&page=1'>
<img src='../obr/kos.png' width=15 height=15 border=1 title="Vymazanie vöetk˝ch poloûiek"></a>
<?php
  }
?>
</td>
...
if ( $kli_uzall > 3500 )
  {
?>
<img src='../obr/import.png' width=15 height=15 border=1 title="Import ˙dajov"></a>
<?php
  }
?>
</td>
...
<img src='../obr/vlozit.png' width=12 height=12 border=0 title='Nastavenie s˙beûn˝ch PP zamestnanca osË <?php echo $cislo_oc; ?>' ></a>
...
<tr>
<td class="fmenu" width="10%">PoËet daÚov˝ch bonusov:</td>
<td class="fmenu" width="15%">
...
?>
 &nbsp&nbsp | &nbsp&nbsp&nbsp&nbspOdv.˙æava DP dÙch.-doh.:
...
<tr>
<td width="30%" >Bankov˝ ˙Ëet: <?php echo $ibanb; ?> - <?php echo $swift; ?> / <?php echo $riadok->uceb; ?> / <?php echo $riadok->numb; ?></td>
