...
//.jpg podklad
$jpg_cesta="../dokumenty/tlacivo2020/vyhlasenie_nazdanenie/vyhlasenie_nczd_v20";
...
if ( !confirm ("Chcete naËÌtaù deti z ˙dajov o zamestnancovi ?") )
     ...
     { location.href='vyhlasenie_dane2020.php?copern=4156&page=1&drupoh=1&cislo_oc=<?php echo $cislo_oc; ?>' }
</script>
<?php
     }
...
if ( !confirm ("Chcete naËÌtaù ˙daje do vyhl·senia z firmy minulÈho roka ?") )
     ...
     { location.href='vyhlasenie_dane2020.php?copern=3156&page=1&drupoh=1&cislo_oc=<?php echo $cislo_oc; ?>' }
</script>
<?php
     }
...
//Z ciarky na bodku
  ...
  function prevOC()
  {
   window.open('vyhlasenie_dane2020.php?copern=20&drupoh=1&page=1&subor=0&cislo_oc=<?php echo $prev_oc;?>', '_self');
  }
  function nextOC()
  {
   window.open('vyhlasenie_dane2020.php?copern=20&drupoh=1&page=1&subor=0&cislo_oc=<?php echo $next_oc;?>', '_self');
  }
  function TlacVyhlNCZD()
  {
   window.open('../mzdy/vyhlasenie_dane2020.php?cislo_oc=<?php echo $cislo_oc;?>&copern=10&drupoh=1&page=1&subor=0&strana=1', '_blank', 'width=1050, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes');
  }
  function NacitajMinRok()
  {
   window.open('../mzdy/vyhlasenie_dane2020.php?cislo_oc=<?php echo $cislo_oc;?>&copern=1055&drupoh=1&page=1&subor=1', '_self', 'width=1080, height=900, top=0, left=10, status=yes, resizable=yes, scrollbars=yes');
  }
  ...
  {
   window.open('../mzdy/vyhlasenie_dane2020.php?cislo_oc=<?php echo $cislo_oc;?>&copern=2055&drupoh=1&page=1&subor=1', '_self', 'width=1080, height=900, top=0, left=10, status=yes, resizable=yes, scrollbars=yes');
  }
</script>
</HEAD>
...
<div id="content">
<FORM name="formv1" method="post" action="vyhlasenie_dane2020.php?copern=23&cislo_oc=<?php echo $cislo_oc; ?>">
<div class="navbar">
<?php
$clas1="active";
$source="../mzdy/vyhlasenie_dane2020.php?cislo_oc=".$cislo_oc."&drupoh=1&page=1&subor=0";
?>
...
<img src="<?php echo $jpg_cesta; ?>_str1.jpg"
...
<img src="../obr/ikony/pencil_blue_icon.png" onclick="UpravZamestnanca();"
     ...
     style="top:298px; left:330px; width:16px; height:16px;">
<?php                      } ?>
<span class="text-echo" style="top:325px; left:122px;"><?php echo $prie; ?></span>
<span class="text-echo" style="top:325px; left:410px;"><?php echo $meno; ?></span>
<span class="text-echo" style="top:325px; left:590px;"><?php echo $rodne; ?></span>
<span class="text-echo" style="top:347px; left:250px;"><?php echo $ptitl; ?></span>
<span class="text-echo" style="top:347px; left:485px;"><?php echo $ptitz; ?></span>
<select size="1" name="rdstav" id="rdstav" style="top:338px; left:689px;">
...
<span class="text-echo" style="top:384px; left:160px;"><?php echo $uli; ?></span>
<span class="text-echo" style="top:384px; left:588px;"><?php echo $cdm; ?></span>
<span class="text-echo" style="top:384px; left:742px;"><?php echo $psc; ?></span>
<span class="text-echo" style="top:403px; left:160px;"><?php echo $mes; ?></span>
<span class="text-echo" style="top:403px; left:530px;"><?php echo $zstat; ?></span>
<span class="text-echo" style="top:450px; left:122px;"><?php echo $zamestnavatel; ?></span>

<!-- UPLATNENIE NCZD -->
<input type="checkbox" name="nezd" value="1" style="top:543px; left:801px;"/>
<input type="checkbox" name="docx" value="1" style="top:604px; left:801px;"/>

<!-- UPLATNENIE BONUS -->
<input type="checkbox" name="bonus" value="1" style="top:716px; left:801px;"/>

<input type="text" name="det01" id="det01" style="width:250px; top:810px; left:116px; height:16px"/>
<input type="text" name="nar01" id="nar01" onkeyup="CiarkaNaBodku(this);" style="width:95px; top:810px; left:378px; height:16px"/>

<input type="text" name="det02" id="det02" style="width:250px; top:829px; left:116px; height:16px"/>
<input type="text" name="nar02" id="nar02" onkeyup="CiarkaNaBodku(this);" style="width:95px; top:829px; left:378px; height:16px"/>

<input type="text" name="det03" id="det03" style="width:250px; top:849px; left:116px; height:16px"/>
<input type="text" name="nar03" id="nar03" onkeyup="CiarkaNaBodku(this);" style="width:95px; top:849px; left:378px; height:16px"/>

<input type="text" name="det04" id="det04" style="width:250px; top:870px; left:116px; height:16px"/>
<input type="text" name="nar04" id="nar04" onkeyup="CiarkaNaBodku(this);" style="width:95px; top:870px; left:378px; height:16px"/>

<input type="text" name="det05" id="det05" style="width:250px; top:890px; left:116px; height:16px"/>
<input type="text" name="nar05" id="nar05" onkeyup="CiarkaNaBodku(this);" style="width:95px; top:890px; left:378px; height:16px"/>




<input type="text" name="det06" id="det06" style="width:250px; top:810px; left:486px; height:16px"/>
<input type="text" name="nar06" id="nar06" onkeyup="CiarkaNaBodku(this);" style="width:95px; top:810px; left:746px; height:16px"/>

<input type="text" name="det07" id="det07" style="width:250px; top:829px; left:486px; height:16px"/>
<input type="text" name="nar07" id="nar07" onkeyup="CiarkaNaBodku(this);" style="width:95px; top:829px; left:746px; height:16px"/>

<input type="text" name="det08" id="det08" style="width:250px; top:849px; left:486px; height:16px"/>
<input type="text" name="nar08" id="nar08" onkeyup="CiarkaNaBodku(this);" style="width:95px; top:849px; left:746px; height:16px"/>

<input type="text" name="det09" id="det09" style="width:250px; top:870px; left:486px; height:16px"/>
<input type="text" name="nar09" id="nar09" onkeyup="CiarkaNaBodku(this);" style="width:95px; top:870px; left:746px; height:16px"/>

<input type="text" name="det10" id="det10" style="width:250px; top:890px; left:486px; height:16px"/>
<input type="text" name="nar10" id="nar10" onkeyup="CiarkaNaBodku(this);" style="width:95px; top:890px; left:746px; height:16px"/>



<input type="text" name="datum" id="datum" onkeyup="CiarkaNaBodku(this);" style="width:110px; top:1179px; left:145px;" />
...
$pdf->Cell(20,5," ","$rmc1",0,"L");$pdf->Cell(28,4,"$hlavicka->zcdm","$rmc",0,"L");
$pdf->Cell(5,5," ","$rmc1",0,"L");$pdf->Cell(31,4,"$hlavicka->zpsc","$rmc",1,"L");
...
$pdf->Cell(5,3," ","$rmc1",0,"L");$pdf->Cell(60,6,"$datum","$rmc",1,"C");
