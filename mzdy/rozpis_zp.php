...
if( $statsum == 0 ) {
$pdf->Cell(115,6,"Rozpis odvodov do Zdravotnej Poisovne za $kli_vume","LTB",0,"L");
}
if( $statsum == 1 ) {
$pdf->Cell(135,6,"Rozpis odvodov do Zdravotnej Poisovne za $vyb_umep až $vyb_umek","LTB",0,"L");
}
