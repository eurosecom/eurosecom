...
//.jpg podklad
$jpg_source="../dokumenty/tlacivo2019/rz_ziadost/rz_ziadost_v19";
...
alert ("éiadosù bude pripraven· v priebehu janu·ra 2019. Aktu·lne info n·jdete na vstupnej str·nke v bode Novinky, tipy, triky.");
window.close();
</script>
<?php
exit;
...
$uplkup = 1*$_REQUEST['uplkup'];
$kupeur = 1*$_REQUEST['kupeur'];
$kupdet = 1*$_REQUEST['kupdet'];
$kupdem = 1*$_REQUEST['kupdem'];

$uprav="NO";

if ( $strana == 1 ) {
$uprtxt = "UPDATE F$kli_vxcf"."_rocneziadost SET uplkup='$uplkup', kupeur='$kupeur', kupdet='$kupdet', kupdem='$kupdem', ".
...
$upluro = 1*$_REQUEST['upluro'];
$uroeur = 1*$_REQUEST['uroeur'];
$urohyp = 1*$_REQUEST['urohyp'];
$uromes = 1*$_REQUEST['uromes'];
$urorok = 1*$_REQUEST['urorok'];

$uprav="NO";

if ( $strana == 2 ) {
$uprtxt = "UPDATE F$kli_vxcf"."_rocneziadost SET ".
" upluro='$upluro', uroeur='$uroeur', urohyp='$urohyp', uromes='$uromes', urorok='$urorok', ".
...
//zmeny2018
$sql = "SELECT uroeur FROM F$kli_vxcf"."_rocneziadost";
$vysledok = mysql_query("$sql");
if (!$vysledok)
{
$sql = "ALTER TABLE F$kli_vxcf"."_rocneziadost ADD new2018 DECIMAL(2,0) NOT NULL AFTER upldds";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_rocneziadost ADD uplkup DECIMAL(2,0) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_rocneziadost ADD kupeur DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_rocneziadost ADD kupdet DECIMAL(2,0) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_rocneziadost ADD upluro DECIMAL(2,0) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_rocneziadost ADD urohyp DECIMAL(2,0) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_rocneziadost ADD uromes DECIMAL(2,0) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_rocneziadost ADD uroeur DECIMAL(10,2) DEFAULT 0 AFTER new2018";
$vysledek = mysql_query("$sql");
}

//zmeny2019
$sql = "SELECT urorok FROM F$kli_vxcf"."_rocneziadost";
$vysledok = mysql_query("$sql");
if (!$vysledok)
{
$sql = "ALTER TABLE F$kli_vxcf"."_rocneziadost ADD new2019 DECIMAL(2,0) NOT NULL AFTER uplkup";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_rocneziadost ADD kupdem DECIMAL(10,2) DEFAULT 0 AFTER new2019";
$vysledek = mysql_query("$sql");
$sql = "ALTER TABLE F$kli_vxcf"."_rocneziadost ADD urorok DECIMAL(4,0) DEFAULT 0 AFTER new2019";
$vysledek = mysql_query("$sql");
}
...
$uplkup = $fir_riadok->uplkup;
$kupeur = $fir_riadok->kupeur;
$kupdet = $fir_riadok->kupdet;
$kupdem = $fir_riadok->kupdem;
                                       }
...
$upluro = $fir_riadok->upluro;
$uroeur = $fir_riadok->uroeur;
$uromes = $fir_riadok->uromes;
$urorok = $fir_riadok->urorok;
$urohyp = $fir_riadok->urohyp;
...
<div id="content">
<FORM name="formv1" method="post" action="rocne_ziadost2019.php?copern=23&cislo_oc=<?php echo $cislo_oc; ?>&strana=<?php echo $strana; ?>">
<?php
$clas1="noactive"; $clas2="noactive";
if ( $strana == 1 ) $clas1="active"; if ( $strana == 2 ) $clas2="active";
//$source="../mzdy/rocne_ziadost2019.php?cislo_oc=".$cislo_oc."&drupoh=1&subor=0";
?>
<div class="navbar">
...
<span class="text-echo" style="top:141px; left:485px;"><?php echo $kli_vrok; ?></span>

<!-- I.ZAMESTNANEC -->
<img src="../obr/ikony/pencil_blue_icon.png" onclick="UpravZamestnanca();" title="Upraviù ˙daje o zamestnancovi" class="btn-row-tool" style="top:246px; left:360px; width:16px; height:16px;">
<span class="text-echo" style="top:262px; left:120px;"><?php echo $zprie; ?></span>
<span class="text-echo" style="top:262px; left:410px;"><?php echo $zmeno; ?></span>
<span class="text-echo" style="top:262px; left:591px;"><?php echo $zrodne; ?></span>

<span class="text-echo" style="top:283px; left:248px;"><?php echo $ztitlp; ?></span>
<span class="text-echo" style="top:283px; left:648px;"><?php echo $ztitlz; ?></span>

<span class="text-echo" style="top:319px; left:163px;"><?php echo $zuli; ?></span>
<span class="text-echo" style="top:319px; left:595px;"><?php echo $zcdm; ?></span>
<span class="text-echo" style="top:319px; left:740px;"><?php echo $zpsc; ?></span>

<span class="text-echo" style="top:338px; left:163px;"><?php echo $zmes; ?></span>
<span class="text-echo" style="top:338px; left:670px;"><?php echo $zstat; ?></span>

<span class="text-echo" style="top:370px; left:120px;"><?php echo "$fir_fnaz, $fir_fuli $fir_fcdm, $fir_fmes"; ?></span>

<input type="checkbox" name="prisknczd" value="1" style="top:403px; left:805px;"/>
<input type="checkbox" name="docx" value="1" style="top:497px; left:805px;"/>

<!-- II-1.NCZD MANZEL/KA  -->
<input type="checkbox" name="uplman" value="1" style="top:637px; left:800px;"/>

<input type="text" name="manprie" id="manprie" style="width:265px; top:738px; left:115px;"/>
<input type="text" name="manmeno" id="manmeno" style="width:155px; top:738px; left:405px;"/>
<input type="text" name="manrodne" id="manrodne" style="width:110px; top:747px; left:583px; height:15px;"/>

<input type="text" name="manuli" id="manuli" style="width:220px; top:767px; left:154px; height:15px;"/>
<input type="text" name="mancdm" id="mancdm" style="width:101px; top:767px; left:565px; height:15px;"/>
<input type="text" name="manpsc" id="manpsc" style="width:83px; top:767px; left:715px; height:15px;"/>

<input type="text" name="manmes" id="manmes" style="width:380px; top:787px; left:155px; height:15px;"/>
<input type="text" name="manstat" id="manstat" style="width:230px; top:787px; left:595px; height:15px;"/>

<input type="text" name="manpes" id="manpes" style="width:41px; top:808px; left:790px; height:15px;"/>

<input type="text" name="maneur" id="maneur" onkeyup="CiarkaNaBodku(this);" style="width:181px; top:837px; left:555px;"/>

<!-- II-2.NCZD DOCHODOK  -->
<input type="checkbox" name="upldoc" value="1" style="top:895px; left:805px;"/>
<input type="text" name="doceur" id="doceur" onkeyup="CiarkaNaBodku(this);" style="width:170px; top:950px; left:574px;"/>

<!-- II-3.NCZD DDS -->
<input type="checkbox" name="upldds" value="1" style="top:1017px; left:802px;"/>
<input type="text" name="ddseur" id="ddseur" onkeyup="CiarkaNaBodku(this);" style="width:170px; top:1067px; left:574px;"/>

<!-- II-4.NCZD kupele new2018 uplkup, kupeur, kupdem-->
<input type="checkbox" name="uplkup" value="1" style="top:1137px; left:802px;"/>
<input type="text" name="kupeur" id="kupeur" onkeyup="CiarkaNaBodku(this);" style="width:170px; top:1190px; left:568px;"/>
<input type="text" name="kupdem" id="kupdem" onkeyup="CiarkaNaBodku(this);" style="width:170px; top:1220px; left:568px;"/>
...
<!-- III.BONUS -->
<input type="checkbox" name="bonus" value="1" style="top:106px; left:785px;"/>
<input type="text" name="det01" id="det01" style="width:190px; top:219px; left:116px; height:18px;"/>
<input type="text" name="rod01" id="rod01" style="width:88px; top:219px; left:310px; height:18px;"/>
<input type="text" name="mes01" id="mes01" style="width:63px; top:219px; left:409px; height:18px;"/>

<input type="text" name="det05" id="det05" style="width:190px; top:219px; left:484px; height:18px;"/>
<input type="text" name="rod05" id="rod05" style="width:90px; top:219px; left:677px; height:18px;"/>
<input type="text" name="mes05" id="mes05" style="width:61px; top:219px; left:779px; height:18px;"/>

<input type="text" name="det02" id="det02" style="width:190px; top:242px; left:116px; height:18px;"/>
<input type="text" name="rod02" id="rod02" style="width:88px; top:242px; left:310px; height:18px;"/>
<input type="text" name="mes02" id="mes02" style="width:63px; top:242px; left:409px; height:18px;"/>

<input type="text" name="det06" id="det06" style="width:190px; top:242px; left:484px; height:18px;"/>
<input type="text" name="rod06" id="rod06" style="width:90px; top:242px; left:677px; height:18px;"/>
<input type="text" name="mes06" id="mes06" style="width:61px; top:242px; left:779px; height:18px;"/>

<input type="text" name="det03" id="det03" style="width:190px; top:265px; left:116px; height:18px;"/>
<input type="text" name="rod03" id="rod03" style="width:88px; top:265px; left:310px; height:18px;"/>
<input type="text" name="mes03" id="mes03" style="width:63px; top:265px; left:409px; height:18px;"/>

<input type="text" name="det07" id="det07" style="width:190px; top:265px; left:484px; height:18px;"/>
<input type="text" name="rod07" id="rod07" style="width:90px; top:265px; left:677px; height:18px;"/>
<input type="text" name="mes07" id="mes07" style="width:61px; top:265px; left:779px; height:18px;"/>

<input type="text" name="det04" id="det04" style="width:190px; top:288px; left:116px; height:18px;"/>
<input type="text" name="rod04" id="rod04" style="width:88px; top:288px; left:310px; height:18px;"/>
<input type="text" name="mes04" id="mes04" style="width:63px; top:288px; left:409px; height:18px;"/>

<input type="text" name="det08" id="det08" style="width:190px; top:288px; left:484px; height:18px;"/>
<input type="text" name="rod08" id="rod08" style="width:90px; top:288px; left:677px; height:18px;"/>
<input type="text" name="mes08" id="mes08" style="width:61px; top:288px; left:779px; height:18px;"/>

<!-- IV.UROKY -->
<input type="checkbox" name="upluro" value="1" style="top:360px; left:792px;"/>
<input type="checkbox" name="urohyp" value="1" style="top:416px; left:792px;"/>
<input type="text" name="uromes" id="uromes" onkeyup="CiarkaNaBodku(this);" style="width:50px; top:473px; left:448px; height:18px;"/>
<input type="text" name="urorok" id="urorok" onkeyup="CiarkaNaBodku(this);" style="width:50px; top:473px; left:568px; height:18px;"/>
<input type="text" name="uroeur" id="uroeur" onkeyup="CiarkaNaBodku(this);" style="width:175px; top:504px; left:572px;"/>


<!-- V.POISTNE -->
<input type="checkbox" name="uplpoist" value="1" style="top:590px; left:788px;"/>
<input type="text" name="zappoistne" id="zappoistne" onkeyup="CiarkaNaBodku(this);" style="width:181px; top:629px; left:567px;"/>

<!-- VI.ZAM.PREMIA -->
<input type="checkbox" name="ziad5" value="1" style="top:715px; left:793px;"/>

<!-- VII.POTVRDENIE -->
<input type="checkbox" name="ziad9" value="1" style="top:832px; left:797px;"/>
<input type="text" name="ineuda" id="ineuda" style="width:58px; top:922px; left:229px; height:17px;"/>
<span class="text-echo" style="top:1176px; left:130px;"><?php echo $fir_fmes; ?></span>
<input type="text" name="datum" id="datum" onkeyup="CiarkaNaBodku(this);" onclick="dajDnes();" style="width:106px; top:1167px; left:380px;"/>
<?php                                        } ?>
...
//obdobie
$pdf->SetFont('arial','',8);
$pdf->Cell(15,5," ","$rmc1",0,"L");$pdf->Cell(190,5,"éIA38v19_1","$rmc1",1,"L");
$pdf->SetFont('arial','',10);
$pdf->Cell(190,11," ","$rmc1",1,"L");
$obdobie=$kli_vrok;
$pdf->Cell(92,4," ","$rmc1",0,"L");$pdf->Cell(14,6,"$kli_vrok","$rmc",1,"C");
...
$pdf->Cell(168,6," ","$rmc1",0,"L");$pdf->Cell(4,4,"$text","$rmc",1,"C");
...
$pdf->Cell(167.5,5," ","$rmc1",0,"L");$pdf->Cell(4,4,"$text","$rmc",1,"C");
...
$pdf->Cell(163,3," ","$rmc1",0,"L");$pdf->Cell(15,6,"$manpes","$rmc",1,"C");
...
$text=" "; if ( $uplkup == 1 ) { $text="x"; }
$pdf->Cell(168,5," ","$rmc1",0,"L");$pdf->Cell(3,3,"$text","$rmc",1,"C");

$pdf->Cell(191,2.5," ","$rmc1",1,"L");
$hodx=1*$kupdem;
if ( $hodx == 0 ) $hodx="";
$pdf->Cell(72,5," ","$rmc1",0,"L");$pdf->Cell(3,3,"$hodx","$rmc",1,"C");

$pdf->Cell(191,4," ","$rmc1",1,"L");
$hodx=100*$kupeur;
if ( $hodx == 0 ) $hodx="";
$text=sprintf("% 6s",$hodx);
$t01=substr($text,0,1);
...
$t05=substr($text,4,1);
$t06=substr($text,5,1);
$pdf->Cell(117,6," ","$rmc1",0,"R");
$pdf->Cell(5,4,"$t01","$rmc",0,"C");$pdf->Cell(6,4,"$t02","$rmc",0,"C");$pdf->Cell(5,4,"$t03","$rmc",0,"C");
$pdf->Cell(5,4,"$t04","$rmc",0,"C");
$pdf->Cell(6,6," ","$rmc1",0,"C");$pdf->Cell(5,4,"$t05","$rmc",0,"C");$pdf->Cell(6,4,"$t06","$rmc",1,"C");

$pdf->Cell(191,2," ","$rmc1",1,"L");
$hodx=100*$kupdem;
if ( $hodx == 0 ) $hodx="";
$text=sprintf("% 6s",$hodx);
$t01=substr($text,0,1);
...
$pdf->Cell(166,5," ","$rmc1",0,"L");$pdf->Cell(4,3,"$text","$rmc",1,"C");
$pdf->SetFont('arial','',9);
...
$pdf->Cell(45,5,"$det05","$rmc",0,"L");$pdf->Cell(20,5,"$rod05","$rmc",0,"C");$pdf->Cell(16,5,"$mes05","$rmc",1,"L");
$pdf->Cell(190,0.5," ","$rmc1",1,"L");
$pdf->Cell(17,5," ","$rmc1",0,"L");
...
$pdf->Cell(45,5.5,"$det08","$rmc",0,"L");$pdf->Cell(20,5.5,"$rod08","$rmc",0,"C");$pdf->Cell(16,5.5,"$mes08","$rmc",1,"L");
$pdf->Cell(17,5," ","$rmc1",0,"L");
$pdf->SetFont('arial','',10);
...
//IV.UROKY
$pdf->Cell(190,11," ","$rmc1",1,"L");
$text=" "; if ( $upluro == 1 ) { $text="x"; }
$pdf->Cell(168,5," ","$rmc1",0,"L");$pdf->Cell(3,3,"$text","$rmc",1,"C");

$pdf->Cell(190,9.5," ","$rmc1",1,"L");
$text=" "; if ( $urohyp == 1 ) { $text="x"; }
$pdf->Cell(168,5," ","$rmc1",0,"L");$pdf->Cell(3,3,"$text","$rmc",1,"C");

$pdf->Cell(191,11.5," ","$rmc1",1,"L");
$hodx=1*$uromes.".";
if ( $hodx == 0 ) $hodx="";
$pdf->Cell(97,5," ","$rmc1",0,"L");$pdf->Cell(3,3,"$hodx","$rmc",0,"C");
$hodx=1*$urorok;
if ( $hodx == 0 ) $hodx="";
$pdf->Cell(21,5," ","$rmc1",0,"L");$pdf->Cell(3,3,"$hodx","$rmc",1,"C");

$pdf->Cell(191,4.5," ","$rmc1",1,"L");
$hodx=100*$uroeur;
if ( $hodx == 0 ) $hodx="";
$text=sprintf("% 6s",$hodx);
$t01=substr($text,0,1);
...
//V.POISTNE
$pdf->Cell(190,13.5," ","$rmc1",1,"L");
$text=" "; if ( $uplpoist == 1 ) { $text="x"; }
$pdf->Cell(167,5," ","$rmc1",0,"L");$pdf->Cell(4,3.5,"$text","$rmc",1,"C");
//
...
$t05=substr($text,4,1);
$t06=substr($text,5,1);
$pdf->Cell(117.5,6," ","$rmc1",0,"R");$pdf->Cell(6,5,"$t01","$rmc",0,"C");$pdf->Cell(6,5,"$t02","$rmc",0,"C");$pdf->Cell(5,5,"$t03","$rmc",0,"C");
...
$pdf->Cell(168,5," ","$rmc1",0,"L");$pdf->Cell(4,3.5,"$text","$rmc",1,"C");
...
<?php if ( $uplkup == 1 ) { ?> document.formv1.uplkup.checked = "checked"; <?php } ?>
   document.formv1.kupeur.value = '<?php echo $kupeur; ?>';
   document.formv1.kupdem.value = '<?php echo $kupdem; ?>';
<?php                                        } ?>
...
<?php if ( $upluro == 1 ) { ?> document.formv1.upluro.checked = "checked"; <?php } ?>
<?php if ( $urohyp == 1 ) { ?> document.formv1.urohyp.checked = "checked"; <?php } ?>
   document.formv1.uroeur.value = '<?php echo $uroeur; ?>';
   document.formv1.uromes.value = '<?php echo $uromes; ?>';
   document.formv1.urorok.value = '<?php echo $urorok; ?>';
<?php                                        } ?>
  }
<?php
//koniec uprava
...
//Z ciarky na bodku
  ...
  function prevOC()
  {
   window.open('rocne_ziadost2019.php?copern=20&drupoh=1&page=1&subor=0&cislo_oc=<?php echo $prev_oc; ?>', '_self');
  }
  function nextOC()
  {
   window.open('rocne_ziadost2019.php?copern=20&drupoh=1&page=1&subor=0&cislo_oc=<?php echo $next_oc; ?>', '_self');
  }
  function TlacZiadostRZ()
  {
   window.open('../mzdy/rocne_ziadost2019.php?cislo_oc=<?php echo $cislo_oc;?>&copern=10&drupoh=1&page=1&subor=0&strana=9999', '_blank', 'width=1050, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes');
  }
  function reNacitajMzdy()
  {
   window.open('../mzdy/rocne_ziadost2019.php?cislo_oc=<?php echo $cislo_oc;?>&copern=26&drupoh=1&page=1&subor=0', '_self', 'width=1050, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes');
  }
  ...
  {
   window.open('<?php echo $jpg_source; ?>_poucenie.pdf', '_blank', 'scrollbars=yes, resizable=yes, top=0, left=0, width=1080, height=900');
  }
  function editForm(strana)
  {
    window.open('rocne_ziadost2019.php?cislo_oc=<?php echo $cislo_oc; ?>&copern=20&strana=' + strana + '&drupoh=1&subor=0', '_self');
  }
  function FormPDF(strana)
  {
    window.open('rocne_ziadost2019.php?cislo_oc=<?php echo $cislo_oc; ?>&copern=10&strana=' + strana + '&drupoh=1&subor=0', '_blank', blank_param);
  }
  function dajDnes()
  {
