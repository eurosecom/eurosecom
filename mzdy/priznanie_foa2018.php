...
//zmeny pre rok 2018
$sql = "SELECT uzhr FROM F".$kli_vxcf."_mzdpriznanie_foa";
$vysledok = mysql_query($sql);
if ( !$vysledok )
{
...
//vypocty nie su aktualizovane vsetky na 2018
//$prepoc=0;
$alertprepocet="";
...
<input type="text" name="r39" id="r39" onkeyup="CiarkaNaBodku(this);" style="width:151px; top:367px; left:570px;"/>
 <img src="../obr/ikony/calculator_blue_icon.png" onclick="nezdanitelna();"
      title="Doplniù odpoËet na daÚovnÌka a zohæadniù milion·rsku daÚ" class="btn-row-tool" style="top:367px; left:736px;">
...
<input type="text" name="r40" id="r40" onkeyup="CiarkaNaBodku(this);" style="width:151px; top:407px; left:570px;"/>
 <img src="../obr/ikony/calculator_blue_icon.png" onclick="namanzelku();"
      title="Doplniù odpoËet na manûelku a zohæadniù milion·rsku daÚ" class="btn-row-tool" style="top:407px; left:736px;">
