...
<a href="#" onClick="ulozPol();"> Chcete uloûiù nastavenie programovan˝ch poloûiek ?</a></td></tr>

<tr><td class='ponuka' colspan='1'><input type='checkbox' name='ajstravne' value='1' > StravnÈ lÌstky </td></tr>

<tr><td class='ponuka' colspan='5'><input type='checkbox' name='premie' value='1' > PrÈmie z dm 101 aû 107 v mesaËnej d·vke, ak v ˙dajoch o zamestnancovi sz1 > 0, percento prÈmiÌ = sz3</tr>
