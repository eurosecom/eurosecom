...
<span class="text-echo" style="top:74px; left:401px;"><?php echo "$fdic"; ?></span> <!-- dopyt, bude asi in· premenn· -->
...
<input type="checkbox" name="zslu" value="1" style="top:543px; left:59px;"/> <!-- dopyt, novinka, please vytvoriù -->
