...
if ( $rok == 4 ) $roks="štyri roky ";
if ( $rok == 5 ) $roks="pä rokov ";
if ( $rok == 6 ) $roks="šes ";
if ( $rok == 7 ) $roks="sedem ";
if ( $rok == 8 ) $roks="osem ";
if ( $rok == 9 ) $roks="devä ";
if ( $rok == 10 ) $roks="desa ";
if ( $rok == 11 ) $roks="jedenás ";
if ( $rok == 12 ) $roks="dvanás ";
if ( $rok == 13 ) $roks="trinás ";
if ( $rok == 14 ) $roks="štrnás ";
if ( $rok == 15 ) $roks="pätnás ";
if ( $rok == 16 ) $roks="šestnás ";
if ( $rok == 17 ) $roks="sedemnás ";
if ( $rok == 18 ) $roks="osemnás ";
if ( $rok == 19 ) $roks="devätnás ";
if ( $rok == 20 ) $roks="dvadsa ";
if ( $rok == 21 ) $roks="dvadsajeden ";
if ( $rok == 22 ) $roks="dvadsadva ";
if ( $rok == 23 ) $roks="dvadsatri ";
if ( $rok == 24 ) $roks="dvadsaštyri ";
if ( $rok == 25 ) $roks="dvadsapä ";
if ( $rok == 26 ) $roks="dvadsašes ";
if ( $rok == 27 ) $roks="dvadsasedem ";
if ( $rok == 28 ) $roks="dvadsaosem ";
if ( $rok == 29 ) $roks="dvadsadevä ";
if ( $rok > 5 ) $roks=$roks."rokov ";

if ( $dni == 0 ) $dnis="nula dní";
if ( $dni == 1 ) $dnis="jeden deò ";
if ( $dni == 2 ) $dnis="dva dni ";
if ( $dni == 3 ) $dnis="tri dni ";
if ( $dni == 4 ) $dnis="štyri dni ";
if ( $dni == 5 ) $dnis="pä dní ";
if ( $dni == 6 ) $dnis="šes ";
if ( $dni == 7 ) $dnis="sedem ";
if ( $dni == 8 ) $dnis="osem ";
if ( $dni == 9 ) $dnis="devä ";
if ( $dni == 10 ) $dnis="desa ";
if ( $dni == 11 ) $dnis="jedenás ";
if ( $dni == 12 ) $dnis="dvanás ";
if ( $dni == 13 ) $dnis="trinás ";
if ( $dni == 14 ) $dnis="štrnás ";
if ( $dni == 15 ) $dnis="pätnás ";
if ( $dni == 16 ) $dnis="šestnás ";
if ( $dni == 17 ) $dnis="sedemnás ";
if ( $dni == 18 ) $dnis="osemnás ";
if ( $dni == 19 ) $dnis="devätnás ";
...
if ( $stovky == 4 ) $dnis="štyristo";

if ( $desiatky == 0 ) $dnis=$dnis."";
if ( $desiatky == 1 AND $x1119 == 0 ) $dnis=$dnis."desa";
if ( $desiatky == 2 ) $dnis=$dnis."dvadsa";
if ( $desiatky == 3 ) $dnis=$dnis."tridsa";
if ( $desiatky == 4 ) $dnis=$dnis."štyridsa";
if ( $desiatky == 5 ) $dnis=$dnis."pädesiat";
if ( $desiatky == 6 ) $dnis=$dnis."šesdesiat";
if ( $desiatky == 7 ) $dnis=$dnis."sedemdesiat";
if ( $desiatky == 8 ) $dnis=$dnis."osemdesiat";
if ( $desiatky == 9 ) $dnis=$dnis."devädesiat";
...
if ( $jednotky == 4 ) $dnis=$dnis."štyri";
if ( $jednotky == 5 ) $dnis=$dnis."pä";
if ( $jednotky == 6 ) $dnis=$dnis."šes";
if ( $jednotky == 7 ) $dnis=$dnis."sedem";
if ( $jednotky == 8 ) $dnis=$dnis."osem";
if ( $jednotky == 9 ) $dnis=$dnis."devä";
}
if ( $x1119 == 1 )
{
if ( $od11do19 == 11 ) $dnis=$dnis."jedenás ";
if ( $od11do19 == 12 ) $dnis=$dnis."dvanás ";
if ( $od11do19 == 13 ) $dnis=$dnis."trinás ";
if ( $od11do19 == 14 ) $dnis=$dnis."štrnás ";
if ( $od11do19 == 15 ) $dnis=$dnis."pätnás ";
if ( $od11do19 == 16 ) $dnis=$dnis."šestnás ";
if ( $od11do19 == 17 ) $dnis=$dnis."sedemnás ";
if ( $od11do19 == 18 ) $dnis=$dnis."osemnás ";
if ( $od11do19 == 19 ) $dnis=$dnis."devätnás ";
}

if ( $dni > 5 ) $dnis=$dnis." dní ";
$dnis="a ".$dnis;
...
<title>EuroSecom - Zápoètový list</title>
<style type="text/css">
div.navbar {
  overflow: auto;
  width: 100%;
...
<div id="wrap-heading">
 <table id="heading">
  ...
  <tr>
   <td class="header">Zápoètový list - <span class="subheader"><?php echo "$oc $meno $prie";?></span>
<?php if ( $novy == 0 ) { ?>
