...
<?php if ( $strana == 1 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfoa2014/dpfoa_v14-1.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ A pre rok 2013 1.strana 282kB" class="form-background">
...
<img src="../dokumenty/dan_z_prijmov2014/dpfoa2014/dpfoa_v14-2.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ A pre rok 2013 2.strana 250kB" class="form-background">
...
<?php if ( $strana == 3 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfoa2014/dpfoa_v14-3.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ A pre rok 2013 3.strana 250kB" class="form-background">
<?php $tlacrdk="$hrdc / $hrdk"; if( $tlacrdk == "0 / " ) { $tlacrdk=""; } ?>
<input type="text" name="fir_fdic" id="fir_fdic" value="<?php echo "$tlacrdk"; ?>" disabled="disabled" class="nofill" style="width:242px; top:68px; left:357px;"/>
...
<input type="text" name="r45" id="r45" onkeyup="CiarkaNaBodku(this);" style="width:129px; top:538px; left:591px;"/>
 <img src="../obr/ikony/calculator_blue_icon.png" onclick="zamestnanecka();" title="Doplniù zamestnaneck˙ prÈmiu" class="btn-row-tool" style="top:539px; left:736px;">
...
<?php if ( $strana == 4 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfoa2014/dpfoa_v14-4.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ A pre rok 2013 4.strana 250kB" class="form-background">
<?php $tlacrdk="$hrdc / $hrdk"; if( $tlacrdk == "0 / " ) { $tlacrdk=""; } ?>
<input type="text" name="fir_fdic" id="fir_fdic" value="<?php echo "$tlacrdk"; ?>" disabled="disabled" class="nofill" style="width:242px; top:68px; left:357px;"/>
...
<?php if ( $strana == 5 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfoa2014/dpfoa_v14-5.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ A pre rok 2013 5.strana 250kB" class="form-background">
<?php $tlacrdk="$hrdc / $hrdk"; if( $tlacrdk == "0 / " ) { $tlacrdk=""; } ?>
<input type="text" name="fir_fdic" id="fir_fdic" value="<?php echo "$tlacrdk"; ?>" disabled="disabled" class="nofill" style="width:242px; top:68px; left:357px;"/>
...
<?php if ( $strana == 6 OR $strana == 9999 ) { ?>
<img src="../dokumenty/dan_z_prijmov2014/dpfoa2014/dpfoa_v14-6.jpg" alt="tlaËivo DaÚ z prÌjmov FO typ A pre rok 2013 6.strana 250kB" class="form-background">
<?php $tlacrdk="$hrdc / $hrdk"; if( $tlacrdk == "0 / " ) { $tlacrdk=""; } ?>
<input type="text" name="fir_fdic" id="fir_fdic" value="<?php echo "$tlacrdk"; ?>" disabled="disabled" class="nofill" style="width:242px; top:68px; left:357px;"/>
