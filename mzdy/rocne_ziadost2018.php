...
//.jpg podklad
$jpg_source="../dokumenty/tlacivo2018/dan_zo_zavislej_v18/rz/rz_ziadost_v18";
...
if ( $strana == 1 ) {
$uprtxt = "UPDATE F$kli_vxcf"."_rocneziadost SET uplkup='$uplkup', kupeur='$kupeur', kupdet='$kupdet', ".
...
" upluro='$upluro', uroeur='$uroeur', urohyp='$urohyp', uromes='$uromes', ".
...
<div id="content">
<FORM name="formv1" method="post" action="rocne_ziadost2018.php?copern=23&cislo_oc=<?php echo $cislo_oc; ?>&strana=<?php echo $strana; ?>">
<?php
$clas1="noactive"; $clas2="noactive";
if ( $strana == 1 ) $clas1="active"; if ( $strana == 2 ) $clas2="active";
//$source="../mzdy/rocne_ziadost2018.php?cislo_oc=".$cislo_oc."&drupoh=1&subor=0";
?>
<div class="navbar">
...
<span class="text-echo" style="top:296px; left:248px;"><?php echo $ztitlp; ?></span>
<span class="text-echo" style="top:296px; left:648px;"><?php echo $ztitlz; ?></span>

<span class="text-echo" style="top:332px; left:163px;"><?php echo $zuli; ?></span>
<span class="text-echo" style="top:332px; left:595px;"><?php echo $zcdm; ?></span>
<span class="text-echo" style="top:332px; left:740px;"><?php echo $zpsc; ?></span>

<span class="text-echo" style="top:351px; left:163px;"><?php echo $zmes; ?></span>
<span class="text-echo" style="top:351px; left:670px;"><?php echo $zstat; ?></span>

<span class="text-echo" style="top:382px; left:120px;"><?php echo "$fir_fnaz, $fir_fuli $fir_fcdm, $fir_fmes"; ?></span>

<input type="checkbox" name="prisknczd" value="1" style="top:415px; left:805px;"/>
<input type="checkbox" name="docx" value="1" style="top:485px; left:805px;"/>

<!-- II-1.NCZD MANZEL/KA  -->
<input type="checkbox" name="uplman" value="1" style="top:618px; left:811px;"/>

<input type="text" name="manprie" id="manprie" style="width:265px; top:714px; left:120px;"/>
<input type="text" name="manmeno" id="manmeno" style="width:155px; top:714px; left:410px;"/>
<input type="text" name="manrodne" id="manrodne" style="width:110px; top:723px; left:588px; height:15px;"/>

<input type="text" name="manuli" id="manuli" style="width:220px; top:744px; left:159px; height:15px;"/>
<input type="text" name="mancdm" id="mancdm" style="width:101px; top:744px; left:570px; height:15px;"/>
<input type="text" name="manpsc" id="manpsc" style="width:83px; top:744px; left:720px; height:15px;"/>

<input type="text" name="manmes" id="manmes" style="width:380px; top:765px; left:160px; height:15px;"/>
<input type="text" name="manstat" id="manstat" style="width:230px; top:765px; left:600px; height:15px;"/>

<input type="text" name="manpes" id="manpes" style="width:41px; top:785px; left:797px; height:15px;"/>

<input type="text" name="maneur" id="maneur" onkeyup="CiarkaNaBodku(this);" style="width:181px; top:815px; left:555px;"/>

<!-- II-2.NCZD DOCHODOK  -->
<input type="checkbox" name="upldoc" value="1" style="top:870px; left:805px;"/>
<input type="text" name="doceur" id="doceur" onkeyup="CiarkaNaBodku(this);" style="width:170px; top:925px; left:574px;"/>

<!-- II-3.NCZD DDS -->
<input type="checkbox" name="upldds" value="1" style="top:990px; left:802px;"/>
<input type="text" name="ddseur" id="ddseur" onkeyup="CiarkaNaBodku(this);" style="width:170px; top:1035px; left:574px;"/>

<!-- II-4.NCZD kupele new2018 uplkup, kupeur, kupdet-->
<input type="checkbox" name="uplkup" value="1" style="top:1105px; left:802px;"/>
<input type="text" name="kupdet" id="kupdet" onkeyup="CiarkaNaBodku(this);" style="width:30px; top:1130px; left:358px; height:15px;"/>
<input type="text" name="kupeur" id="kupeur" onkeyup="CiarkaNaBodku(this);" style="width:170px; top:1215px; left:568px;"/>
...
<!-- III.BONUS -->
<input type="checkbox" name="bonus" value="1" style="top:155px; left:785px;"/>
<input type="text" name="det01" id="det01" style="width:190px; top:269px; left:116px; height:18px;"/>
<input type="text" name="rod01" id="rod01" style="width:88px; top:269px; left:310px; height:18px;"/>
<input type="text" name="mes01" id="mes01" style="width:63px; top:269px; left:409px; height:18px;"/>

<input type="text" name="det05" id="det05" style="width:190px; top:269px; left:484px; height:18px;"/>
<input type="text" name="rod05" id="rod05" style="width:90px; top:269px; left:677px; height:18px;"/>
<input type="text" name="mes05" id="mes05" style="width:61px; top:269px; left:779px; height:18px;"/>

<input type="text" name="det02" id="det02" style="width:190px; top:292px; left:116px; height:18px;"/>
<input type="text" name="rod02" id="rod02" style="width:88px; top:292px; left:310px; height:18px;"/>
<input type="text" name="mes02" id="mes02" style="width:63px; top:292px; left:409px; height:18px;"/>

<input type="text" name="det06" id="det06" style="width:190px; top:292px; left:484px; height:18px;"/>
<input type="text" name="rod06" id="rod06" style="width:90px; top:292px; left:677px; height:18px;"/>
<input type="text" name="mes06" id="mes06" style="width:61px; top:292px; left:779px; height:18px;"/>

<input type="text" name="det03" id="det03" style="width:190px; top:315px; left:116px; height:18px;"/>
<input type="text" name="rod03" id="rod03" style="width:88px; top:315px; left:310px; height:18px;"/>
<input type="text" name="mes03" id="mes03" style="width:63px; top:315px; left:409px; height:18px;"/>

<input type="text" name="det07" id="det07" style="width:190px; top:315px; left:484px; height:18px;"/>
<input type="text" name="rod07" id="rod07" style="width:90px; top:315px; left:677px; height:18px;"/>
<input type="text" name="mes07" id="mes07" style="width:61px; top:315px; left:779px; height:18px;"/>

<input type="text" name="det04" id="det04" style="width:190px; top:338px; left:116px; height:18px;"/>
<input type="text" name="rod04" id="rod04" style="width:88px; top:338px; left:310px; height:18px;"/>
<input type="text" name="mes04" id="mes04" style="width:63px; top:338px; left:409px; height:18px;"/>

<input type="text" name="det08" id="det08" style="width:190px; top:338px; left:484px; height:18px;"/>
<input type="text" name="rod08" id="rod08" style="width:90px; top:338px; left:677px; height:18px;"/>
<input type="text" name="mes08" id="mes08" style="width:61px; top:338px; left:779px; height:18px;"/>

<!-- IV.UROKY -->
<input type="checkbox" name="upluro" value="1" style="top:408px; left:792px;"/>
<input type="checkbox" name="urohyp" value="1" style="top:464px; left:792px;"/>
<input type="text" name="uromes" id="uromes" onkeyup="CiarkaNaBodku(this);" style="width:108px; top:523px; left:378px; height:18px;"/>
<input type="text" name="uroeur" id="uroeur" onkeyup="CiarkaNaBodku(this);" style="width:175px; top:554px; left:572px;"/>


<!-- V.POISTNE -->
<input type="checkbox" name="uplpoist" value="1" style="top:638px; left:788px;"/>
<input type="text" name="zappoistne" id="zappoistne" onkeyup="CiarkaNaBodku(this);" style="width:181px; top:679px; left:567px;"/>

<!-- VI.ZAM.PREMIA -->
<input type="checkbox" name="ziad5" value="1" style="top:765px; left:793px;"/>

<!-- VII.POTVRDENIE -->
<input type="checkbox" name="ziad9" value="1" style="top:880px; left:797px;"/>
<input type="text" name="ineuda" id="ineuda" style="width:58px; top:971px; left:229px; height:17px;"/>
<span class="text-echo" style="top:1200px; left:130px;"><?php echo $fir_fmes; ?></span>
<input type="text" name="datum" id="datum" onkeyup="CiarkaNaBodku(this);" onclick="dajDnes();" style="width:106px; top:1197px; left:380px;"/>
<?php                                        } ?>
...
$hodx=1*$uromes.".";
if ( $hodx == 0 ) $hodx="";
$pdf->Cell(86,5," ","$rmc1",0,"L");$pdf->Cell(3,3,"$hodx","$rmc",1,"C");
...
<?php if ( $uplkup == 1 ) { ?> document.formv1.uplkup.checked = "checked"; <?php } ?>
   ...
   document.formv1.kupdet.value = '<?php echo $kupdet; ?>';
<?php                                        } ?>
...
//Z ciarky na bodku
  ...
  function prevOC()
  {
   window.open('rocne_ziadost2018.php?copern=20&drupoh=1&page=1&subor=0&cislo_oc=<?php echo $prev_oc; ?>', '_self');
  }
  function nextOC()
  {
   window.open('rocne_ziadost2018.php?copern=20&drupoh=1&page=1&subor=0&cislo_oc=<?php echo $next_oc; ?>', '_self');
  }
  function TlacZiadostRZ()
  {
   window.open('../mzdy/rocne_ziadost2018.php?cislo_oc=<?php echo $cislo_oc;?>&copern=10&drupoh=1&page=1&subor=0&strana=9999', '_blank', 'width=1050, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes');
  }
  function reNacitajMzdy()
  {
   window.open('../mzdy/rocne_ziadost2018.php?cislo_oc=<?php echo $cislo_oc;?>&copern=26&drupoh=1&page=1&subor=0', '_self', 'width=1050, height=900, top=0, left=20, status=yes, resizable=yes, scrollbars=yes');
  }
  ...
  {
    window.open('rocne_ziadost2018.php?cislo_oc=<?php echo $cislo_oc; ?>&copern=20&strana=' + strana + '&drupoh=1&subor=0', '_self');
  }
  function FormPDF(strana)
  {
    window.open('rocne_ziadost2018.php?cislo_oc=<?php echo $cislo_oc; ?>&copern=10&strana=' + strana + '&drupoh=1&subor=0', '_blank', blank_param);
  }
  function dajDnes()
  {
