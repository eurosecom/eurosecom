...
//Z ciarky na bodku
  ...
  function TlacVykaz()
  {
   window.open('../mzdy/stat_praca204.php?copern=11&drupoh=1&page=1&typ=PDF&strana=9999', '_blank', 'width=1080, height=900, top=0, left=30, status=yes, resizable=yes, scrollbars=yes');
  }
  function UdajeFirma()
  {
