...
<?php                            } ?>
  ...
  function upravRZ()
  {
   window.open('../mzdy/rocne_dane2014.php?cislo_oc=<?php echo $oc; ?>&copern=20&drupoh=1&page=1&subor=0', '_blank', 'width=1080, height=900, top=0, left=30, status=yes, resizable=yes, scrollbars=yes');
  }
  function nacitajRZ()
  {
...
<?php $dnessk = Date ("d.m.Y", MkTime (date("H"),date("i"),date("s"),date("m"),date("d"),date("Y"))); ?>
  ...
  function upravOC(oc)
  {
   window.open('hlasenie_daneoc2014.php?copern=102&oc='+ oc + '&drupoh=<?php echo $drupoh;?>&uprav=1', '_self');
  }
  function zmazOC(oc)
  {
   window.open('hlasenie_daneoc2014.php?copern=502&cislo_oc='+ oc + '&drupoh=<?php echo $drupoh;?>&uprav=1', '_self');
  }
//new zamestnanec
  function rozninewoc()
  { 
  ...
  function uloznewoc()
  {
   ...
   window.open('hlasenie_daneoc2014.php?copern=2500&cislo_ocn='+ ocn + '&drupoh=<?php echo $drupoh;?>&uprav=1', '_self');
  }
</script>
</HEAD>
<BODY onload="ObnovUI();">
...
<FORM name="formv1" method="post" action="hlasenie_daneoc2014.php?copern=102">
 <table class="zoznam">
 <thead>
 <tr>
...
if ( $copern == 102 )
     {
?>
<FORM name="formv1" method="post" action="hlasenie_daneoc2014.php?copern=103">
