...
<select size="1" name="tz1" id="tz1" class="btn-rzstav" style="top:147px; left:559px; height:20px;">
 <option value="0">&nbsp;Nevykonal roËnÈ z˙Ëtovanie&nbsp;&nbsp;</option>
 <option value="1">&nbsp;Vykonal roËnÈ z˙Ëtovanie</option>
</select>
...
<img src='../obr/ikony/download_blue_icon.png' onclick="nacitajRZ();"
     title="NaËÌtaù ˙daje z roËnÈho z˙Ëtovania" class="btn-row-tool" style="top:680px; left:385px;">
