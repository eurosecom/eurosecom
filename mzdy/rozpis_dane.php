...
<title>Rozpis Dane z príjmu</title>
  <style type="text/css">
...
" WHERE F$kli_vxcf"."_mzdprcvypl".$kli_uzid.".oc >= 0 ORDER BY konx,prie,meno";
...
$pdf->Cell(115,6,"Rozpis Dane z príjmov za $kli_vume","LTB",0,"L");
...
if( $rtov->konx == 8 ) $j=0; //nova strana;
  }
