...
//copern=20 zostava prijmu z informacii
...
" SELECT 0,ume,dat,skl,dok,poh,ico,fak,str,zak,cis,mno,cen,(mno*cen),'0','0',(mno*cen),'0','0' FROM F$kli_vxcf"."_sklpri WHERE ( cis > 0 AND ume < $vyb_ume )".
" ORDER BY skl,dok".
"";
...
<title>Zostava príjmu PDF</title>
  <style type="text/css">
...
if ( $copern == 10 )  { $pdf->Cell(90,6,"Zostava príjmu za $kli_vume ","LTB",0,"L"); }
