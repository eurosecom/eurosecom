...
" SELECT ume,dat,skl,poh,cis,mno,cen,(mno*cen),'0','0','0','0',(mno*cen) FROM F$kli_vxcf"."_sklpoc WHERE NOT ( cis = 0 )".
" ORDER BY skl,poh,cis,cen".
"";
$dsql = mysql_query("$dsqlt");
//prijem minuly
$dsqlt = "INSERT INTO F$kli_vxcf"."_sklprc".
" SELECT ume,dat,skl,poh,cis,mno,cen,(mno*cen),'0','0','0','0',(mno*cen) FROM F$kli_vxcf"."_sklpri WHERE ( cis > 0 AND $podm_poc )".
" ORDER BY skl,poh,cis,cen".
"";
$dsql = mysql_query("$dsqlt");
//vydaj minuly
$dsqlt = "INSERT INTO F$kli_vxcf"."_sklprc".
" SELECT ume,dat,skl,poh,cis,mno,cen,-(mno*cen),'0','0','0','0',-(mno*cen) FROM F$kli_vxcf"."_sklvyd WHERE ( cis > 0 AND $podm_poc )".
" ORDER BY skl,poh,cis,cen".
"";
$dsql = mysql_query("$dsqlt");
//faktury minuly
$dsqlt = "INSERT INTO F$kli_vxcf"."_sklprc".
" SELECT ume,dat,skl,poh,cis,mno,cen,-(mno*cen),'0','0','0','0',-(mno*cen) FROM F$kli_vxcf"."_sklfak WHERE ( cis > 0 AND $podm_poc )".
" ORDER BY skl,poh,cis,cen".
"";
$dsql = mysql_query("$dsqlt");
//presun- minuly
$dsqlt = "INSERT INTO F$kli_vxcf"."_sklprc".
" SELECT ume,dat,skl,poh,cis,mno,cen,-(mno*cen),'0','0','0','0',-(mno*cen) FROM F$kli_vxcf"."_sklpre WHERE ( cis > 0 AND $podm_poc )".
" ORDER BY skl,poh,cis,cen".
"";
$dsql = mysql_query("$dsqlt");
//presun+ minuly
$dsqlt = "INSERT INTO F$kli_vxcf"."_sklprc".
" SELECT ume,dat,sk2,poh,cis,mno,cen,(mno*cen),'0','0','0','0',(mno*cen) FROM F$kli_vxcf"."_sklpre WHERE ( cis > 0 AND $podm_poc )".
" ORDER BY skl,poh,cis,cen".
"";
$dsql = mysql_query("$dsqlt");
...
//prijem mesiaca
$dsqlt = "INSERT INTO F$kli_vxcf"."_sklprc".
" SELECT ume,dat,skl,poh,cis,mno,cen,(mno*cen),'0','0','0',(mno*cen),'0' FROM F$kli_vxcf"."_sklpri WHERE ( cis > 0 AND $podm_obd )".
" ORDER BY skl,poh,cis,cen".
"";
$dsql = mysql_query("$dsqlt");
...
//vydaj mesiaca
$dsqlt = "INSERT INTO F$kli_vxcf"."_sklprc".
" SELECT ume,dat,skl,poh,cis,mno,cen,-(mno*cen),'0','0',-(mno*cen),'0','0' FROM F$kli_vxcf"."_sklvyd WHERE ( cis > 0 AND $podm_obd )".
" ORDER BY skl,poh,cis,cen".
"";
$dsql = mysql_query("$dsqlt");
...
//faktury mesiaca
$dsqlt = "INSERT INTO F$kli_vxcf"."_sklprc".
" SELECT ume,dat,skl,poh,cis,mno,cen,-(mno*cen),'0',-(mno*cen),'0','0','0' FROM F$kli_vxcf"."_sklfak WHERE ( cis > 0 AND $podm_obd )".
" ORDER BY skl,poh,cis,cen".
"";
$dsql = mysql_query("$dsqlt");
...
//presun- mesiaca
$dsqlt = "INSERT INTO F$kli_vxcf"."_sklprc".
" SELECT ume,dat,skl,poh,cis,mno,cen,-(mno*cen),-(mno*cen),'0','0','0','0' FROM F$kli_vxcf"."_sklpre WHERE ( cis > 0 AND $podm_obd )".
" ORDER BY skl,poh,cis,cen".
"";
$dsql = mysql_query("$dsqlt");
...
//presun+ mesiaca
$dsqlt = "INSERT INTO F$kli_vxcf"."_sklprc".
" SELECT ume,dat,sk2,poh,cis,mno,cen,(mno*cen),(mno*cen),'0','0','0','0' FROM F$kli_vxcf"."_sklpre WHERE ( cis > 0 AND $podm_obd )".
" ORDER BY skl,poh,cis,cen".
"";
$dsql = mysql_query("$dsqlt");
...
" SELECT ume,dat,skl,poh,cis,mno,cen,SUM(zas),SUM(prs),SUM(pdj),SUM(vdj),SUM(prj),SUM(pcs) FROM F$kli_vxcf"."_sklprc ".
" GROUP BY skl,poh".
"";
...
if ( $copern == 10 OR $copern == 20 )
  {
$sqlt = "SELECT F$kli_vxcf"."_sklprc2.skl,poh,pcs,prj,vdj,pdj,prs,zas ".
...
if ( $copern == 10 )
  {
?>
<td class="tlacs" align="left" colspan="4">Druhy pohybov v skladoch</td>
...
if ( $copern == 20 )
  {
?>
<td class="tlacs" align="left" colspan="4">Druhy pohybov v skladoch - okamžitý stav celé úètovné obdobie</td>
...
<tr bgcolor="lightblue">
<th class="tlac">Sklad<th class="tlac">Pohyb<th class="tlac">Poè.stav<th class="tlac">Príjem
...
?>
<tr bgcolor="lightblue">
<td class="tlacs" colspan="9">Celkom sklad:&nbsp;<?php echo $sCelskl;?> Sk </td>
</tr>
<?php
$riad_dokon = $riad_dokon-1;
...
<tr>
<td class="tlac" width="5%" >&nbsp;<?php echo $riadok->skl;?></td>
<td class="tlac" width="5%" >&nbsp;<?php echo $riadok->poh;?></td>
...
<td class="tlacs" colspan="2">Celkom:&nbsp;</td>
