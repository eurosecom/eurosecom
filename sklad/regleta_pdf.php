...
<tr>
<td>EuroSecom  -  Regleta zásob PDF 
...
if ( $copern == 20 )  { $pdf->Cell(90,6,"Regleta zásob za $kli_vume Sklad $riadok->skl $riadok->nas","LTB",0,"L"); }
if ( $copern == 10 )  { $pdf->Cell(90,6,"Stav zásob okamžitý stav $kli_vume Sklad $riadok->skl $riadok->nas","LTB",0,"L"); }
