...
<title>Stav skladov podla kódov CPA PDF</title>
  <style type="text/css">
...
<tr>
<td>EuroSecom  -  Stav skladov podla kódov CPA 
...
//suma za CPA nie podla skladov
$dsqlt = "UPDATE F$kli_vxcf"."_sklprc$kli_uzid SET skl=1, druh='' "; $dsql = mysql_query("$dsqlt");

$dsqlt = "UPDATE F$kli_vxcf"."_sklprc$kli_uzid,F$kli_vxcf"."_sklcisudaje SET druh=xnat5 ".
...
$pdf->Cell(135,5,"CELKOM kód CPA $riadok->druh","T",0,"L");
...
$pdf->Cell(155,5,"CELKOM všetky CPA ","LTB",0,"L");
$pdf->Cell(0,5,"$riadok->hod","RTB",1,"R");
$j=-1;
}
