...
<title>Stav skladov podla kategórií PDF</title>
  <style type="text/css">
...
<tr>
<td>EuroSecom  -  Stav skladov podla kategórií 
...
//suma za KAT nie podla skladov
$dsqlt = "UPDATE F$kli_vxcf"."_sklprc$kli_uzid SET skl=1, druh='' "; $dsql = mysql_query("$dsqlt");

$dsqlt = "UPDATE F$kli_vxcf"."_sklprc$kli_uzid,F$kli_vxcf"."_sklcisudaje SET druh=xdr2 ".
...
if ( $copern == 10 )  { $pdf->Cell(90,6,"Stav zásob okamžitý stav $kli_vume ","LTB",0,"L"); }
...
$nazovktg="";
$sqlttt = "SELECT * FROM F$kli_vxcf"."_restktgtov WHERE cktg = $riadok->druh ORDER BY cktg DESC LIMIT 1 ";
$sqldok = mysql_query("$sqlttt");
    if (@$zaznam=mysql_data_seek($sqldok,0))
    {
    $riaddok=mysql_fetch_object($sqldok);
    $nazovktg=$riaddok->nktg;
    }

$pdf->Cell(135,5,"CELKOM kategória $riadok->druh $nazovktg","T",0,"L");
