...
<button class="mdl-button mdl-js-button mdl-button--icon " title="Prehæad·vanie" style="margin-top: 16px;">
...
<!-- vstup dat -->
    <div class="mdl-color--white mdl-shadow--2dp card-module">
      ...
      <ul class="card-module-content">
        <li onclick="" class="card-item external-link">OdberateæskÈ fakt˙ry</i></li>
        <li onclick="" class="card-item external-link">Dod·vateæskÈ fakt˙ry</li>
        <li onclick="" class="card-item external-link">PrÌjmovÈ pokladniËnÈ doklady</li>
        <li onclick="" class="card-item external-link">V˝davkovÈ pokladniËnÈ doklady</li>
        <li onclick="" class="card-item external-link">BankovÈ v˝pisy</li>
        <li onclick="" class="card-item external-link">VöeobecnÈ ˙ËtovnÈ doklady</li>
      </ul>
    </div>
<!-- ekorobot -->
...
<!--       <div class="card-module-header">
      ...
      <div class="card-module-content" style="padding-left: 56px;">
        <img src="obr/robot/robot3.jpg" onclick="UkazLista(ekorobot);" title="Ak m·te ûelanie, kliknite na mÚa" class="">
      </div>
    </div>
  </div> <!-- .mdl-cell -->
...
<!-- vystupy -->
    <div class="mdl-color--white mdl-shadow--2dp card-module">
      ...
      <ul class="card-module-content">
        <li onclick="" class="card-item external-link">⁄ËtovnÈ zostavy</li>
        <li onclick="" class="card-item external-link">ätatistickÈ v˝kazy</li>
        <li onclick="" class="card-item external-link">DaÚovÈ formul·re</li>
      </ul>
    </div>
<!-- dph -->
    <div class="mdl-color--white mdl-shadow--2dp card-module">
...
<!-- saldokonto -->
    <div class="mdl-color--white mdl-shadow--2dp card-module">
      ...
      <ul class="card-module-content">
        ...
        <li onclick="" class="card-item external-link">Vz·jomnÈ z·poËty</li>
        <li onclick="" class="card-item external-link">Faktoring</li>
        <li onclick="" class="card-item external-link">PrÌkazy na ˙hradu</li>
      </ul>
    </div>
<!-- ciselniky -->
    <div class="mdl-color--white mdl-shadow--2dp card-module">
      ...
      <ul class="card-module-content">
        ...
        <li onclick="" class="card-item external-link">»ÌselnÌk I»O</li>
