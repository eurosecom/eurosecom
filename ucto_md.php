...
<!-- vstup dat -->
    <div id="vstup_data" class="card-module">
      ...
      <ul class="card-module-content">
        ...
        <li id="prijem_pokladna" onclick="PrijemPokl();" class="card-item">PrÌjmovÈ pokladniËnÈ doklady</li>
        <li id="vydaj_pokladna" onclick="VydavPokl();" class="card-item">V˝davkovÈ pokladniËnÈ doklady</li>
        <li id="bank_vypisy" onclick="BankVyp();" class="card-item">BankovÈ v˝pisy</li>
        <li id="vseobec_doklady" onclick="VseoDokl();" class="card-item">VöeobecnÈ ˙ËtovnÈ doklady</li>
      </ul>
    </div>
<!-- ekorobot -->
