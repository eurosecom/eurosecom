...
$cit_nas = include("cis/citaj_nas.php");
  ...
  if( $_SERVER['SERVER_NAME'] == "www.europkse.sk" AND $vyb_xcf != 1014 ) { $ajnajom=0; }
  if( $_SERVER['SERVER_NAME'] == "www.europkse.sk" AND $vyb_xcf == 1014 ) { $ajnajom=1; }
...
//[[[[[[[ body fakturacie
  ...
  <?php
  $sql = mysql_query("SELECT * FROM ".$mysqldbdata.".F$vyb_xcf"."_dodb WHERE drod = 1 ORDER BY dodb");
...
"Chcete skontrolova doklady v Odbyte ?</a>";
    htmlmenu += "</td></tr>";
...
"Prejs do odberate¾skıch objednávok</a>";
    htmlmenu += "</td></tr>";
<?php } ?>
</script>
</HEAD>
