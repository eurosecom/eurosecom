...
function volajSlu()
{
  ...
  if (xmlHttp)
  {
    ...
    try
    {
      ...
      var params = "prm1=" + h_cis + "&prm2=" + h_nat + "&cennik=" + cennik + "&csl=" + csl;
...
function tabulkaXML()
{
  ...
  for (var i=0; i<pol01Array.length; i++)
    {
    html += "<tr><td width='6%'>SKL=" + pol08Array.item(i).firstChild.data + "</td>"+
            ...
            "<td width='8%' class='ponuka'>" + pol04Array.item(i).firstChild.data + "</td>" +
            "<td width='8%' class='ponuka'>" + pol05Array.item(i).firstChild.data + "</td>" +
  ...
  var html = "";  
  document.forms.eplu.h_cis.value =  pol01Array.item(0).firstChild.data;
  document.forms.eplu.h_nat.value =  pol02Array.item(0).firstChild.data;
  document.forms.eplu.h_dph.value =  pol03Array.item(0).firstChild.data;
  document.forms.eplu.h_cep.value =  pol04Array.item(0).firstChild.data;
  document.forms.eplu.h_mno.value =  pol10Array.item(0).firstChild.data;
