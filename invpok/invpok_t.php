...
$pdf->SetY(235);
$pdf->Cell(30,5,"Fyzický stav pokladničnej hotovosti  s ú h l a s í  –  n e s ú h l a s í  s účtovným stavom.","$rmc",1,"L");
$pdf->Cell(190,15," ","$rmc",1,"L");
$pdf->Cell(30,5,"$fir_fmes, dňa:  $skinvdatskc","$rmc",1,"L");
$pdf->Cell(190,7," ","$rmc",1,"L");
