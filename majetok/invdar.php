...
" WHERE F$kli_vxcf"."_zozprc$kli_uzid.inv=F$kli_vxcf"."_majtextmaj.invt AND F$kli_vxcf"."_majtextmaj.zdro = 3 ".
"";
$dsql = mysql_query("$dsqlt");
...
if( $drupoh == 1 )
{
$pdf->Cell(80,5,"Inventúrna zostava majetku darovaného a bezplatne nadobudnutého $kli_vume ","LTB",0,"L");
