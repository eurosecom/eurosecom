...
" VALUES ('$czs', 'zostava1', 'zostava1', '1', 'inv', 'Inv.è.', 'Inventárne èíslo', '0', '' ) ";
...
$ttvv = "INSERT INTO majmajpol ( xpol,xpop,xdlz,xzar,xvyz ) VALUES ( 'inv', 'Inv.è.', '15', 'R', 'Inventárne èíslo' )";
$ttqq = mysql_query("$ttvv");
$ttvv = "INSERT INTO majmajpol ( xpol,xpop,xdlz,xzar,xvyz ) VALUES ( 'naz', 'Názov', '35', 'L', 'Názov majetku' )";
$ttqq = mysql_query("$ttvv");
$ttvv = "INSERT INTO majmajpol ( xpol,xpop,xdlz,xzar,xvyz ) VALUES ( 'drm', 'DRM', '10', 'L', 'DRM' )";
$ttqq = mysql_query("$ttvv");
$ttvv = "INSERT INTO majmajpol ( xpol,xpop,xdlz,xzar,xvyz ) VALUES ( 'cen', 'Obst.cena', '20', 'R', 'Obstarávacia cena' )";
$ttqq = mysql_query("$ttvv");
$ttvv = "INSERT INTO majmajpol ( xpol,xpop,xdlz,xzar,xvyz ) VALUES ( 'ops', 'Oprávky', '20', 'R', 'Oprávky' )";
$ttqq = mysql_query("$ttvv");
...
$ttqq = mysql_query("$ttvv");
$ttvv = "INSERT INTO majmajpol ( xpol,xpop,xdlz,xzar,xvyz ) VALUES ( 'vyc', 'v.è.', '20', 'L', 'výrobné èíslo' )";
$ttqq = mysql_query("$ttvv");
...
$ttqq = mysql_query("$ttvv");
$ttvv = "INSERT INTO majmajpol ( xpol,xpop,xdlz,xzar,xvyz ) VALUES ( 'spo', 'SPO', '10', 'R', 'Spôsob odpisovania' )";
$ttqq = mysql_query("$ttvv");
$ttvv = "INSERT INTO majmajpol ( xpol,xpop,xdlz,xzar,xvyz ) VALUES ( 'sku', 'SKU', '10', 'R', 'Odpisová skupina úètovná' )";
$ttqq = mysql_query("$ttvv");
$ttvv = "INSERT INTO majmajpol ( xpol,xpop,xdlz,xzar,xvyz ) VALUES ( 'rvr', 'r.výr.', '10', 'L', 'Rok výroby' )";
$ttqq = mysql_query("$ttvv");
$ttvv = "INSERT INTO majmajpol ( xpol,xpop,xdlz,xzar,xvyz ) VALUES ( 'ros', 'Roè.odpis', '20', 'R', 'Roè.odpis' )";
$ttqq = mysql_query("$ttvv");
...
$ttqq = mysql_query("$ttvv");
$ttvv = "INSERT INTO majmajpol ( xpol,xpop,xdlz,xzar,xvyz ) VALUES ( 'kanc', 'KANC', '20', 'L', 'Kancelária' )";
$ttqq = mysql_query("$ttvv");
$ttvv = "INSERT INTO majmajpol ( xpol,xpop,xdlz,xzar,xvyz ) VALUES ( 'pop', 'Popis', '35', 'L', 'Popis majetku' )";
$ttqq = mysql_query("$ttvv");
$ttvv = "INSERT INTO majmajpol ( xpol,xpop,xdlz,xzar,xvyz ) VALUES ( 'poz', 'Poznámka', '35', 'L', 'Poznámka' )";
$ttqq = mysql_query("$ttvv");
$ttvv = "INSERT INTO majmajpol ( xpol,xpop,xdlz,xzar,xvyz ) VALUES ( 'zar', 'Zaradené', '10', 'L', 'Dátum zaradenia' )";
$ttqq = mysql_query("$ttvv");
$ttvv = "INSERT INTO majmajpol ( xpol,xpop,xdlz,xzar,xvyz ) VALUES ( 'dob', 'Obstarané', '10', 'L', 'Dátum obstarania' )";
$ttqq = mysql_query("$ttvv");
                }
...
<title>Tlaè údajov o majetku</title>
  <style type="text/css">
...
<tr>
<td>EuroSecom  -  Tlaè údajov o majetku</td>
...
<option value="1" >Dlhodobý</option>
<option value="2" >Drobný</option>
</select>
...
è.<?php echo $zaznam["czs"];?> - <?php echo $zaznam["pzs"];?></option>
<?php endwhile;?>
</select>

<a href="#" onClick="PdfZos();" >
<img border=0 src='../obr/tlac.png' style='width:20; height:20;' title='Vytlaè preddefinovanú zostavu PDF' >
 PDF </a>

<img src='../obr/info.png' onClick='' width=12 height=12 border=0 title='Ak zaškrtnete políèko použije sa pre zostavu výber zo zoznamu majetku' >

<input type="checkbox" name="h_vyber" value="1" />

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
VYR <img src='../obr/info.png' onClick='' width=12 height=12 border=0 title='Ak zaškrtnete políèko tlaèi sa bude z vyradeného majetku' >
...
<img border=0 src='../obr/zoznam.png' style='width:20; height:20;' title='Vytlaè preddefinovanú zostavu HTML' >
 HTML </a>
<?php
}
?>
...
<img border=0 src='../obr/uprav.png' style='width:20; height:20;' title='Uprav preddefinovanú zostavu HTML' >
</a>

<a href="#" onClick="CopyZos();" >
<img border=0 src='../obr/ziarovka.png' style='width:20; height:20;' title='Kópia preddefinovanej zostavy' >
</a>

<a href="#" onClick="ZmazZos();" >
<img border=0 src='../obr/zmazuplne.png' style='width:20; height:20;' title='Zmaž preddefinovanú zostavu' >
</a>
</tr>
</FORM>
</table>
...
<tr>
<td class="hmenu" colspan="10">Zostava è.<?php echo $czs; ?> 
<tr>
...
<input type="text" name="h_nzs" id="h_nzs" size="40" onclick="New.style.display='none'; " />Názov zostavy
<tr>
<td class="hmenu" colspan="10" align="left">
...
<?php echo $h_ttp; ?>
</textarea>Text pred položkami
</td></tr>

<tr><td class="bmenu" colspan="10">
<textarea name="h_ttz" id="h_ttz" rows="4" cols="80" >
<?php echo $h_ttz; ?>
</textarea>Text za položkami
</td></tr>

<tr>
<td class="hmenu" align="left">Poradie
<td class="hmenu" >Položka
<td class="hmenu" >Popis
<td class="hmenu" colspan="3">Význam
...
<img src='../obr/hladaj.png' width=12 height=12 border=0 title="H¾ada zákazku" ></a>
...
<td class="hmenu" colspan="1" align="left">
<img border=0 src='../obr/ok.png' style='width:15; height:15;' onclick="UlozPolozku();" title='Uloži' ></td>
...
<span id="New" style="display:none; width:100%; align:center; font-family:bold; font-weight:bold; background-color:red; color:black;">
 Nenašiel som úèet pod¾a zadaných podmienok, skúste znovu</span>
...
?>
<tr>
<td class="hmenu" colspan="10">Zostava è.<?php echo $polozka->czs; ?> Názov:<?php echo $polozka->nzs; ?> Popis:<?php echo $polozka->pzs; ?>
</tr>
