...
if( $drupoh == 1 )
{
$pdf->SetY(5);$pdf->Cell(10,10," ","1",0,"R");$pdf->Cell(80,5,"Invent˙rna zostava dlhodobÈho majetku ⁄»TOVN› stav $kli_vume ","LTB",0,"L");
$pdf->Cell(90,5,"FIR$kli_vxcf $kli_nxcf strana $strana","RTB",1,"R");
}
if( $drupoh == 2 )
{
$pdf->SetY(5);$pdf->Cell(10,5," ","0",0,"R");$pdf->Cell(80,5,"Invent˙rna zostava dlhodobÈho majetku DA“OV› stav $kli_vume","LTB",0,"L");
$pdf->Cell(90,5,"FIR$kli_vxcf $kli_nxcf strana $strana","RTB",1,"R");
}
$pdf->SetFont('arial','',6);
$pdf->Cell(10,5," ","0",0,"R");
...
{
$pdf->SetFont('arial','',8);
$pdf->Cell(70,4,"CELKOM CPA $rtov->kcpax = $rtov->pol poloûiek","LTB",0,"R");
...
{
$pdf->SetFont('arial','',8);
$pdf->Cell(70,4,"CELKOM zak$rtov->zak = $rtov->pol poloûiek","LTB",0,"R");
$pdf->Cell(8,4," ","TB",0,"L");$pdf->Cell(12,4," ","TB",0,"L");$pdf->Cell(16,4," ","TB",0,"L");
$pdf->Cell(20,4,"$rtov->cen","LRTB",0,"R");$pdf->Cell(20,4,"$rtov->ops","LRTB",0,"R");$pdf->Cell(20,4,"$zostatok","LTB",0,"R");
$pdf->Cell(14,4," ","RTB",1,"L");
$pdf->SetFont('arial','',7);
...
{
$pdf->SetFont('arial','',8);
$pdf->Cell(70,4,"CELKOM DRM$rtov->drm v str$rtov->str = $rtov->pol poloûiek","LTB",0,"R");
$pdf->Cell(8,4," ","TB",0,"L");$pdf->Cell(12,4," ","TB",0,"L");$pdf->Cell(16,4," ","TB",0,"L");
$pdf->Cell(20,4,"$rtov->cen","LRTB",0,"R");$pdf->Cell(20,4,"$rtov->ops","LRTB",0,"R");$pdf->Cell(20,4,"$zostatok","LTB",0,"R");
$pdf->Cell(14,4," ","RTB",1,"L");
$pdf->SetFont('arial','',7);
...
{
$pdf->SetFont('arial','',8);
$pdf->Cell(70,4,"CELKOM DRM$rtov->drm = $rtov->pol poloûiek","LTB",0,"R");
$pdf->Cell(8,4," ","TB",0,"L");$pdf->Cell(12,4," ","TB",0,"L");$pdf->Cell(16,4," ","TB",0,"L");
$pdf->Cell(20,4,"$rtov->cen","LRTB",0,"R");$pdf->Cell(20,4,"$rtov->ops","LRTB",0,"R");$pdf->Cell(20,4,"$zostatok","LTB",0,"R");
$pdf->Cell(14,4," ","RTB",1,"L");
$pdf->SetFont('arial','',7);
...
{
$pdf->SetFont('arial','',8);
$pdf->Cell(70,4,"CELKOM STR$rtov->str = $rtov->pol poloûiek","LTB",0,"R");
$pdf->Cell(8,4," ","TB",0,"L");$pdf->Cell(12,4," ","TB",0,"L");$pdf->Cell(16,4," ","TB",0,"L");
$pdf->Cell(20,4,"$rtov->cen","LRTB",0,"R");$pdf->Cell(20,4,"$rtov->ops","LRTB",0,"R");$pdf->Cell(20,4,"$zostatok","LTB",0,"R");
$pdf->Cell(14,4," ","RTB",1,"L");
$pdf->SetFont('arial','',7);
...
$pdf->Cell(70,6,"Invent˙ra vykonan· dÚa: $h_mail","1",1,"L");
$pdf->Cell(0,2," ","0",1,"L");
$pdf->Cell(70,6,"Zodpovedn˝ pracovnÌk: $h_mdov","1",1,"L");
$pdf->Cell(0,2," ","0",1,"L");
$pdf->Cell(40,6,"»lenovia komisie:","1",0,"L");$pdf->Cell(30,6,"$h_dovv","1",0,"L");$pdf->Cell(30,6,"$h_dovv2","1",0,"L");$pdf->Cell(30,6,"$h_dovv3","1",1,"L");
}

if ( $rtov->druh == 999 )
{
$pdf->SetFont('arial','',8);
$pdf->Cell(70,5,"CELKOM MAJETOK = $rtov->pol poloûiek","LTB",0,"R");
...
//uprav komisiu
  ...
  { 
    ...
    htmlmenu2 += "Nastavenie invent˙ry ";
...
htmlmenu2 += " Komisia 3 ";
    ...
    htmlmenu2 += " <img border=0 src='../obr/ok.png' style='width:15; height:15;' onClick='uloz_upravmail();' title='Uloûiù nastavenie' >";  
...
<tr>
<td>EuroSecom  -  Invent˙ra MAJETKU</td>
...
<td class="bmenu" width="38%">Invent˙rna zostava dlhodobÈho majetku 
<td class="bmenu" width="50%">
 triedenie
<select size="1" name="h_trd" id="h_trd" >
<option value="0" >podæa invent·rneho ËÌsla</option>
<option value="1" >podæa druhu majetku</option>
<option value="2" >podæa strediska</option>
<option value="3" >podæa kÛdu CPA</option>
<option value="4" >podæa strediska a druhu majetku</option>
<option value="5" >podæa z·kazky</option>
</select>
</td>

<td class="bmenu" width="10%" align="right" >
<img src='../obr/naradie.png'  onClick="nastavpaux.style.display='';" width=15 height=15 border=0 title='Nastaviù komisiu a d·tum invent˙ry, platÌ aj pre DIM' >
...
<td class="bmenu" width="38%">Invent˙rna zostava drobnÈho majetku 
...
<td class="bmenu" width="38%">Invent˙rna zostava majetku obstaranÈho zo zdrojov EU a in˝ch cudzÌch zdrojov
...
<td class="bmenu" width="38%">Invent˙rna zostava majetku darovanÈho a bezplatne nadobudnutÈho
...
<img src='../obr/zoznam.png' width=20 height=15 border=0 title='Definovanie a tlaË zost·v vo form·te PDF' ></a>
</td>
<td class="bmenu" width="38%">PreddefinovanÈ zostavy z majetku
...
<td class="bmenu" width="38%">Zostava zaradenÈho majetku a stavu odpisov v roku zaradenia
...
<td class="bmenu" width="38%">Zostava Osobnej spotreby daÚov˝ch odpisov majetku
...
<td class="bmenu" width="38%">Odpisov˝ pl·n majetku podæa odpisov˝ch skupÌn
...
<td class="bmenu" width="38%">RoËnÈ obraty - druhu majetku 26 a 27
