...
<img src='../obr/naradie.png' width=15 height=12 border=1 onClick='Servis();' alt='InformaËn˝ a reklamn˝ systÈm' >
...
<a href='cfir.php?copern=66&page=<?php echo $page;?>&cislo_xcf=<?php echo $riadok->xcf;?>&nazov_xcf=<?php echo $riadok->naz;?>'>
 <img src='obr/odstran.png' width=20 height=20 border=0 alt="Vymazaù vöetky tabulky vybranej firmy"></a>
<?php
  }
?>
<?php echo $riadok->naz;?>
