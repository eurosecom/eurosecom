...
{
$sql = "SELECT rok2015 FROM $mysqldb2010.kalendar";
$vysledok = mysql_query($sql);
if (!$vysledok){
...
{
$sql = "SELECT rok2015 FROM $mysqldb2011.kalendar";
$vysledok = mysql_query($sql);
if (!$vysledok){
...
{
$sql = "SELECT rok2015 FROM $mysqldb2012.kalendar";
$vysledok = mysql_query($sql);
if (!$vysledok){
...
{
$sql = "SELECT rok2015 FROM $mysqldb2013.kalendar";
$vysledok = mysql_query($sql);
if (!$vysledok){
