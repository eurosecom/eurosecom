...
<tr>
  ...
  <td><a href="#" onClick="ZmazPolozku(<?php echo $riadok->cplf;?>);">Vymaza</a></td>
</tr>
<?php
  }
$if = $if + 1;
...
<tr>
  ...
  <td><a href="#" onClick="ZmazPolozku(<?php echo $riadokp->prav;?>, <?php echo $riadokp->cslm;?>, '<?php echo $riadokp->datm;?>' );">Vymaza</a></td>
</tr>
<?php
  }
$ip = $ip + 1;
