...
if( $sekov == 1 AND $copern == 1 AND $kli_vxcf == 524 )
     {
$databaza="";
...
$sql = "CREATE TABLE F".$kli_vxcf."_zakprenos SELECT * FROM ".$databaza."F239_zak WHERE zak >= 0";
$vysledek = mysql_query("$sql");
...
$dsqlt = "DELETE FROM F$kli_vxcf"."_zak WHERE str = 10 AND zak < 180000 AND zak > 1 ";
$dsql = mysql_query("$dsqlt");
     }
...
$sql = "CREATE TABLE F".$kli_vxcf."_zakprenos SELECT * FROM ".$databaza."F237_zak WHERE zak >= 0";
$vysledek = mysql_query("$sql");
...
$dsqlt = "DELETE FROM F$kli_vxcf"."_zak WHERE str = 10 AND zak < 160000";
$dsql = mysql_query("$dsqlt");
     }
