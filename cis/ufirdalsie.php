...
<tr>
<td>EuroSecom  -  Ïalšie údaje o firme</td>
...
<img src='../obr/zoznam.png' width=20 height=15 border=0 title="Nastavenie úètov pre úhradu daní, SP a odborov" >bank.úèty DÚ,SP...</a>
...
<img src='../obr/zoznam.png' width=20 height=15 border=0 title="Nastavenie dátumov uzávierky" >Dátumy na uzávierke</a>

<a href="#" onClick="fosp();">
<img src='../obr/zoznam.png' width=20 height=15 border=0 title="Nastavenie Fosoby SP" >Fosoba SP</a>

<a href="#" onClick="fotrv();">
<img src='../obr/zoznam.png' width=20 height=15 border=0 title="Nastavenie FO daòovník" >FO daòovník</a>
...
<tr><td class="bmenu" colspan="10">Èísla úètov pre úhradu najpouívanejších daní, SP a odborov ( tvar 500208-8028547880 / 8180 ) </tr>
...
<tr>
<td class="pvstuz" colspan="10">Miesto podnikania (ak sa líši od miesta trvalého pobytu) - ! <i>Vypåòa iba pri Vıkaze o príjmoch a vıdavkoch a pri Vıkaze o majetku a záväzkov</i>&nbsp;!</td>
</tr>
<tr>
<td class="bmenu" colspan="1">Ulica:</td>
<td class="bmenu" colspan="1"><input type="text" name="pruli" id="pruli" size="30" /></td>
<td class="bmenu" colspan="1">Èíslo:</td>
<td class="bmenu" colspan="1"><input type="text" name="prcdm" id="prcdm" size="10" /></td>
</tr>
<tr>
<td class="bmenu" colspan="1">PSÈ:</td>
...
<tr>
<td class="bmenu" colspan="1">Telefón:</td>
...
<tr>
<td class="pvstuz" colspan="10">Dátumy na uzávierkach&nbsp;</td>
</tr>
<tr>
<td class="bmenu" colspan="5">Uzávierka k dátumu:</td>
<td class="bmenu" colspan="5"><input type="text" name="datk" id="datk" onkeyup="CiarkaNaBodku(this);" size="12" /></td>
</tr>
<tr>
<td class="bmenu" colspan="5">Druh uzávierky ( nastavenie v Súvahe, Vıkaze ziskov a Poznámkach ):</td>
...
<tr>
<td class="bmenu" colspan="5">Bené úètovné obdobie od dátumu:</td>
<td class="bmenu" colspan="5"><input type="text" name="datbod" id="datbod" onkeyup="CiarkaNaBodku(this);" size="12" /></td>
</tr>
<tr>
<td class="bmenu" colspan="5">Bené úètovné obdobie do dátumu:</td>
<td class="bmenu" colspan="5"><input type="text" name="datbdo" id="datbdo" onkeyup="CiarkaNaBodku(this);" size="12" /></td>
</tr>
<tr>
<td class="bmenu" colspan="5">Bezprostredne predchádzajúce úètovné obdobie od dátumu:</td>
...
<tr>
<td class="bmenu" colspan="5">Kríik zostavená ( Úètovná závierka NUJ 2014 ):</td>
<td class="bmenu" colspan="5"><input type="checkbox" name="kzos" value="1" /></td>
</tr>
<tr>
<td class="bmenu" colspan="5">Kríik schválená ( Úètovná závierka NUJ 2014 ):</td>
...
<tr>
<td></td>
<td class="bmenu"><INPUT type="submit" id="uloz" name="uloz" value="Uloi úpravy"></td>
</tr>
</FORM>
...
<tr>
<td class="pvstuz" colspan="10">FO, ktorá plní povinnosti voèi SP (mzdová uètáreò).&nbsp;</td>
</tr>
<tr>
...
<tr><td class="pvstuz" colspan="10">ÚDAJE O DAÒOVNÍKOVI FO</td></tr>
<tr>
<td class="bmenu" colspan="1">Priezvisko:</td>
...
<tr><td colspan="10" height="4px"></td></tr>
<tr><td class="pvstuz" colspan="10">Adresa trvalého pobytu</td></tr>
<tr>
<td class="bmenu" colspan="1">Ulica:</td>
...
<td class="bmenu" colspan="1">Štát:</td>
