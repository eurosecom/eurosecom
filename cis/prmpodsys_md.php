...
<td></td><td></td>
<td colspan="3">
  <a href="#" onclick="PredvolText();">Predvolené texty</a>
  <a href="#" onclick="NastavAutouct();">Nastavenie auto úètov.</a>
</td>
</tr>
</FORM>
</table>
...
<script>
  ...
  {
   window.open('../faktury/ftexty.php?copern=105', '_blank');
  }
  function NastavAutouct()
  {
   window.open('../ucto/uctpoh.php?copern=1&page=1', '_blank');
  }
</script>
<?php
mysql_free_result($vysledok);
