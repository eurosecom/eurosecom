...
$sqltt = "SELECT * FROM F$kli_vxcf"."_icoodbm WHERE ico = $cprm1  ORDER BY odbm";
...
if( $diak == 1 ) 
{ 
$txp01 = $retezec = iconv("CP1250", "UTF-8", $riadok->odbm); 
$txp02 = $retezec = iconv("CP1250", "UTF-8", $riadok->onai); 
$txp03 = $retezec = iconv("CP1250", "UTF-8", $riadok->omes); 
...
$pol04Text = $dom->createTextNode(BU.$txp04);
